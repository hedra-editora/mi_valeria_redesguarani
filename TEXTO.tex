...
\epigraph{Podemos estudar sim, mas continuar sonhando em guarani. Assim nosso conhecimento faz a gente.}{\textsc{karai mirim \&\\algemiro da silva}}


\chapter*{Introdução\smallskip\subtitulo{As múltiplas conexões de pessoas\break e 
conhecimentos}}
\addcontentsline{toc}{chapter}{Introdução, \textit{\small por Valéria Macedo e Dominique Tilkin Gallois}}
...
% reconhece como parte delas.\looseness=-1

\pagestyle{intro}

\begin{flushright}
\textsc{valéria macedo}\\
\textsc{dominique tilkin gallois}
\end{flushright}

%\medskip
\noindent\emph{Guarani} é uma designação que não dá conta da multiplicidade de coletivos
...
Kaiowá, Pai Tavyterã, entre outros. Tais denominações trazem consigo
...
\section{alegria como conceito guarani}

\textit{Alegria} é a palavra que nos parece sintetizar o encontro. Mas \textit{alegria}
...
uma Proposta de Emenda Constitucional, a \textsc{pec} 215, entrara na pauta de
...
proposta fosse aprovada, o direito originário dos indígenas a terras que
...
Entre as mais ameaçadas pela \textsc{pec} 215, figuram terras dos Kaiowá e
...
dois de seus participantes --- o kaiowá Tonico Benites e a mbya Jera Poty
...
missionamento dos indígenas e sua arregimentação como mão de obra. Em tais
...
dos ruralistas. No Mato Grosso do Sul, os grandes encontros kaiowá e
...
\textit{Guarani Kaiowá} em seus nomes. Milhares de outras pessoas
acrescentaram aos seus perfis os dizeres \textit{Eu sou\ldots{}} com o nome de um
povo indígena, sendo \textit{Kaiowá} um dos mais citados. Na mesma direção,
...
melhor para os indígenas é que eles deixem de sê-lo, para que \textit{alcancem a
civilização} e \textit{integrem a comunhão nacional} como cidadãos
...
sermos indígenas, tampouco para sermos iguais, e sim para termos sempre
aberta a possibilidade de experimentar a diferença e se transformar por
meio dela.

\section{luta e repercussão do pensamento}
...
Guasu, cujos encontros reúnem populações guarani nhandeva e kaiowá no
Mato Grosso do Sul. Já Carlos Papa Mirĩ Poty, Ariel Kuaray Poty e
Alexandre Werá têm se destacado na produção de filmes. Além da linha de
...
nas reivindicações por direitos à terra.\looseness=-1
...
kaiowá doutor em antropologia pelo Museu Nacional da Universidade
...
fortalecimento da vida kaiowá e guarani, tendo como horizonte comum a
...
saberes \emph{juruá}, como as comidas industrializadas, a televisão e
...
dos \emph{juruá}, os não indígenas, ressalta que na cidade se está sozinho
entre muitos, sendo onde mora o \textit{si}, e por isso é chamada de \emph{sidade} ---
...
do livro --- é a autora do próximo artigo, em que os \emph{juruá} são também
...
O~terceiro texto da seção foi escrito em co"-autoria por Alexandre Werá ---
...
filme ``O~dono da lontra''. Werá filma um episódio que testemunhou, em
...
No texto, Werá elabora a metáfora da câmera como uma criança, que
...
expectativas de um coletivo de jovens kaiowá, nhandeva e terena em Mato
...
guarani e kaiowá na região e aborda a vida nas reservas, nos
...
com descendentes de europeus, africanos e guarani. A~\textit{mistura} que
caracteriza o modo pelo qual essa população se identifica não se opõe à
\textit{pureza} ou \textit{autenticidade}, e sim implica a problematização dessas
...
apreensíveis em um único coletivo, como parece indicar o termo \textit{guarani}.
...
%   \vspace{-2cm}
%   \includegraphics[width=136mm]{./img/mapita_crop2.jpg}	
% \end{adjustwidth}
...
\begin{adjustwidth}{-2.7cm}{}
  \vspace{-3.1cm}
  \includegraphics[width=136mm]{./img/GUARANIS-img1_crop2.jpg}	
\end{adjustwidth}
...
\part[Movimentos pela terra, andanças entre mundos]{Movimentos pela terra,\break andanças entre mundos}

\chapter*{\emph{Aguyjevete} pra quem luta!\subtitulo{A~Comissão Yvyrupa e a busca por\break nosso espaço de viver}}

\addcontentsline{toc}{chapter}{\emph{Aguyjevete} pra quem luta!, \textit{\small por Tupã}}
\markboth{Aguyjevete pra quem luta}{}

\pagestyle{baruch}

%\@openrighttrue\makeatother
\begin{flushright}
\textsc{tupã (marcos dos santos)\footnote[*]{Coordenador \emph{tenonde} da Comissão
Guarani Yvyrupa.}}
\end{flushright}
...
\emph{juruá}, o pessoal simplesmente carimbava o seu dedo, e apenas os \emph{juruá}
...
prefeitura municipal, e o Centro de Trabalho Indigenista (\textsc{cti}) nos
...
do Centro Indigenista Missionário (\textsc{cimi}) e dos demais apoiadores.
...
da ocupação dos \emph{juruá}, da colonização portuguesa, vi que se nós
...
processo já tem muita dificuldade, porque os tais \textit{proprietários}
...
\section{Carta veiculada pela Comissão Yvyrupa por ocasião\break da tinta
...
\emph{Aguyjevete pra todos que lutam!}%\footnote[*]{Carta veiculada pela Comissão Yvyrupa por ocasião da tinta vermelha no Monumento às Bandeiras}
%\end{samepage}
%\bigskip
...
\chapter*{A~caminho do sol\subtitulo{Cosmografias guarani}}

\addcontentsline{toc}{chapter}{A~caminho do sol, \textit{\small por Daniel Calazans Pierri}}
\markboth{A~caminho do sol}{}

\begin{flushright}
\textsc{daniel calazans pierri\footnote[*]{Mestre pelo \textsc{ppgas}-\textsc{usp} e membro do Centro de Trabalho Indigenista (\textsc{cti}).}}
\end{flushright}

\begin{quote}
\textit{Isso que eu tenho pra contar. Então nós, Guarani, iríamos nos encontrar
frente a frente com os brancos. \emph{Nhanderu}, a divindade criadora do
...
\emph{Nhamandu}, a divindade solar, se põe e o fim da terra dele,
...
já sabemos disso tudo pelos \emph{nhamandu kuery}, a coletividade dos \emph{Nhamandu},
...
\textit{Os brancos usaram a nossa língua para dar o nome a todas as coisas que
...
\textit{Se não existisse o Guarani aqui, não existiriam essas ruínas. Tinha
...
tem a sabedoria dos \emph{nhanderu kuery}, o coletivo genérico das divindades.
Até aqui foi a minha palavra, aqui na aldeia Peguaoty, que vai ser uma
aldeia mesmo, bem grande.}

\begin{flushright}
\textsc{cacique luís eusébio}\footnote{Escrito em 30 de janeiro de 2011 na aldeia Peguaoty, em Sete Barras, São Paulo.}
\end{flushright}
...
\noindent\textls[-10]{Essa narrativa, da qual reproduzo apenas um pequeno trecho, foi
...
\textls[-10]{Construiu"-se em parte da literatura antropológica especializada e,
sobretudo, em parte da chamada \textit{opinião pública} a ideia de que os
Guarani"-Mbya seriam um povo \textit{originário do Paraguai ou da Argentina}
...
\emph{yvy mbyte}, ``centro do mundo'', e \emph{yvy apy} ou \emph{yvy akã}, ``extremidade do mundo'' ou ``fim da terra''. Os três conceitos aparecem no discurso acima, mas
...
sobre a qual falarei brevemente ao concluir o texto.\looseness=-1
...
daquela que a literatura antropológica convencionou chamar o \textit{mito dos
...
situa em uma plataforma celeste localizada ao Leste.\looseness=-1
...
Eusébio se referia para dizer que os Guarani \textit{foram destinados a andar
do centro do mundo ao fim da terra}. Quando ele dizia que os primeiros
viviam no centro da terra e vieram \textit{seguindo o caminho de \emph{Nhamandu}}, há
...
\textls[-15]{Mas o discurso de Luís Eusébio, ao deixar implícitas essas questões,
fala explicitamente de suas decorrências na vida concreta dos Guarani.
Ele diz que \textit{em todo esse percurso sempre formamos as nossas aldeias,
...
Estando os Guarani destinados a \textit{imitar} os heróis da raça, como dizia
...
fato \textit{vieram do Paraguai}. Entretanto, os que vieram fizeram esse
...
tem embaixo da terra. E~esse não é salgado. {[}\ldots{}{]}
...
Guarani, que não terei espaço para abordar aqui.\footnote{Ver, a esse respeito,
...
abordados por autores como Cadogan ou Curt Nimuendajú, que lançaria
nova luz sobre as concepções guarani a respeito do espaço terrestre, de
\emph{yvyrupa}, como dizem os indígenas. Nimuendajú foi o primeiro autor que já
...
dizia em suas \emph{Lendas da criação e destruição do mundo} (1914) que
...
notado, que embora os indígenas dissessem que a Terra sem mal se situava
além do mar, \textit{a maioria a leste}, alguns falavam \textit{de uma outra Terra
...
consideração, a diferenciação de Nimuendajú entre uma Terra sem mal que
...
\textls[-20]{A~partir dessa concepção, esse último ancião me explicava de uma maneira
muito peculiar o que pensava sobre algo que Nimuendajú chamava de
\textit{crença na destruição do mundo}, e que para esse autor tinha relação
...
\textls[-10]{Embora seja uma tradução que não dá conta da complexidade das concepções
...
\textls[-10]{Em 2006, lideranças guarani"-mbya de grande parte das aldeias situadas
...
\textls[-10]{Para isso, optaram por utilizar esse termo que denota em sua língua todo
o espaço terrestre, onde vivem os Guarani, os brancos e uma série de
outros povos, como se significasse exclusivamente \textit{território guarani}.
...
a terra, acabando com todos que estiverem aqui, indígenas e brancos.
Afinal, \textit{a terra é uma só}. Estamos todos juntos em \emph{yvyrupa}.}

\begin{bibliohedra}
\tit{nimuendajú}, Curt Unkel. \emph{As lendas da criação e destruição do mundo
como fundamentos da religião dos Apapocúva"-Guarani}. São Paulo: Hucitec/\,Edusp, 1987 {[}1914{]}.

\tit{pierri}, Daniel Calazans. \emph{O~perecível e o imperecível: lógica do
...
\footnotesize
{\itshape
Desde o século \textsc{xvi} os Guarani tiveram uma série de tradutores, uns
...
das questões é a \textit{natureza} como separada daquilo que a gente chamaria de
\textit{cosmologia}, \textit{religião}, \textit{metafísica}, \textit{cultura}, seja lá o que for. Não há
...
\smallskip
\hspace*{\fill}\textsc{beatriz perrone"-moysés}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Novas terras sem males\subtitulo{A luta guarani"-kaiowá pelos \emph{tekoha}}}

\addcontentsline{toc}{chapter}{Novas terras sem males, \textit{\small por Spensy K.\,Pimentel}}
\markboth{Novas terras sem males}{}

\begin{flushright}
\textsc{spensy k. pimentel}\footnote[*]{Docente na Universidade Federal do Sul da
Bahia. Este artigo amadureceu a partir de diálogos com o historiador
kaiowá Izaque João e o \emph{nhanderu} Atanásio Teixeira, a quem agradeço
...
\noindent
Os Guarani"-Kaiowá\footnote{No contexto sul"-mato"-grossense, os
Guarani"-Kaiowá costumam usar a designação ``Kaiowá e Guarani'',
diferenciando os falantes do dialeto kaiowá e os do dialeto nhandeva ---
...
\textls[-10]{Conhecido como \emph{Aty Guasu} --- Grande Assembleia Kaiowá e Guarani, esse
...
para renascer a esperança de alcançarmos a terra sem males.\footnote{Documento final da \emph{Aty Guasu} realizada em 21 de agosto de 2011 na aldeia Paso
Piraju, em Dourados, \textsc{ms}, uma Terra Indígena em processo de identificação.}
\end{quote}

Não se trata de um exemplo único. O~uso do termo \textit{terra sem mal} é
...
grandes temas guarani, a Terra sem mal, \emph{Yvy Marane’y}.

\textls[-20]{Noelli (1999) rememorava"-nos o longo processo, por meio do qual se
teceram hipóteses cada vez mais abrangentes --- e arriscadas --- sobre a
Terra sem mal e, particularmente, sua associação com a mobilidade
guarani. O~autor destaca, na criação do que chama de \textit{mito acadêmico}
(1999, p.\,123), as obras de Nimuendajú (1987 {[}1914{]}) e Métraux (1927).}

Em resumo: o pioneiro Nimuendajú encontra, em 1912, uma família guarani
...
tentar chegar, em vida, à Terra sem mal, \emph{yvy marane’y}, um lugar \textit{onde
...
paraíso terreal? (1987, p.\,107).

A~hipótese de Nimuendajú começa a ser dada como favas contadas, cresce
mais e mais, sobretudo a partir de Métraux, que a \textit{reforça e
amplifica}, na avaliação de Noelli (1999, p.\,136). Talvez, o exemplo mais
significativo sobre a dimensão que tomaram os imaginados \textit{motivos
religiosos} para os movimentos coletivos guarani esteja na análise que
se construiu a respeito do termo \emph{kandire}.

Autores como Viveiros de Castro (1995, p.\,247 e 371) ou Pissolato (2007, p.\,410--11) --- entre muitos outros, diga"-se de passagem --- tomam, a partir de
...
\textit{ambivalência do humano} (Pissolato, 2007, p.\,410) posta em destaque nas
cosmologias tupi"-guarani. Esse autor, como se sabe, considerava a ideia
de um \textit{modelo tupi"-guarani} (1986, p.\,623--700), elaborado a partir de uma
...
Em tal constructo, a \textit{metafísica tupi"-guarani} envolvia uma concepção de
pessoa constituída pelo \textit{devir} (1986, p.\,623). Entre os Guarani,
...
corporal"-espiritual, alcançar a imortalidade, ou \textit{amadurecimento}.
...
século \textsc{xvi} --- já entendidas como uma procura da Terra sem mal --- à
...
\textit{interiorização} da busca pela \emph{Yvy Marane’y}.\footnote{Essa configuração
de uma teoria guarani da pessoa, de fato, remonta ainda à obra de
Nimuendajú, que, em seu relato sobre a crença na duplicidade da alma
entre os Apapokuva (1987, p.\,29--47), já apontava para essa ``visão dual da
pessoa'' (Viveiros de Castro, 1987, p.\,\textsc{xxvii}).}
...
inmortales por poseer una cultura superior?'' (Cadogan, 1997, p.\,101). E,
...
mantinham contato e que, por sua cultura característica, inspiravam
...
representar, simplesmente, uma \textit{reação à conquista}, essas
...
de \textit{motivos religiosos}, ou \textit{levantes político"-místicos}, como
sintetiza Julien (2007, p.\,265).
...
barreiras linguísticas (Julien, p.\,251 e 254).
...
termo se referiria aos Inca. Seriam os \textit{señores verdaderos del metal
amarillo}, ou seja, o ouro (Combès, 2011, p.\,102). Mais precisamente,
...
outro grupo também citado nos documentos, seriam \emph{mitimaes}, ``funcionários'', empregados pelo inca Condori nessas minas conhecidas
como Saypuru --- a própria designação Kandire poderia ser derivada de
Condori, supõe (2011, p.\,102--3).

A~autora busca refinar as hipóteses de Julien --- não é que se deva opor
os \textit{motivos religiosos}de Nimuendajú a um cálculo e uma razão \textit{à
...
‘cosas buenas’'', conjectura ela (2011, p.\,103--4).

Combès lembra que Métraux já apontava para uma convergência entre as
buscas pela mítica Terra sem mal e os Inca --- da mesma forma que
...
(2008, p.\,16--7), ou Meliá (1993). Mesmo quando se menciona essa questão,
como em Monteiro (1992, p.\,484), pode parecer que os grupos guarani
...
antigas migrações tupi"-guarani como \textit{crises messiânicas} (Métraux,
1979, p.\,175), oriundas da \textit{aculturação}, com a chegada dos europeus, ou,
nas obras de Pierre e Hélène Clastres, como um \textit{processo autóctone},
relacionado ao crescimento demográfico\footnote{Gloso aqui a leitura
que Pissolato (2007, p.\,99--105) faz desse debate. Sztutman, por sua vez,
rejeita o termo \textit{messianismo}, mas continua centrando a discussão no
\textit{profetismo} como \textit{xamanismo feito história} (2005, p.\,410) ou \textit{leitura da
história} (2005, p.\,430) feita pelos povos indígenas. No caso
...
geográfica, que acirraria uma \textit{contradição entre o político e o
religioso} (H. Clastres, 1978, p.\,45): grandes chefes com prestígio em
escala cada vez maior, espécie de \textit{força centrípeta}, enquanto os
profetas agiriam de forma \textit{centrífuga}, numa ação \textit{contra o Estado},
...
Combès, entre \textit{razões ecológicas e econômicas} e \textit{razões de ordem
mítica} (H. Clastres, 1978, p.\,59).}

O~problema que está posto aqui é o seguinte: será mesmo que, quando
estamos falando de Terra sem mal, nos referimos a algo que está no
polo do divino, do religioso, de um \textit{não ser social}, de \textit{forças
negadoras do social} (H. Clastres, 1978, p.\,45), ou, como afirmou, mais
recentemente, Sztutman (2005, p.\,41), de uma \textit{tradução guarani do devir não humano}?

No Brasil, os Kaiowá e Guarani de Mato Grosso do Sul representam a
...
Saúde Indígena (Sesai). Afora os Guarani Kaiowá de Mato Grosso do Sul,
...
porção da terra já demarcada, ou mesmo homologada, como os casos
...
identificar e delimitar como terras guarani"-kaiowá outras 39 áreas,
...
Cada uma dessas áreas pleiteadas pelos Kaiowá e Guarani é conhecida como
\emph{tekoha} --- significando algo como \textit{o lugar onde se pode viver do nosso
...
falantes de kaiowá que vivem do lado paraguaio.} ocorrido por lá
sobretudo nos anos 1970. A~despeito disso, como se sabe, palavras
correlatas são muito comuns, não só na história guarani,\footnote{Veja a obra de
...
porção de território com o qual um determinado coletivo kaiowá ou
guarani consegue identificar uma relação que pode ser interpretada
pelos não indígenas como de \textit{ocupação tradicional}, ao mesmo tempo em
...
miséria, relacionada sobretudo à superlotação e aos problemas ambientais --- impera um \emph{teko vai}, modo de ser ruim, ou imperfeito.
...
esforço dos xamãs kaiowá e guarani, hoje, como há vários séculos, é o
de pregar a volta ao \emph{nhande reko}, seu modo próprio de ser, de agir.
\textit{Pegar o jeito do branco}, uma expressão comum de se ouvir, é o perigo.
O~\emph{nhande reko}, o jeito kaiowá/\,guarani de ser, de fazer as coisas, está
...
designamos por \textit{natureza}. Nesse sentido, mais uma vez, há uma relação
direta entre a luta pela terra, o xamanismo e a política. Terra, aqui,
é muito mais do que o mero suporte para a \textit{produção} que nela veem os
brancos. De todo modo, o fato é que o projeto, teoria ou filosofia
kaiowá da política passa, de forma decisiva, por aquilo que chamamos de
natureza. E~isso não apenas no sentido \textit{romântico} identificado pelos
fazendeiros, de uma \textit{volta à natureza}.\footnote{Esse termo é
constantemente evocado pelo \emph{establishment} ruralista em \textsc{ms} para
questionar o sentido do movimento indígena de luta pela terra. Veja
Pimentel, 2012a e 2012b.} Mais que um objetivo, a natureza é aliada
no processo de luta pela terra.\footnote{Veja Pimentel, 2013.}

Animais, plantas, elementos do clima, como ventos e raios, e da paisagem, como
...
essas \textit{entidades sensíveis} (De La Cadena, 2008), que são aliados,
parentes, ou mesmo ancestrais dos Kaiowá e Guarani é, como se viu,
\emph{Tekojára}, os \textit{donos do nosso modo de ser}, numa das possíveis
...
forma apropriada, com todos esses seres"-elementos citados.\footnote{Veja Pereira,
2004.}

A~ideia de abandonar a ordem imposta pelos brancos e retomar os \textit{antigos
...
tempos do profeta Oberá, que liderou uma rebelião guarani em 1579.\footnote{Veja
Meliá, 1993.}

\textls[-10]{O~pensamento de um dos expoentes do movimento \emph{Aty Guasu}, o
\emph{nhanderu}\footnote{Um dos termos mais comuns que os Kaiowá costumam usar
para designar os xamãs --- \textit{nosso pai}. No litoral, entre os
Mbya/\,Nhandeva, designa o Criador do Mundo. Para diferenciar os xamãs
deste personagem, os Kaiowá chamam"-no \emph{Nhanderuvusu} --- ``nosso pai
...
maior parte do território kaiowá/\,guarani do lado brasileiro, em função
...
futuro, recebendo a denominação de \emph{johexakáry}, ver Pimentel, 2012, cap.\,3.} Nesse período, os dois, junto com outros xamãs, conseguiram apoio
do movimento indígena para promover, a partir de 1987, as chamadas
\emph{Jeroky Guasu}, ``grandes danças'' ou ``rezas''. Foi a partir dessa fase que
surgiu, pouco depois, o formato que é verificado até hoje para as
assembleias \emph{Aty Guasu}.
...
Chamorro.} assim se referia ao que irá acontecer quando os Kaiowá e
...
\textls[-10]{As festas kaiowá e guarani, segundo a memória dos mais velhos, estavam
...
pensamento político kaiowá e guarani, a presença dos xamãs nas ações
...
a ideia de cosmopolítica,\footnote{Cosmopolítica seria a \textit{nova
política}, no dizer de Latour (2001, p.\,347) --- a política livre do acordo
moderno que isolava a natureza, como se a ela não dissessem respeito as
decisões políticas. Por si só, esse acordo já definia um \textit{cosmos} para
uma certa política. Novos cosmos, novas políticas.} ou \textit{política
ontológica}, como aponta Mol: 

\begin{quote}
\textls[-20]{A~combinação dos termos \textit{ontologia} e \textit{política} sugere"-nos que as
...
modelada por essas práticas.\footnote{Mol, 2008, p.\,63.}}
\end{quote}

O~deslocamento que propomos nos parece útil no sentido de desfazer um
equívoco recorrente: enquanto tantos estiveram endossando os \textit{motivos
...
associação entre a \textit{terra ideal} e a terra almejada, disputada e
...
de um choque entre \textit{razões econômicas} e \textit{razões míticas}: os vetores
...
\textit{religiosa} das migrações guarani. Diante da persistência, em certos
segmentos sociais, da ideia de que os indígenas eram \textit{invasores
paraguaios}, ameaçando as áreas de conservação na Serra do Mar,
antropólogos que identificavam uma \textit{resistência} em reconhecer a
relação dessas migrações guarani com o tema da Terra sem mal e a
reprodução dos caminhos trilhados pelos \textit{grandes heróis ``divinizados''}
(Ladeira, 2007, p.\,66), lograram demonstrar que essa dimensão profética
das migrações permanecia viva na memória de muitos idosos. 

Em \textsc{ms}, como no litoral, trata"-se, portanto, de reconhecer que as
...
são a base da dimensão transcendente da religião'' (Chamorro, 2010, p.\,102). Chamorro não
foi a única a utilizar o termo \textit{utopia} associado à Terra sem mal.\footnote{Carneiro da Cunha e Viveiros de Castro (2009, p.\,95) igualmente o fizeram.}

Por que, afinal, é que, mesmo quando reconhecemos a dimensão política da
Terra sem mal, vamos considerá-la uma \textit{utopia}? Utopia, afinal ---
...
dizem os que se opõem aos Kaiowá e Guarani.
...
autêntica Terra sem mal a que almejam os Kaiowá e Guarani,
...
subumanas que os Kaiowá e Guarani têm sido obrigados a sobreviver nas
...
dos Kaiowá e Guarani nas reservas com a de porcos presos num
...
\emph{O~Globo}, 27 de maio de 2008.} se achava que os indígenas já não teriam terra
demais no Brasil. Ele respondeu dizendo que o destino do homem não
podia ser o de permanecer como uma \textit{criança aprisionada em um paraíso
verde} e que, apesar de disporem de uma porção \textit{generosa} de terra, os
indígenas no país não têm acesso a \textit{oportunidades econômicas}. Isso
deveria ser \textit{consertado}, em função do compromisso do país com os
indígenas, que, como todas as pessoas, \textit{são espíritos que desejam
transcender}.
...
um \textit{paraíso} --- ou seja, algo concedido por um poder superior, sendo,
isto sim, uma \textit{laboriosa construção co"-adaptativa}, resultado da
interação entre a \textit{engenhosidade técnica} dos indígenas e as
\textit{engenhosidades naturais} das espécies da região. 

``Deixemos o paraíso para quem precisa de paraíso'', diz ainda, defendendo
a tese de que as culturas e sociedades indígenas escolheram um \textit{caminho
civilizacional radicalmente distinto do nosso}, uma \textit{via da imanência}
--- em lugar de uma \textit{via da transcendência}. ``Os índios são os senhores
...
ideia de Mangabeira de que \textit{todas as pessoas são espíritos que desejam
transcender}?

Na prática, houve outra instituição que não a universidade ou o
indigenismo estatal, como o \textsc{spi} e a \textsc{funai}, que se encarregou de 
repassar diretamente aos indígenas uma mensagem a respeito de nosso \textit{caminho
civilizacional} e das opções que ele permitira aos Kaiowá e Guarani. 
...
desempenhavam o papel de promotoras dos benefícios do \textit{aldeamento}. Os
...
poderia ser descrito como uma \textit{libertação} a fim de realizar o
\textit{destino} daqueles homens e mulheres, de se tornarem \textit{grandes,
...
conformar a realidade de tal forma a impor aos Kaiowá e Guarani a ideia
...
longo do século \textsc{xx}. Quando se afirma que os Guarani buscam a \textit{Terra sem
mal} como quem busca algo inalcançável, que está completamente fora
...
guarani, quando se lhes atribui o epíteto de povo \textit{melancólico e
pessimista}, que \textit{perdeu a vontade de viver} talvez se esteja muito
mais próximo dos fazendeiros e missionários do que alguém gostaria de
admitir. O~que os Kaiowá vivem cotidianamente em sua política, dando a
...
\begin{bibliohedra}
\tit{cadogan}, Leon. \emph{Ayvu rapyta}. 2ª ed. Assunção: Ceaduc"-Cepag, 1997.

\tit{carneiro da cunha}, Manuela \& \textsc{viveiros de castro}, Eduardo.
``Vingança e temporalidade: os Tupinambá''. In: \textsc{carneiro da cunha},
Manuela. \emph{Cultura com aspas}. São Paulo: Cosac \& Naify, 2009 {[}1985{]}.

\tit{chamorro}, Graciela. ``Imagens espaciais utópicas: símbolos de
liberdade e desterro nos povos guarani''. \emph{Indiana} 27, 2010. 

\tit{clastres}, Hélène. \emph{Terra sem mal: o profetismo tupi"-guarani}. São
Paulo: Brasiliense, 1978.

\tit{combès}, Isabelle. ``Pai Sumé, el Rey Blanco y el Paititi''. \emph{Anthropos}
106, 2011a.

\titidem. ``El Paititi, los Candires y las migraciones guaraníes''.
\emph{Suplemento Antropológico} \textsc{xlvi} (1), 2011b.

\tit{de la cadena}, Marisol. ``Política indígena: um análisis más allá de
‘la política’''. \emph{\textsc{wan e}-Journal} 4, 2008.

\tit{gallois}, Dominique T. ``Terras ocupadas? Territórios?
Territorialidades?''. In: \textsc{ricardo}, Fany. (org.). \emph{Terras indígenas \&
unidades de conservação da natureza}. São Paulo: Instituto Socioambiental, 2004.

\tit{julien}, Catherine. ``Kandire in real time and space:
sixteenth"-century expeditions from the Pantanal to the Andes''.
\emph{Ethnohistory} 54(2), 2007.

\tit{ladeira}, Maria Inês. \emph{O Caminhar sob a luz: territorio mbya à beira
do oceano}. São Paulo: Ed. Unesp/\,\textsc{cti}/\,Fapesp, 2007.

\tit{latour}, Bruno. \emph{A esperança de Pandora: ensaios sobre a realidade
dos estudos científicos}. Bauru: \textsc{edusc}, 2001.

\tit{melià}, Bartolomeu. ``La tierra sin mal de los Guaraní: economía y
profecía''. \emph{América Indígena} \textsc{xlix} (3), 1989.

\titidem. \emph{El guaraní conquistado y reducido: ensayos de etnohistoria}.
3ª ed. Asunción: Ceaduc, 1993.

\tit{melià}, Bartomeu; \textsc{grünberg}, Georg; \textsc{grünberg}, Friedl. \emph{Los
Paĩ-Tavyterã: etnografía guaraní del Paraguay Contemporáneo}. 2ª
ed. Asunción: Ceaduc/\,Cepag, 2008 [1976].

\tit{métraux}, Alfred. ``Migrations historiques des Tupi"-guarani''. \emph{Journal
de la Société des Americanistes} 19, 1927.

\tit{mol}, Annemarie. ``Políticas ontológicas. Algumas ideias e várias
perguntas''. In: \textsc{nunes}, João Arriscado \& \textsc{roque}, Ricardo (org.). \emph{Objectos impuros. Experiências em estudos sociais da ciência}. Porto: Edições
Afrontamento, 2008.
...
\tit{noelli}, Francisco S. ``Curt Nimuendajú e Alfred Métraux: a invenção
da busca da `terra sem mal'\,''. \emph{Suplemento Antropológico} 34 (2), 1999. 

\tit{pereira}, Levi M. \emph{Imagens kaiowá do sistema social e seu entorno}.
Tese de Doutorado. São Paulo: \textsc{ppgas}/\,\textsc{usp}, 2004.

\tit{pimentel}, Spensy K. ``Violência contra os povos indígenas''. In:
\textsc{sacchetta}, Vladimir (org.). \emph{\textsc{cddph}: Conselho de Defesa dos Direitos da Pessoa Humana: uma história de resistência e luta pelos direitos
humanos no Brasil}. Brasília: Secretaria de Direitos Humanos, 2010.

\titidem. ``Cosmopolítica kaiowá e guarani: uma crítica ameríndia ao
agronegócio''. \emph{\textsc{r}@u} 4(2), 2012a.

\titidem. \emph{Elementos para uma teoria política kaiowá e guarani}. Tese
de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2012b. 

\titidem. ``Aty Guasu, as grandes assembleias kaiowá e guarani: os
indígenas de \textsc{ms} e a luta pela redemocratização do país''. In: \textsc{chamorro},
Graciela; \textsc{combés}, Isabelle (org.). \emph{Povos indígenas no Mato Grosso do
Sul}. Dourados: Ed. \textsc{ufgd}. (No prelo)

\tit{pimentel}, Spensy K. \& \textsc{moncau}, Joana A. ``Guarani Kaiowá: genocídio
surreal''. In: \textsc{ricardo}, Beto; \textsc{ricardo}, Fany (org.). \emph{Povos indígenas no Brasil 2006--2010}. São Paulo: Instituto Socioambiental, 2011.

\tit{pissolato}, Elizabeth. \emph{A duração da pessoa: mobilidade, parentesco
e xamanismo mbya (guarani)}. São Paulo: Unesp, \textsc{isa}; Rio de Janeiro:
\textsc{n}u\textsc{t}i, 2007.

\tit{sztutman}, Renato. \emph{O profeta e o principal: a ação política
ameríndia e seus personagens}. Tese de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp},
2005.

\tit{viveiros de castro}, Eduardo. \emph{Araweté: os deuses canibais}. Rio de
Janeiro: Jorge Zahar/\,Anpocs, 1986.

\titidem. ``Nimuendajú e os Guarani''. In: \textsc{nimuendajú}, Curt. \emph{As lendas
da criação e destruição do mundo como fundamentos da religião dos
Apapocúva"-Guarani}. São Paulo: Hucitec/\,Edusp, 1987.

\titidem. \emph{A inconstância da alma selvagem e outros ensaios de
antropologia}. São Paulo: Cosac \& Naify, 2002.

\titidem. ``Desenvolvimento econômico e reenvolvimento cosmopolítico:
da necessidade extensiva à suficiência intensiva''. \emph{Sopro: Panfleto
Político"-Cultural} 51, 2011.
\end{bibliohedra}
...
\footnotesize
{\itshape
As falas guarani e kaiowá mostram que a busca da Terra sem Mal pode estar na
...
\smallskip
\hspace*{\fill}\textsc{valéria macedo}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{\emph{Ore ava reko}\subtitulo{Luta dos Guarani e Kaiowá para
manutenção de~seu~modo~de~ser~e~viver}}

\addcontentsline{toc}{chapter}{\emph{Ore ava reko}, \textit{\small por Tonico Benites Kaiowá}}
\markboth{Ore ava reko}{}

\begin{flushright}
\textsc{tonico benites kaiowá}\footnote[*]{Doutor em Antropologia Social pelo
\textsc{ppgas}/Museu Nacional"-\textsc{ufrj} e membro do Conselho da Aty Guasu, Grande
Assembleia do Povo Guarani e Kaiowá.}
\end{flushright}

\noindent
\emph{Jeroky Guasu}, ``grandes rituais'', e \emph{Aty Guasu}, ``grande assembleia'', são
entendidos pelas lideranças espirituais e políticas Guarani e Kaiowá
como encontros ou reuniões e como movimentos fundamentais para a
...
Kaiowá. É~por meio da articulação das \emph{Jeroky Guasu} e \emph{Aty Guasu} que
pretendo apresentar a luta guarani e kaiowá por suas terras no Mato
Grosso do Sul. 

\section{A invasão das terras Guarani e Kaiowá}

Os relatórios oficiais do governo brasileiro, através do Serviço de
Proteção aos Índios (\textsc{spi}), revelam a presença Guarani e Kaiowá desde
...
reivindicados pelos Guarani e Kaiowá estão localizados nas margens
direita e esquerda desses rios.

Até o início do século \textsc{xx}, diversas comunidades ou famílias extensas
Guarani e Kaiowá, aliadas entre si, ainda habitavam em determinados
...
várias famílias grandes guarani e kaiowá viviam de modo autônomo nas
suas terras antigas, \emph{tekoha}, onde não passavam miséria, se distanciando
15 a 20 km das outras comunidades.\looseness=-1

As fontes documentais demonstram que o processo da primeira retirada ou
expulsão dos Guarani e Kaiowá de seus territórios antigos, \emph{tekoha
...
territórios guarani e kaiowá pela política de colonização ocorreu
...
presença dos Guarani e Kaiowá na fronteira, visto que a demarcação da
divisa entre os dois países levou à descoberta progressiva dos
territórios ocupados por Guarani e Kaiowá. No período subsequente foi
...
região em que estavam os Guarani e Kaiowá. Iniciou"-se um contato e os
...
da segunda década do século \textsc{xx}, os Guarani e Kaiowá não sofreram
...
expropriação de terras de ocupação antigas Guarani e Kaiowá, em favor
...
\textit{terra devoluta} e terra vazia, por isso o território tradicional
Guarani e Kaiowá se tornou legalmente um objeto de comércio do Governo.


Naquele contexto histórico, marcadamente a partir de 1940, os Guarani e
Kaiowá foram progressivamente expulsos de seus territórios
...
explorar a mão de obra indígena e depois expulsaram os Guarani e Kaiowá
...
indígenas guarani e kaiowá de seus territórios, envolveram"-se os
novos proprietários e fazendeiros compradores de terras indígenas,
agentes políticos locais, missionários e militares. Estes passaram a
operar com \textit{violência no atual sul de Mato Grosso do Sul},\footnote{\emph{https://bit.ly/2JTiHnX.}} contando com a
...
do Sul se intensificou, e inúmeras comunidades Guarani e Kaiowá foram
...
territórios Guarani e Kaiowá pelo Governo do Brasil, aproximadamente
...
reocupadas ou retomadas. Além disso, aproximadamente trinta mil pessoas,
ou seja, a maioria das comunidades Guarani e Kaiowá se assenta nas oito
...
aproximadamente 46 mil indivíduos Guarani e Kaiowá distribuídos em
...
várias lideranças Guarani e Kaiowá para retornar aos antigos
territórios começaram a despontar no final da década de 1970.\looseness=-1

\section{A~força das «Jeroky Guasu» e «Aty Guasu»}

\emph{Jeroky} é o termo usado para se referir a um ritual religioso Guarani e
Kaiowá, sendo que \emph{guasu} significa ``grande''. Neste sentido, o \emph{Jeroky
...
\emph{ñandereko jara}, de todas as pessoas Guarani e Kaiowá localizados no
...
indígenas, homens, mulheres, crianças e jovens. 
...
aquelas originárias dos territórios em conflito com os não indígenas, como os
...
Kaiowá, como é o caso de decisões sobre a reocupação dos territórios
tradicionais. Assim, as \emph{Aty Guasu} são o principal foro de discussão e
de decisão política articulada entre as lideranças Guarani e Kaiowá que
...
\emph{tekoha} reocupada em litígio, \textsc{ti}s e reservas ou aldeias. Além das \emph{Aty
Guasu}, a atuação e a valorização dos saberes e conselhos dos líderes
espirituais \emph{ñanderu} Guarani e Kaiowá são sempre vitais nos processos de
...
ativar e valorizar os modos de ser e viver Guarani e Kaiowá,
...
colonial dos territórios tradicionais Guarani e Kaiowá pelo \emph{karai}, não
indígena: Estado/\,governo e fazendeiros. Mesmo antes do surgimento da \emph{Aty
Guasu} pela recuperação dos \emph{tekoha} já aconteciam as \emph{Jeroky} Guarani e
Kaiowá para nosso fortalecimento.
...
No seio da \emph{Aty Guasu}, as lideranças Guarani e Kaiowá reivindicantes das
...
As narrativas dos mais idosos Guarani e Kaiowá revelam que essas
...
e viver Guarani e Kaiowá \emph{ava reko}. Por essa razão, entre essas
...
para a manutenção de modo de ser e viver Guarani e Kaiowá \emph{reko}.
...
\chapter*{Sonhos e conhecimentos na vida guarani\subtitulo{Uma experiência de pesquisa na universidade}}

\addcontentsline{toc}{chapter}{Sonhos e conhecimentos na vida guarani, \textit{\small por Karai Mirim}}
\markboth{Sonhos e conhecimentos\ldots}{}

%\@openrighttrue\makeatother
\begin{flushright}
\textsc{karai mirim (algemiro da silva)\footnote[*]{Professor na aldeia Brakui,
...
Guarani'', em 16 e 17 de outubro de 2013, acrescido de pequenos trechos de seu
Trabalho de Conclusão de Curso na Universidade Federal Rural do Rio de
Janeiro. {[}\textsc{n.\,orgs.}{]}.} Infelizmente também tenho nome
...
Guarani e com os \emph{juruá}.

O~pensamento guarani foi negado pelos \emph{juruá} ao longo do tempo. A~gente
achava que o conhecimento dentro da comunidade, nossa vivência, não
significava nada para os \emph{juruá}. Mas a partir do momento que fui
...
Federal Rural do Rio de Janeiro, e aprendi que para os \emph{juruá} é
...
Paranaguá, no Paraná, ele me contou assim: ``Ah, ontem eu fui lá pro Brakui''.
...
perguntas. Elas falam que é muito difícil agora devido ao \emph{juruá}, os
...
sobre isso na Universidade.\looseness=-1
...
Estudar pode estudar, mas viver sempre em Guarani, sonhar em Guarani.\looseness=-1
...
\smallskip
\hspace*{\fill}\textsc{dominique tilkin gallois}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Os «xondaro» e a circulação de\break saberes no mundo de hoje}
\addcontentsline{toc}{chapter}{Os «xondaro» e a circulação de saberes no mundo de hoje, \textit{\small por Jera Poty Mirῖ}}
\markboth{Os xondaro\ldots}{}

\begin{flushright}
\textsc{jera poty mirῖ (giselda pires de lima)\footnote[*]{Professora na escola da aldeia Tenonde Porã, São Paulo /\textsc{sp}.}}
\end{flushright}  
...
para comprar pilha tinham que estar com os \emph{juruá}, e a maioria não
topava muito. A~relação com os \emph{juruá} era muito distante. Nessa época,
...
influência do mundo do \emph{juruá} por conta da energia elétrica e da
...
para o mercado de \emph{juruá}, são os pais. Então o que o filho sabe comer
hoje foi o pai e a mãe que ensinou. Não adianta o menino fazer quinze
anos e quererem enfiar goela abaixo um \emph{mbyta}, a comida feita de milho\ldots{}
...
do \emph{juruá}, da energia elétrica. Para alguns homens guarani, quando não
...
até que eles percebessem e parassem de rir ou de falar. Isso acontecia
...
\textit{transmissão de saberes}, mas estou gostando mais da ideia de
\textit{circulação}. Nessa circulação de ações voltadas para o aprendizado
...
O~povo Guarani foi um dos primeiros povos a ter contato com os \emph{juruá}. E
...
\emph{juruá}, ainda têm pessoas que não sabem falar o português, que se mantêm
...
aprender a falar a língua do \emph{juruá} pra saber lidar melhor com as coisas
do \emph{juruá} que chegam na aldeia.\looseness=-1

No início, quando eu tinha doze ou treze anos, eu lembro bem que a ideia
de aprender a língua ou os conhecimentos \emph{juruá} era pra lutar pelos
...
do \emph{juruá}, se politizar e conhecer seus direitos, a escola está trazendo
...
\emph{juruá} fala eu não entendo tudo. Às vezes quando o Guarani fala eu
...
\footnotesize
{\itshape
A~palavra \emph{xondaro}, que quer dizer tanta coisa, para os Guarani Mbya é
...
\smallskip
\hspace*{\fill}\textsc{daniel calazans pierri}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Processos de aprendizado pelos olhos\break das crianças Guarani Mbya}

\addcontentsline{toc}{chapter}{Processos de aprendizado pelos olhos das crianças Guarani Mbya, \textit{\small por Alice Haibara}}
\markboth{Processos de aprendizado}{}

\begin{flushright}
\textsc{alice haibara}\footnote[*]{Doutora em antropologia pela \textsc{usp} e membro do
\textsc{ce}st\textsc{a}.}
\end{flushright}
...
relacionam com as formas de aprendizado características da escola.\looseness=-1
...
diferenciados do mundo adulto (Cohn, 2000). Quando buscamos entender as
...
Terra. Jera Guarani (2008, p.\,39) afirma que:
...
(Melo, 2008, p.\,85). Como a alma da criança está fortemente ligada ao pai
...
afirmada de que \textit{a vida de cada um é seu caminho de buscar e aprender}.
A~pesquisadora associa o processo de aprendizado à noção de um \textit{caminho}
...
e também para facilitar o \textit{caminhar junto}, quando o pai \textit{marca os
...
dizer que as ações de \textit{acompanhar} os pais e mães imitando as suas
...
mostram que entre os Guarani o conhecimento é construído \textit{caminhando e
...
possível verificar algumas práticas de \textit{aprender junto} realizadas no
corpo e por meio do corpo.\looseness=-1
...
\emph{petỹgua}, ``cachimbo'', vão sendo acesos, os homens vão se levantando e
...
sopro, sucção, cantos e do \emph{petỹgua}. De acordo com a menina, o \emph{xeramõi}
...
termo ``satanás'', e que é jogada no fogo para que \textit{\emph{Anhã} pegue de novo a
...
mesmo. Sabe quando o \emph{xeramõi} fica \textit{argh, argh} (sonorização), é que tem
...
A~menina também explicou a função da fumaça e do \emph{petỹgua}:

\begin{quote}
O~\emph{petỹgua} serve só pra \emph{Nhanderu} ouvir. Quando a gente fuma a gente
...
guarani. Montardo (2002, p.\,12) também
...
cotidianos se constitui num \textit{caminho a percorrer ao encontro dos
...
exemplo, picar o fumo, acender os \emph{petỹgua}, cuidar do fogo, esfriar a
...
fazem. Quando vão até o \emph{amba’i}, ou fumam \emph{petỹgua}, por exemplo, elas
...
(2010, p.\,21): ``copiar é imitativo, na medida em que ocorre sob
...
da percepção, que se constitui \textit{como uma atividade de todo o organismo
num ambiente} (Ingold, 2010, p.\,21). O~\textit{ambiente} é compreendido aqui,
...
vivências coletivas também é possível perceber a prática de \textit{aprender
junto} que se constitui desde a infância.

Nesse sentido, temos que o próprio termo guarani que designa o processo
de aprender faz referência às práticas de \textit{aprender junto}, como
demonstra Melissa Oliveira (2005, p.\,88) ao apontar que, de acordo com
...
\section{A~escola e os modos de aprendizado guarani}
...
professores, sendo seis \emph{juruá}, ``não indígenas'', e sete guarani.
...
Eckart (2010, p.\,36) aponta que na escola localizada na Aldeia Krukutu,
...
familiares se direcionam para este espaço de \textit{educação diferenciada},
...
teriam ficado muito \textit{barulhentos} e \textit{sem respeito pelos mais velhos}.
...
de que \textit{cada pessoa sabe coisas diferentes}, o que é muito
...
iguaizinhos. E~aí então fica como uma escola \emph{juruá}.
\end{quote}
...
assim como outras instituições e relações que vêm do mundo \textit{juruá}, não
...
No entanto, a \textit{escola diferenciada} em si carrega muitas contradições,
...
\begin{bibliohedra}
\tit{clastres}, Helene. \emph{Terra sem mal: o profetismo tupi"-guarani}. São
Paulo: Brasiliense, 1978.

\tit{cohn}, Clarice. \emph{A~criança indígena: a concepção Xikrin de infância
e aprendizado}. Dissertação de Mestrado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2000.

\tit{eckart}, Jan"-Arthur Bruno. \emph{O~saber imanente mbya"-guarani e a escola
...
\tit{ingold}, Tim. ``Da transmissão de representações à educação da
atenção''. \emph{Educação} 33(1), 2010.

\tit{lima}, Giselda Pires de (Jera Guarani). Kyringue reko. \emph{Crianças
guarani}. Trabalho de Conclusão de Curso. São Paulo: Fisp/\,\textsc{usp}, 2008.

\tit{melo}, Clarissa Rocha de. \emph{Corpos que falam em silêncio. Escola,
corpo e tempo entre os Guarani}. Dissertação de Mestrado.
Florianópolis: Universidade Federal de Santa Catarina, 2008.

\tit{menezes}, Ana Luiza Teixeira. ``O~corpo `educado' na dança
Mbya"-Guarani''. \emph{Tellus} 4(7), 2004.

\tit{montardo}, Deise Lucy Oliveira. \emph{Através do} mbaraka. \emph{Música, dança e
xamanismo guarani}. São Paulo: Edusp, 2009

\tit{oliveira}, Melissa. ``Nhanhembo’é: infância, educação e religião
entre os Guarani de M’Biguaçu'', \textsc{sc}. \emph{Cadernos de Campo} 13, 2005.

\tit{testa}, Adriana Queiroz. \emph{Palavra, sentido e memória. Educação e
memória nas lembranças dos Guarani Mbya}. Dissertação de mestrado. São
Paulo: Faculdade de Educação/\,\textsc{usp}, 2007

\tit{toren}, Christina. ``Making history: the significance of childhood
...
\smallskip
\hspace*{\fill}\textsc{cristine takua}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Tornar"-se adulto sem deixar\break de ser gente\subtitulo{Fazer (crescer) parentes}}
\addcontentsline{toc}{chapter}{Tornar"-se adulto sem deixar de ser gente, \textit{\small por Adriana Queiroz Testa}}
\markboth{Tornar-se adulto\ldots}{}

\begin{flushright}
\textsc{adriana queiroz testa}\footnote[*]{Pesquisadora de pós"-doutorado do Centro
de Pesquisa em Etnologia da \textsc{unicamp}.}
\end{flushright}

\noindent
Neste texto,\footnote{Este texto é uma versão resumida do quinto capítulo
da minha tese de doutorado. Recebi o apoio da Fapesp para
...
de relações. A~noção de \textit{caminhos} é tomada num sentido amplo que abrange
...
sufixo -\textit{gue}, seria, literalmente, uma ex"-sombra ou aquilo que foi
sombra. Com a desintegração dos componentes da pessoa, o -\textit{ã} se
...
\emph{nhandereko}.\footnote{O~termo \emph{nhandereko} --- \emph{nhande} é o pronome pessoal da primeira pessoa plural inclusiva, aqui com atribuição possessiva mais
...
entre os Awá Guajá, quando usam o termo \emph{rikô} (2010, p.\,264--65).} Nestes
...
Viveiros de Castro, 2002, p.\,137 e 164.} trazem à tona o perigo sedutor de
...
aldeia. Ver Testa, 2014, p.\,2--17.} localizados nas regiões sul e
...
\textls[-10]{Nesta mesma direção, outras pessoas, cujos relatos veremos mais adiante,
...
de sofrer uma transformação irreversível, \emph{jepotá}, por meio da qual,
...
relações, cujo placar está em perpétuo desequilíbrio.\looseness=-1
...
tipo de comunicação, criam"-se caminhos para os processos de alteração:\looseness=-1
...
``Quando escurecer, se você ficar vagando, vai sofrer
transformação. Você precisa lembrar que quando escurece é para dormir.
Você precisa cuidar de si e não ficar fazendo brincadeiras ou rindo. Quando
...
da sua transformação. No original: ``Ha’e ko kunhãgue’i, yma, yma, kunhãgue’i por no ojepotáa py ko ikã guaxu
ja’ea ha’e rami ramove onhangareko ma omemby re. // Ka'aru ovy ramo omboguapy ma, onheno aguã'i py. Pyavy ndoikoi, aỹgua rami e'ỹ, nomoingovei ma. // Ha'e rami ramo yma, ymave ko kunhãgue'i onhe'erendu va'ekue nguu ko oxy
onhe'erendu. Mba'e re pa? Ijayvu voi ty omombe'u voi ty: ``Pytũ
rupi ha'e va'eve reikovy ma, rejepotá `rã. Pytũ ramo nema'endu'a ma reke
...
rire pytũ ma, nanderoryaivei ma''. // Mokoĩve omongeta porami, avakue ha'e rami avi ae. Kunumigue'i inhe'ẽ
...
rami vy py ogueraa kuaapa okuapy. // Ja pytũ ramo, opuka, inhegue va’erã, opuka va’e onhendu mombyry, ha’e
...
esse tipo de transformação, por eles designada \emph{jepotá}, observando
...
irreversível, os Mbya dizem que o corpo já \textit{mudou} ou \textit{virou},
...
pode ser perfurada, a não ser pelo uso de armas especiais.\looseness=-1
...
\begin{quote}
\textls[-10]{E é verdade que quando um jovem se tornava adulto não queriam que ele
...
``Se você se descuidar, vai sofrer transformação, meu filho. Vai
...
aconselhavam. ``Não coma pelos caminhos {[}na mata{]}''
diziam, ``não coma quando for tarde, quando escurecer, não
coma'', assim diziam os antigos. E os antigos também falavam:
``Onde estiverem as moças, não fique olhando''.

E as moças, cujos seios começavam a crescer, eles aconselhavam assim:
``Não, minha filha, não entre no rio! Não tome banho na água que
corre! Vocês já têm seios {[}já são mulheres adultas{]}, por isso,
não é bom fazerem isso, se vocês se descuidarem, vão sofrer
transformação pelo dono da pedra, pelo dono da água, pelo dono que mora
na árvore'', diziam tudo isso antigamente.\footnote{No original: ``Ha'e gui anhete, ko inhe'ẽ nguxu ma vy, ndoipotai ha'e py opa marã rei
...
vy. // `Rejejogua vai’i ‘rã, rejepotá ‘rã xera’y. Rejepotá ‘rã ko yvyra rovapy
ja re, rejepotá ‘rã ko yvy ja re, rejepotá ‘rã ija re, rejepotá ‘rã ita
ja re', he’i va’ekue ymagua kuery. // Ha'e rami ma ore kuery, orekunumi, orenhe'ẽ nguxu py rokyje. Rokyje ma ha'e mba'e he'i ague'i rami roiko `rã. // Ha'e gui jevy anhete opamba'e"-mba'e'i py ma ymagua kuery ijayvu va'ekue
gua'y kuery pe, omongeta va'ekue. `Anyĩ ke tape re rekaru'
he'i, `anyĩ ke ka'aru ma rekaru, pytũ re ekaru eme', he'i
va'ekue ymagua kuery. `Ko kunhãtaĩgue ikuai'i va'e, anyĩ rema'ẽ
teri', he'i va'ekue ymagua kuery // Ha'e gui kunhãtaĩgue'i ha'e rami avi, ikã ramo"-ramo va'e, ikã guaxu"-guaxu va'e, omongeta: `Anyĩ ke, xememby, yakã rupi rive ke
eiko eme! Yxyry py ke ejau eme! Penekã ma' he'i, `penekãmba
ma' he'i, `nda'evei, ha'e rami pejejogua vai `rã, pejepotá `rã,
ita ja re, yy ja re, yvyra rovapy ja re', he'ipa va'ekue ma''.}
\end{quote}

\textls[-10]{Ele se refere a problemas que têm como eixo central a necessidade de
...
refere à própria filha{]}. ``Não seja brava, você não deve ser
brava. Para viver, não é bom você ser brava demais.''\footnote{No original: ``Takua ro py kuee aĩ. Ivai ja e'ỹ aguã va'e py ae nhambo'e inheguea py.
Ivai rive rive. `Ndevai eme, ndevai eme ranhe. Nda'evei teri
...
\textit{transição entre o que se é e o que se está por ser} (2009, p.\,163). Por
...
temperança, caracterizada por um modo de ser calmo.\footnote{Montardo, 2009, p.\,163--64.} 
\end{quote}


A necessidade de \textit{esfriar} a raiva também está associada ao risco de que
ela se transforme em doença ou desencadeie ações de vingança veladas, por meio de feitiçaria, ou explícitas, por meio de brigas violentas.
...
Nesse estado, como Karai ressalta, a pessoa \textit{vira outra}, e suas
capacidades de percepção são alteradas: \textit{escurece nossa visão}.
...
``loucura'', \emph{akã vai} ou \emph{akanhy},\footnote[9]{Os Mbya frequentemente usam
...
\emph{ja}, de diferentes lugares e objetos, como animais, plantas etc., as
...
\textls[-10]{Por exemplo, Jaxuka, uma senhora idosa que mora num \emph{tekoa} paulista,
...
substâncias, traz o perigo de perder a condição humana.}\looseness=-1

\begin{quote}
Enquanto a moça socava milho, também falavam para ela assim: ``não
fique olhando para a mata; não olhe pra lá, fique só socando, você tem
apenas que socar'', diziam. ``Não fique olhando para a mata
(lit. copa {[}das árvores{]} da mata)'', diziam. ``Se ficar
...
escurecia, não a deixavam mais ficar de pé.\footnote{No original: ``Ha'e rami vy ae tu omba'exo merami aipo avi he'i: `ema'ẽ eme
ka'aguy rovapy re, kii ema'ẽ eme emba'exo tema, mba'exo tema', he'i.
`Ema'ẽ eme ka'aguy rovapy re', he'i. `Ka'aguy rovapy ja
ndere oma'ẽ okuapy `rã', he'i. // Pee py, Kuaray oo ramo ja oo py omoinge ju ma. Kuaray’ã rupi ja nomopu’ãvei ma''.}
\end{quote}
...
vem.\footnote{Refere"-se aos sujeitos não humanos que são atraídos pelo
cheiro da urina que se propaga pela mata.} E~isso não é bom. Quando menstrua pela primeira
vez, tem que sentar e sentar {[}passar pelo processo de reclusão{]}. Assim
é bom.\footnote{No original: ``Ha’e rami vy py, yma, yma. Ha’e va’e noendui va’e ayvu oxy kuery ayvu noendui, nguu ayvu noendui’i va’e, va’e"-va’e’i rive tu ojepotá. Ha’e
oendu va’e ko oxy ayvu ombojerovia, oxy avyu ombojerovia ma, mba’eve
ndoikoi, ndojepotái. Oiko porã’i. Guaimi peve. Nim mba’eve ma ha’e va’e
re oikuaa pota ramo ma. // Heta mba'e nhaendu rã amongue henda py. Kunhãgue'i, avakue'i inhe'ẽ nguxu va'e tape rupi rive ndoipotai okuaru. Mba'e re pa? Porque avakue
...
\textit{encantamento sexual, o que se denomina \emph{odjepotá}} (1962, p.\,85). Mas
...
circunstâncias para se fazer perceber, \emph{jeexauka} e \emph{nhemoendu}, mas
todos estes exigem aprimorar a percepção, \emph{exave} e
\emph{enduve}.\footnote[11]{\emph{Exa} está associado à percepção através da visão;
...
Quando a voz de um menino começa a engrossar, \emph{nhe'ẽ nguxu}, indicando que ele está se
...
crescimento dos cultivos por incomodar seus donos não humanos.
...
Inclusive, uma das maneiras de se referir à menstruação é \emph{ndajauvei}, \textit{não
...
vai e faz o \emph{nhimbe}\footnote[12]{O~\emph{nhimbe} é um jirau usado pela moça durante
...
você conta para sua mãe e ela ficará feliz, dizendo: ``fico feliz
por minha filha me contar'', assim ela dirá. Se você quiser viver bem,
você vai contar. ``Isso é muito bom'', ela vai dizer.
...
ninguém vê-la ou reconhecê-la, eles fecham tudo completamente.
...
Então, falariam para ela: ``fique reta, fique assim, não fique de
outro jeito, para fazer você ficar reta, fique assim. Caso
contrário, ficará com as costas curvadas e todos vão tirar sarro de
você''.

Depois, ensinariam: ``Não fale mal dos outros''.\footnote{No original: ``Ha’e vy ma inhegue’i primeira, he’ia rami juruá ayvu py, ijypy’i ete tu
nhande reko ojekuaa ‘rã kyrĩ’i, ko’i va’e’i nhanekuã’i apy’i re rive
otyky’i. {[}\ldots{}{]} // Ha'e rami ma kyrĩ'i rima ojekuaai kyrĩ'i ete nekaxõ'i ha'e va'e rive'i
ojekuaa, ha'e va'e reikuaa'i vy remombe'u, ndexy oguerovy'a ete:
`ha'evete xememby omombe'u', he'i. Reiko porãxe rã remombe'u.
`Kova'e ramo ha'evete', he'i. // Ha'e ramive ma, nde'a'i ojayapa nemokanhy aguã e'ỹ vy nhimbe ava va'e ojapo yvate. // Ha’e va’ekue nemoĩ ma nem nderexakuaa aguã ma ndoipe’ai, opa
ombotypa’i. // Ha’e rami ma yma ikuai, ha’e rami vy rima yma ikuai va’e, nda’ijayvu
katu vaipai raka’e.
Aipo e'i vy, omoẽ um mês yvate oĩ. {[}\ldots{}{]} // Ha'e rami ma je, ha'e ma aipo e'i avi: `eĩ yvi merami ma reĩ, eĩ
yvi, merami eĩ eme. Merami renhemboyvi. Ha'e rami e'ỹ rire ndekupe vy
rei rã ndejojaiai'. // Ha'e va'e py ae ma tu ombo'e avi: `ndeayvu katu vai rei eme
ta'vy'\,''.}
\end{quote}

Jaxuka afirma que o cabelo das moças é cortado durante a primeira
menstruação para que não se percam, \emph{mokanhy aguã
e’ỹ}.\footnote[13]{Conferir nota nº 9 sobre \emph{kanhy}.} Em paralelo,
Jera comenta que o cabelo das moças, \emph{a}, contém tanto suas
\textit{substâncias} e \textit{fluidos} como as experiências que viveram, seus
comportamentos e estados. Neste sentido, o cabelo de meninas que até
então foram \textit{bravas} ou \textit{desobedientes} conteriam substâncias
...
\textit{limpar} a pessoa das suas substâncias e experiências anteriores, assim
...
Possivelmente este seja mais um aspecto do \textit{serviço de noiva} que um
genro presta aos sogros, retribuindo parcial e parceladamente, por meio
de uma parte do cabelo de sua filha, a mulher que desposou. 
...
\textls[-10]{Neste sentido, Jaxuka também explicou que, quando teve a primeira
...
visitantes que receberia, provavelmente os parentes do marido.}\looseness=-1
...
alimentávamos. Também me fizeram socar {[}milho{]}. ``Soque'',
diziam, ``soque, assim vai saber alimentar suas filhas'', diziam.
...
tudo, era assim que fazia. ``Debulhe, dê. Assim, futuramente, você
vai saber dar as coisas para seus visitantes'', diziam. 

Foi assim que me criaram. Nossa! Mesmo que eu quisesse comer mais...
Taaa!!! ``Você tem que dar, dar, dar para uma boquinha, três
boquinhas, e você comer pouco. E, depois de aprender isso, os muitos
visitantes que sentarão {[}que você receberá em sua casa{]},
você saberá alimentá-los''. Assim me disseram. E~era verdade!\footnote{No original: ``Xee aiko jave nei jipoi radio naendui, nem televisão naendui, nei
...
`Emba'exo', he'ia rami rire vy, `nememby reta ramo
remongaru kuaa `rã', he'i.  // Peteĩ oĩ avei, iporayvu aguã ombo'e raka'e. Xee ha'e rami ae rire ma, aỹ reve akaru'i ovypa qualquer coisinha ame'ẽ `rã takua re'ẽ, ou pakova'i,
mba'e. // Merami aipo e'i xejaixe, kova'e nunga aexy. peteĩ'i hi'y oexy, ha'e vy
ma xo'o'i koo'i rupigua'i ome'ẽ. // Nhimbe py oĩ va'e pe ma kova'e nunga ae avi oexy uka'i vy ma ojykypa'i,
...
karamboae. `Ejyky, eme'ẽ, nami rire vy ma ndepoua'i `rã mba'emo
reme'ẽ kuaa'i `rã katu', he'i. // Ha'e rami ma xee xerereko karamboae. Nhande! Ha'uxeve'i teĩ avei\ldots{}
Taaa!!!! `Eme'ẽ, eme'ẽ, eme'ẽ peteĩ juru'i, mboapy juru'i ma,
...
pessoa jovem precisa aprender a comer \textit{junto} e a comer \textit{igual} aos seus
parentes próximos:
...
A~partir destas falas sobre a importância de comer \textit{com} e \textit{como} parentes,
...
inclusive interferindo, com maior ou menor eficácia, na escolha do ou da
cônjuge.

De todo modo, os jovens são protagonistas principais na busca por
parceiros, seja para casar ou apenas \textit{namorar}, prática intensificada
...
por diferentes \emph{tekoa} à procura de alguém. Quando isso se concretiza,
eles não apenas ``acham'', \emph{jou}, uma esposa, mas também se inserem na sua
rede de relações e passam a \textit{trabalhar} para o sogro. Em algumas
circunstâncias, dependendo da força política da família do rapaz, é
possível que a moça vá residir junto aos parentes dele.\footnote[14]{Um
...
\textit{outros parentes}. Transcrevo a seguir um trecho dessa
narrativa:\footnote[15]{Esta narrativa foi contada por Vera durante os
...
\begin{quote}
\textls[-15]{Tinha um Mbya e a família dele disse: ``Agora você vai para a aldeia dos
...
parentes porque minha família pediu\ldots'' }\looseness=-1
\end{quote}

\textls[-18]{Quando esta narrativa foi contada, o foco do narrador era exemplificar
...
diferentes coletivos mbya, em que os \textit{outros parentes} muito
...
experiências, faz"-se crescer a pessoa e também suas redes de relações.}\looseness=-1

\textls[-10]{Ademais, assim como os Mbya criam e fazem crescer suas relações de
...
fazer parentes à maneira dos deuses.}\looseness=-1


\begin{bibliohedra}
\tit{gallois}, Dominique Tilkin. \emph{O~movimento na cosmologia waiãpi:
criação, expansão e transformação do universo}. Tese de Doutorado
(versão corrigida). São Paulo: \textsc{ppgas}-\textsc{usp}, 1996.

\tit{garcia}, Uirá Felippe. \emph{Karawara. A~caça e o mundo dos Awá-Guajá}.
Tese de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2010.

\tit{garlet}, Ivori José. \emph{Mobilidade mbyá: história e significação}.
Dissertação de Mestrado. Porto Alegre: \textsc{puc}-\textsc{rs}, 1997.

\tit{ladeira}, Maria Inês. \emph{Espaço geográfico guarani"-mbya. Significado,
constituição e uso}. Maringá: Eduem; São Paulo: \textsc{edusp}, 2008.

\tit{mccallum}, Cecilia. ``Intimidade com estranhos: uma perspectiva
...
\tit{schaden}, Egon. \emph{Aspectos fundamentais da cultura guarani}. São
Paulo: Difusão Europeia do Livro, 1962.

\tit{testa}, Adriana Queiroz. \emph{Caminhos de saberes guarani mbya: modos de
criar, crescer e comunicar}. Tese de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp},
2014.

\tit{viveiros de castro}, Eduardo. \emph{A~inconstância da alma selvagem e
outros ensaios de antropologia}. São Paulo: Cosac \& Naify, 2002.

\titidem. \emph{Araweté: os deuses canibais}. Rio de
Janeiro: Jorge Zahar/\,Anpocs, 1986.
\end{bibliohedra}
...
\begin{adjustwidth}{-2.7cm}{} 
  \vspace{-3.1cm}
 \includegraphics[width=136mm]{./img/GUARANIS-img4_crop2.jpg}	
\end{adjustwidth}
...
\chapter*{O~que nos levanta sobre a terra\subtitulo{Alegria e saudade fazendo parentesco}}

\addcontentsline{toc}{chapter}{O~que nos levanta sobre a terra, \textit{\small por Ana María Ramo y Affonso}}
\markboth{O~que nos levanta\ldots}{}

%\@openrighttrue\makeatother
\begin{flushright}
\textsc{ana maría ramo y affonso}\footnote[*]{Doutora em antropologia pela
...
estado de vida, condição, estar, costume, lei, hábito'' (1876, p.\,363,
...
indagar sobre as \textit{formas de construção da pessoa} supõe, entre os povos
ameríndios, se questionar sobre os corpos (1979, p.\,4). Desta perspectiva,
antes que grupos corporados, relações de parentesco formam \textit{corpos de
parentes}.\footnote{Sobre
esse tema, ver Souza (2004) e Viveiros de Castro (2002).} Como
qualquer corpo, tais \textit{corpos de parentes} estão em constante
...
\textls[-10]{A~ideia que gostaria de explorar aqui, de modo a abordar o tema das
...
e morte, \emph{jepotá}. No jogo do parentesco, é preciso criar aproximações a
...
solte a fumaça em cima dela, \textit{limpando"-a} ou \textit{benzendo"-a}, como
...
suficientemente esclarecidos, ver também Ladeira (1992, 2008, p.\,64--65),
Macedo (2009, p.\,286) e Pierri (2013).} pelo que pude entender por meio
...
\textit{acostume} entre os seus parentes. O~parentesco é, em alguns de seus
...
transformação, \emph{jepotá}. Esta pessoa é, assim, subtraída aos poucos do
corpo de parentesco Guarani.

\textls[-25]{Neste contexto, a vida é por vezes um campo minado, onde simpatias podem
facilmente virar paixões, e antipatias, raiva. Este \textit{campo minado} na
...
meus interlocutores --- o pessoal da aldeia Araponga, em Paraty, no Rio de Janeiro,
...
\emph{tekoaxy}, por ser um lugar onde \textit{se pega doença} e onde as pessoas
enfrentam muitas adversidades''. Como diz o \emph{tamoĩ} Nivaldo, da aldeia
...
O~\emph{nhe’ẽ} dos Guarani está em movimento; ele fica indo e
voltando, entre a \emph{yvy rupa} e o \emph{amba}, ``cidade'', ``lugar'', de \emph{Nhanderu}, o \emph{yvate}, o ``alto'', e quando vai, a pessoa fica fraca e pode ficar doente
...
uma \emph{juruá} --- termo com que os Guarani se referem aos brancos --- que o
...
\textls[-10]{``Quando o \emph{nhe’ẽ} da criança não quer ficar'', me explicou o
...
seu \textit{nome indígena}, pelo seu \textit{nome sagrado}, como costumam dizer os
...
\textls[-10]{Nas falas dos Guarani é recorrente a ideia de que para querer ficar é
...
seduzido, ser convencido a ficar, porque o \textit{corpo de parentes} do qual
...
\textls[-10]{Antes que um ser a"-social, o \emph{nhe’ẽ} é supra"-social. Ele vive numa
...
milho e do mel, do \emph{guembe}, ``aningaúba'', do \emph{ka’a}, ``erva"-mate'' etc.,
...
conducta'', contaram os Guarani a Cadogan (1959, p.\,71). Palavras se
...
permite, no final das contas, a duração na Terra.\footnote{Ver Pissolato, 2007.}
...
\textls[-10]{Os mais velhos têm mesmo muito conhecimento para passar. Mas, às vezes, é
difícil ter palavras para passar e não ter entendimentos para
recebê-las. Foi isso que Vera Mirim, da aldeia Rio Silveira, explicava
...
é segundo ele \textit{mais antiga}, não quer geladeira e nem televisão em
casa. Ele quer explicar essas coisas aos filhos, mas tem que se cuidar
porque eles não querem ouvir e \textit{é importante evitar a briga}. ``Mesmo
...
\textls[-15]{Às vezes é difícil mesmo. ``Quando falo isso, falo da dificuldade que eu
...
kuery}, força e coragem (\emph{mbaraete} e \emph{py’a guaxu}, literalmente
...
``estados ontológicos vacilantes''\footnote{Ver Lima, 2005.} --- em que o resguardo
é necessário, como a primeira menstruação e a couvade.

\textls[-10]{Deixar de acostumar"-se entre os próprios \emph{mbya} abre a possibilidade para
...
contrário. Assim, se alguém entra em um processo de \emph{jepotá},
...
do \textit{corpo de parentes} de origem, se consuma quando seus antigos
...
com outros, com \textit{aqueles que não vemos}, ao preço de brigar e se
...
\textls[-20]{Os mortos, na sua condição de \emph{ãgue}, querem ficar junto com os vivos; de
...
\textls[-20]{``Teu parente que morreu vem junto com você. Caminha com
...
\emph{Ãgue} fica com dó da pessoa. Por isso que \emph{mbya} tem que pegar \emph{petỹgua}
à tardezinha, quando a noite está chegando. Pegar \emph{petỹgua} e se
...
\emph{petỹgua}, \emph{tataxina}, levanta um muro que distancia os mortos dos
...
de acontecimentos experimentados ora pelo \emph{nhe’ẽ}, ora pela sombra, \emph{ã}, em suas andanças pelos vários mundos, pelos vários patamares
...
com o não esquecimento. \textit{\emph{Xemaendua Nhanderure}, eu lembro de
...
aquele que ajuda a compor o seu \textit{corpo de parentes} --- troca de
alimentos, por exemplo, como quando os \emph{ãgue} oferecem comida
às pessoas em sonhos. Como disse logo acima, este circuito é também,
inevitavelmente, o da feitiçaria, ou\textit{arte} como costumam dizer os Guarani,
...
Andar junto com \emph{Nhanderu}, \textit{juntar"-se ao seu costume}, por assim dizer, é
a caminhada para compor o seu \textit{corpo de parentes}. Então, para ter
...
mal'' ou ``imperecível'',\footnote{Ver Pierri, 2013.} ou de levar a vida e criar
...
\textls[-10]{\emph{Nemaendua i Nhanderure}. Lembrar de \emph{Nhanderu} para ele olhar em você.
...
\begin{bibliohedra}
\tit{cadogan}, León. Ayvu rapyta. \emph{Textos míticos de los Mbyá-Guaraní del
Guairá}. São Paulo: \textsc{fflch}-\textsc{usp}, boletim n. 227, série Antropologia n. 5,
1959.

\tit{clastres}, Hélene. \emph{Terra sem mal}. Roraima: Ed. Tapé, 2007 [1978].

\tit{deleuze}, Gilles. ``Em que se pode reconhecer o estruturalismo?''.
In: \textsc{châtelet}, François (org.). \emph{História da filosofia: ideias,
doutrinas}. Rio de Janeiro: Zahar. Editores, 1982.

\tit{ladeira}, Maria Inês. \emph{Espaço geográfico Guarani"-Mbya}. São Paulo:
Edusp, 2008.

\titidem. \emph{O~caminhar sob a luz: o território Mbya à beira do oceano}. 
Dissertação de Mestrado. São Paulo: \textsc{puc}-\textsc{sp}, 1992.

\tit{lima}, Tânia Stolze. \emph{Um peixe olhou pra mim: o povo Yudjá e a
perspectiva}. São Paulo: Unesp, \textsc{isa}; Rio de Janeiro: \textsc{n}u\textsc{t}i, 2005.

\tit{macedo}, Valéria. \emph{Nexos da diferença. Cultura e afecção em uma
aldeia guarani na Serra do mar}. Tese de Doutorado. São Paulo:
\textsc{ppgas}-\textsc{usp}, 2009.

\tit{melià}, Bartolomeu. \emph{El Guarani: experiência religiosa}. Asunción:
Ceaduc"-Cepag, 1991.

\tit{montoya}, Antonio Ruiz de. \emph{Vocabulário y tesoro de la Lengua
...
\tit{pissolato}, Elizabeth de Paula. \emph{A~duração da pessoa. Mobilidade,
parentesco e xamanismo mbya (guarani)}. São Paulo: Unesp, \textsc{isa}; Rio de
Janeiro: \textsc{n}u\textsc{t}i, 2007.

\tit{seeger}, Anthony; \textsc{da matta} Roberto; \textsc{viveiros de castro}, Eduardo. ``A construção da pessoa nas sociedades indígenas brasileiras''. \emph{Boletim do
Museu Nacional} 32, 1979. 

\tit{souza}, Marcela Coelho de. ``Parentes de sangue: incesto, substância
e relação no pensamento Timbira''. \emph{Mana} 10(1), 2004.

\tit{viveiros de castro}, Eduardo. \emph{A inconstância da alma selvagem}. São
Paulo: Cosac Naify, 2002.

\tit{wagner}, Roy. \emph{A~invenção da cultura}. São Paulo: Cosac Naify, 2010
[1981].
\end{bibliohedra}
...
\smallskip
\hspace*{\fill}\textsc{marina vanzolini}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Parentesco e emoções\subtitulo{Algumas conexões no «alegrar"-se»}}

\addcontentsline{toc}{chapter}{Parentesco e emoções, \textit{\small por Elizabeth Pissolato}}
\markboth{Parentesco e emoções}{}

\begin{flushright}
\textsc{elizabeth pissolato}\footnote[*]{Docente na área de antropologia
do~Departamento de Ciências Sociais da Universidade Federal de Juiz de
Fora.}
\end{flushright}
%\section{Lidando com emoções}

\noindent{}Por mais que nosso treinamento para nos tornarmos antropólogos não nos
...
cerimoniais, isto é, incorporando a \textit{intensidade da dimensão afetiva},
...
a \textit{raiva}, o \textit{ciúme}, a \textit{tristeza}, a \textit{alegria} para a socialidade
...
percepção \textit{pré-cognitiva}, buscando intuir, por exemplo, sentidos no
...
por exemplo, mais interessante que definir a \textit{raiva}, caberia ver o que
se conecta no \textit{enraivecer} de alguém em um dado contexto, o que se
desdobra daí.
...
afinidade --- da inimizade ---, isto é, enquanto \textit{meta afinidade} (Taylor,
2000) ou \textit{afinidade potencial} (Viveiros de Castro, 2001), as relações
...
fato é que uma criança não nasce parente, mas precisa ser tornada ou se
...
\textit{consciência} do parentesco,\footnote{Entre os Piro, a partir do trabalho da
memória, conforme Gow, 1997.} a experiência de certas emoções, a
produção de determinado vínculo afetivo, tudo isso \textit{através} da
...
primeira forma de consciência, aquela do \textit{pensar aos próximos} (2006, p.\,161).

Para o comentário sobre este tema focalizando a vida nas aldeias mbya,
considero fundamental a definição de Marilyn Strathern da \textit{alimentação
como relação} (Strathern, 1988, p.\,251). Não é o alimento enquanto
...
formas de \textit{alegrar (-se com) parente}, envolvendo ações ou disposições
como as de \textit{falar} e \textit{ouvir} ou ainda \textit{dançar} e \textit{cantar} na reza. Penso que
...
efetivamente um \textit{cozinhar para}. Não se cozinha a não ser para alguém,
...
animal, \emph{jepotá}, que são contadas por nossos anfitriões não deixam
dúvida: visitar a aldeia de \emph{koxi} e aceitar comida por lá é tornar"-se
parente dessa gente, \emph{koxi}.\looseness=-1

Para a criança que nasce, por sua vez, aceitar a relação de alimentação,
envolver"-se e \textit{ficar bem} junto daqueles que a receberam na Terra é um
...
cuidar e um igualmente não dado desejo de \textit{ficar}, isto é, permanecer na
...
como alimento, tal ato é tido como um \textit{não se alegrar}, um \textit{não gostar} que
...
mais velho que ela \textit{não quer ficar}, ou que \textit{não está gostando
{[}possivelmente{]} do pai, da mãe} para os quais veio por nascimento.

Disposições de cuidar ou não cuidar --- ou, como alguns dizem: \textit{jogar} ---,
...
de um sentimento ou disposição relacional que \textit{faz bem}, produz
...
--- \textit{escutadas} pelos adultos que a cercam. 
...
um humor dosado, fala que produz \textit{bem estar} e faz \textit{alegre} a vida
experimentada em um certo lugar.

\textls[-10]{Voltando às práticas entre parentes, e particularmente à relação entre
...
jovens presentes --- param para \textit{ouvir} o que os parentes mais velhos lhes
\textit{contam}. Há um valor especial conferido às narrativas do tempo antigo,
...
contextos diversos para falar"-e"-escutar. Alguns conteúdos são \textit{contados}
...
A~disposição de \textit{contar} --- considerado aqui em sentido amplo --- e sua
contrapartida, isto é, a disposição de \textit{ouvir} são, a meu ver, o contexto
...
\textit{sentirmos} um aspecto de tensão que a vida partilhada num mesmo local
...
\textls[-10]{Um comentário direto do cacique Augustinho em Araponga observava como
poderíamos mudar de ânimo, acordando bem, passando bem a manhã, e, sem
que nada aparentemente ocorresse, já não estaríamos assim à tarde.}\looseness=-1
...
\textit{pensar ao próximo}, o contexto da co"-residência experimentado nas
falas --- bonitas, mas também possivelmente feias, acusatórias,
antipáticas --- pode nos levar a \textit{pensar longe}, a acordar sem vontade de
...
desafeto de parentes. É~quando ouvimos sobre um \textit{não gostar}, ou
melhor, não ser gostado ou não \textit{ter ajuda} de parentes. Tais falas
...
geral. \textit{Ficar alegre} particularmente está sob o teste de lugares e de
...
alguém efetivamente vai \textit{ficar alegre}, o que a experiência põe à
...
palavras, \textit{não ficar} aqui dá margem à circulação por outros lugares
possíveis para se viver com parentes, outras possibilidades de
\textit{alegrar"-se}, de achar conforto emocional. 
...
\textit{concentração} que se pode ter dentro da \emph{opy} ou também fora dela.
Assim, disse"-me uma vez João Karaí, em Parati Mirim, como se sentia
\textit{olhado} por \emph{nhanderu} mesmo não frequentando a casa de reza. De modo que
a conexão com o \textit{alto}, com as capacidades originadas em \emph{nhanderukuery} e
...
\textit{individualista} da reza.\footnote{Ver Nimuendajú, 1987, e Schaden 1962, p.\,122.} 

\textls[-15]{Há também conexões através da \emph{opy} ou das \emph{opy} que mereceriam reflexão. Os
...
experiência local da reza.}\looseness=-1
...
\textls[-10]{Lembrando aqui outros contextos ameríndios em que reconhecemos que
emoções são produzidas intencionalmente, como a \textit{vontade de matar
inimigo} o deve ser para a guerra, por exemplo, entre homens parakanã
(Fausto 2001, p.\,271), é possível sugerir que a reza nas \emph{opy} mbya é
efetivamente feita para produzir o que poderíamos chamar de um estado
afetivo, um saber incorporado do que é \textit{bonito} e \textit{bom}. Sabemos que essas
são propriedades de elementos que compõem a reza, como a \textit{fala bonita}
das \emph{opy}, a fumaça que \textit{faz bem} usada nos cachimbos, mas são também
...
aqui o comentário de Olivier Allard (2003, p.\,24--38) das emoções como
disposição para a ação, e como tais disposições colocam em relação o
próprio agir com o agir dos outros.}\looseness=-1
...
esfriar \textit{más} ou \textit{feias} disposições que se manifestam no cotidiano,
...
pessoas, tudo isso que \textit{esquenta} a convivência seria, então, abrandado
...
parece comparável em intensidade a qualquer outra experiência de \textit{ficar
alegre} e \textit{sentir bem} que conheci nas aldeias.
...
clima tão intenso que costuma fazer \textit{cair} ou \textit{queimar} na dança
algumas pessoas. Persistir cantando e dançando por longo tempo,
\textit{queimar} desse jeito na \emph{opy} nos levaria a experimentar em dose alta e
...
\textls[-10]{Alguns contextos que colocam no centro o tema do \textit{ficar alegre} foram
...
processo, e o parentesco não foge à regra.}\looseness=-1

\begin{bibliohedra}
\tit{allard}, Olivier. \emph{Emotions and relations: a point of view on
Amazoniam kinship}. Dissertação de Mestrado. Cambridge: University of
Cambridge, 2003.

\tit{fausto}, Carlos. \emph{Inimigos fiéis: historia, guerra e xamanismo na
Amazônia}. São Paulo: Edusp, 2001.

\tit{gow}, Peter. ``O~parentesco como consciência humana: o caso dos Piro''.
\emph{Mana} 3(2), 1997.
...
\tit{seeger}, Anthony; \textsc{viveiros de castro}, Eduardo; \textsc{da matta}, Roberto. ``A construção da pessoa nas sociedades indígenas brasileiras''. \emph{Boletim do
Museu Nacional} 32, 1979.

\tit{strathern}, Marilyn. \emph{The gender of the gift. Problems with women
and problems with society in Melanesia}. Berkeley e Los Angeles:
University of California Press, 1988.

\tit{surralés}, Alexandre. \emph{Au c\oe ur du sens: perception, affectivité,
action chez les Candoshi}. Paris: \textsc{cnrs} Éditions, 2003a.

\titidem. ``Face to face: meaning, feeling and
perception in Amazonian welcoming ceremonies''. \emph{Journal of the Royal
Anthropological Institute} 9(4), 2003b.

\tit{taylor}, Anne"-Christine. ``Le sexe de la proie: representations
jivaro du lien de parenté''. \emph{L’Homme} 154--155, 2000.

\tit{taylor}, Anne"-Christine \& \textsc{viveiros de castro}, Eduardo. ``Un corps
fait de regards''. In: \emph{Qu"-est"-ce qu’un corps?}. Paris: Musée du Quai
Branly/\,Flammarion, 2007.

\tit{vilaça}, Aparecida. ``Chronically unstable bodies. Reflexions on
Amazonian corporalities''. \emph{The Journal of the Royal Anthropological
Institute} 11(3), 2005.

\tit{viveiros de castro}, Eduardo. ``\textsc{gut} Feelings about Amazonia:
potential affinity and the construction of sociality''. In: \textsc{rival}, Laura
\& \textsc{whitehead}, Neil (eds.). \emph{Beyond the visible and the material. The
...
alterando. Se há um \textit{si} dentro do \textit{si mesmo}, é um \textit{si} constantemente
alterado. O~\textit{mesmo} é onde estaria a escolha, com quem se quer andar
...
\smallskip
\hspace*{\fill}\textsc{ana maría ramo y affonso}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Um \emph{tekoa}, uma cidade e\break a \emph{sidade}}
\addcontentsline{toc}{chapter}{Um \emph{tekoa}, uma cidade e a \emph{sidade}, \textit{\small por Fabio Nogueira da Silva}}
\markboth{Um tekoa, uma cidade\ldots}{}

\begin{flushright}
\textsc{fabio nogueira da silva}\footnote[*]{Doutor em Antropologia Social pelo
...
Com o apoio do Centro de Trabalho Indigenista (\textsc{cti}), nos anos 1980, os
...
busca da Terra sem mal e a fuga da violência praticada pelos \emph{juruá},
...
Jaraguá, onde residia a cacique Jandira,\footnote{Falecida em março de 2012.} prima de José Fernandes. Pretensos proprietários não indígenas
...
histórica desses grupos com aqueles descritos por Nimuendajú (1987) e Schaden (1974), apontada por Ladeira (1992), descrevem
...
território: os \emph{tataipy}, ``lugar do fogo'', de \emph{tata}, fogo, e
...
do coletivo como a borda do mundo, \emph{Yvy apy} (Ladeira, 2001, p.\,133), a
...
território Guarani Mbya, atuando como líder do grupo e como \emph{karai}, ``rezador''.
...
que os \emph{juruá} chamam de aldeia, ``\emph{jaa tekoa Tenonde Porã}?, vamos lá no
...
sagrado, por isso que não está acontecendo muito, de \emph{juruá} que
ataca a gente.
\end{quote}
...
peçonhentos nem são agredidos pelos \emph{juruá}. Por isso, a fala do
...
\textit{eu já fui por aqui, eu já fui por esse caminho}. Ou acontece alguma
...
Ao viverem como os \emph{juruá}, dizem os Mbya que eles deixam de lado o \emph{teko},
...
indígenas, ao \emph{juruá reko}, a ``cultura do branco''. É~o que observamos na
fala de um cacique sobre as mudanças que nota no \emph{tekoa}:

\begin{quote}
Antes não tinha tanta influência do \emph{juruá}, então a parte da
...
quem o remédio será feito e, antes de tudo, é preciso dirigir o \emph{jerure}, ``pedido'', a \emph{Nhanderu} e depois ao \emph{-ja}. A~pessoa que fará o remédio pode
...
fazem uso de tabaco fumado no \emph{petỹgua}, ``cachimbo'', mas ela também
...
do \emph{petỹgua}, ``cachimbo'', sobre o doente, esfregando a mão espalmada
sobre o local onde está a doença, ou a dor, e faz a \textit{aspiração} desta,
...
religião também. Agora, a cidade, porque o \emph{juruá} chama de cidade? Eu
fiquei pensando nisso. É~porque os \emph{juruá} que vivem em São Paulo, no
...
totalmente \textit{si}. Por isso é \emph{sidade}, lá está morando o \textit{si}, sozinho.
...
\emph{juruáreko}, ``modo de vida dos não indígenas'', e \emph{nhandereko}, ``nosso modo de
vida''. O~\textit{si} é a condição própria dos \emph{juruá}, sempre pensando em si,
...
\begin{bibliohedra}
\tit{carvalho}, Maria Lucia Brant de. \emph{Das terras dos índios a índios sem
terras. O~Estado e os Guarani do Oco’y: violência, silêncio e luta}.
Tese de Doutorado. São Paulo: \textsc{usp}, 2013.

\tit{funai}. \emph{Relatório circunstanciado de identificação e delimitação da \textsc{ti}
Tenondé Porã}. Brasília: \textsc{funai}, 2010.

\titidem. \emph{Relatório circunstanciado de identificação e delimitação da \textsc{ti}
Jaraguá}. Brasília: \textsc{funai}, 2011.

\tit{garlet}, Ivori José. \emph{Mobilidade mbya: história e significação}.
Dissertação de Mestrado. Porto Alegre: \textsc{puc}-\textsc{rs}, 1997.

\tit{ladeira}, Maria Inês. \emph{O~caminhar sob a luz: o território mbya à beira do
oceano}. Dissertação de Mestrado. São Paulo: \textsc{puc}-\textsc{sp}, 1992. 

\titidem. \emph{Espaço geográfico guarani"-mbya: significado, constituição e
uso}. Tese de Doutorado. São Paulo: \textsc{fflch}-\textsc{usp}, 2001.

\tit{macedo}, Valéria Mendonça de. \emph{Nexos da diferença. Cultura e afecção em
uma aldeia guarani na Serra do Mar}. Tese de Doutorado. São Paulo:
\textsc{ppgas}-\textsc{usp}, 2009

\tit{nimuendajú}, Curt Unkel. \emph{As lendas da criação e da destruição do mundo
como fundamentos da religião dos Apapocuva"-guarani}. São Paulo:
Hucitec/\,Edusp, 1987 [1914].

\tit{noelli}, Francisco Silva. \emph{Sem tekoha não há tekó: em busca de um modelo
...
\tit{nogueira da silva}, Fabio de O. \emph{Elementos de etnografia mbya: lideranças
...
\titidem. \emph{Do Tekoa Pyau à nova aldeia: sujeitos em movimento na produção do
...
\tit{pereira}, Sandra de Castro. \emph{Os loteamentos clandestinos no distrito do
Jaraguá (\textsc{sp}): moradia e especulação}. Dissertação de Mestrado. São
Paulo: \textsc{usp}, 2006.

\tit{schaden}, Egon. \emph{Aspectos Fundamentais da cultura guarani}. São Paulo:
Epu/\,Edusp, 1974 [1954].
...
que agora os \emph{juruá} dizem que é obrigatório pedir licença ao Ibama e
outros segmentos do governo\ldots{}}

\smallskip
\hspace*{\fill}\textsc{vanessa lea}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Mundéu do mundo\subtitulo{Predação e troca em relações entre os\break Guarani e os «juruá»}}
\addcontentsline{toc}{chapter}{Mundéu do mundo, \textit{\small por Valéria Macedo}}
\markboth{Mundéu do mundo}{}

\begin{flushright}
\textsc{valéria macedo}\footnote[*]{Docente na área de antropologia
...
aprendizado, particularmente sobre relações com os brancos, os \emph{juruá}, e
...
Os antropólogos vêm aprendendo com os indígenas como a caça e a predação
...
como onça. \emph{Ojepotá} é o modo como os Guarani chamam aquele que sofreu
...
A~pessoa que \emph{ojepotá} passa a experimentar o mundo como o dono animal,
ou de outros domínios da terra, que capturou ou afugentou sua
alma.\footnote{Muitos antropólogos escreveram sobre o \emph{jepotá}, desde
...
Há pessoas que associam o interesse dos indígenas por produtos
industrializados com uma suposta perda cultural, como se estivessem
deixando de ser indígenas. Em sentido inverso, os autores com quem este
...
antropólogo americano Marshall Sahlins (1997, p.\,62), a tradição, ou a
...
imagem de serem um povo muito ávido por mercadorias. No trabalho de
...
se transformaram nos pássaros que existem hoje (Gordon, 2006, p.\,213--4). 
...
Xikrin reconhecem uma inflexão para o estado \emph{uabô} nas relações com o Estado brasileiro, amenizando sua disposição geral para a guerra. A chamada ``pacificação'' teve como estratégia do governo o fornecimento de grandes quantidades de mercadorias, das quais os Xikrin foram ficando cada vez mais dependentes. Mas, após a ``pacificação'', o afluxo de mercadorias diminuiu, ao passo que aumentou a presença de madeireiros e garimpeiros ilegais em suas terras. 
...
invertendo a pacificação imposta pelo Estado. Apropriar"-se de dinheiro e mercadorias é assim um modo de incorporar capacidades e subjetividades \emph{kuben}, com seus poderes
...
Entretanto, assim como o dinheiro, a força do Grande Gavião Àkti não é apenas criativa. ``Ela guarda um componente caótico, virtualmente desmesurado e destrutivo, que pode aniquilar a humanidade xikrin'' (Gordon, 2006, p.\,410).
...
oficial foi um mediador importante na chamada \textit{pacificação}, ou seja,
...
que são empregados e os que são patrões (2005, p.\,47).

A autora reconhece entre os Paumari uma transformação do modelo em que a posição de predador é associada à de sujeito na relação, como é o caso dos Xikrin. Os
...
parecem claramente preferir a segunda opção'' (2005, p.\,56). Mas a autora
...
estabilizadas, e os Xikrin também reconhecem que a construção do parentesco e de alianças implica o controle da predação. A~incorporação do mundo dos brancos e seus
...
que ainda não havia \emph{juruá}, e uma gente"-onça originária andava pela
...
passam de presas ou seres domesticados para predadores ou caçadores das
...
apontamento de Flávia Mello (2006, p.\,229) de que os caçadores guarani se
...
Já no início do século \textsc{xx}, com a criação do Serviço de Proteção aos
Índios (\textsc{spi}), órgão oficial que antecedeu a \textsc{funai}, Curt Nimuendajú
(1914) comenta a dificuldade de agrupar e fixar os Guarani em
...
viviam longe e \textit{deixavam} que os indígenas vivessem ali como modo de
...
respeito, Ladeira e Azanha (1988, p.\,35), membros do Centro de Trabalho
...
a multiplicação dos \emph{juruá} no entorno das aldeias é algo sempre
...
confinamento das cercas \emph{juruá} não impede a intensa circulação de
pessoas e conhecimentos entre as aldeias. 

Para além da questão territorial, a recusa de estar sob o controle dos
\emph{juruá} também se observa nas relações de trabalho. Hoje em dia há muitos
...
Alguns amigos guarani me dizem que não adianta dizer \textit{vou trabalhar!} e
...
o domínio de um dono ou patrão \emph{juruá} na maioria das aldeias no estado
de São Paulo. 

Já nos anos 1940, Schaden (1954) comenta as frequentes incursões
...
Os fregueses \emph{juruá} são via de regra anônimos, que param nos acostamentos
...
frustrando os chamados parceiros \emph{juruá} no que diz respeito ao
...
pragmáticos dos projetos, de modo a posicionarem os \emph{juruá} como
...
aldeia Pyau, no Jaraguá --- é que um \emph{juruá} se torne afilhado de um
...
dá no mesmo sentido, de modo a conferir aos \emph{juruá} a posição de
...
\emph{juruá}. Na maior parte das aldeias mbya, o casamento com não indígena é
controverso e raro. Assim como não gostam de ter patrão \emph{juruá}, os Mbya
em geral não gostam de ter cunhado, genro ou sogro \emph{juruá}.\footnote{Há
casos de \emph{juruá} que se tornam grandes amigos e aliados, os quais passam
...
domesticação de corpos"-afetos visando sua \textit{guaranização}, ou a
...
Niterói, mas cujos moradores mudaram"-se para Maricá, no Rio de Janeiro. Ali a questão
da familiarização com \emph{juruá} se coloca de modo mais acentuado e gera
...
de casamentos e geração de filhos com \emph{juruá} é que os anjos não
...
de um mbya não se acostuma com \emph{juruá}, por isso se afasta e deixa a
pessoa suscetível a adoecimentos e adversidades. Por essa razão, em
muitas \emph{opy} a presença de \emph{juruá} é evitada, pois afasta os \emph{nhe’ẽ} e
enfraquece as rezas e curas.

A~incompatibilidade do \emph{nhe’ẽ} dos Guarani e os \emph{juruá} também é
...
os corpos \emph{juruá}. O~que os profissionais da saúde não conseguem entender
...
Assim como o \emph{petỹgua} fortalece, a comida dos \emph{juruá} deixa o corpo dos
...
comida vinda dos \emph{juruá} pode fazer dela comida de parentes, \emph{nhande
kuery}, ``da gente''.\footnote{A~esse respeito, ver o relato de Pereira,
2014, p.\,47ss. Para um aprofundamento do debate sobre comensalidade,
...
(2013) apresenta várias delas sobre a origem dos \emph{juruá}. Uma dessas
narrativas conta como os animais domésticos, como porcos, vacas e
patos, eram \emph{juruá} nos tempos primordiais. Também ouvi diversas
...
os \emph{juruá} nascem do sopro de \emph{Anhã}, junto com animais de criação como
porcos e ovelhas (Macedo, 2009). Esse primeiro \emph{juruá} plantou uma grande
árvore e nela criaram"-se muitas lagartas, as quais vêm ao mundo em
forma de \emph{juruá}. Por isso um dos nomes usados para os \emph{juruá} nas falas na
...
Diz"-se que \emph{Nhanderu} pediu para o primeiro \emph{juruá} e o primeiro guarani
escolherem entre o \emph{petỹgua} e um saco de dinheiro. O~guarani ficou
com o \emph{petỹgua} para poder se comunicar com \emph{Nhanderu}, e o \emph{juruá} ficou
...
como aqueles que escolheram o \emph{petỹgua} (Macedo, 2009; 2014). 
...
posição de presa nas relações com os \emph{juruá} passa por se posicionar como
\emph{mymba}, ``ser domesticado'', de \emph{Nhanderu}, buscando motivar ações de seu dono
por meio do \emph{petỹgua}, da vida da \emph{opy} e de práticas de conhecimento
...
incorreu nas diferenças entre Guarani e \emph{juruá} foi ouvida por Montardo
(2009), em que a escolha posta por \emph{Nhanderu} fora entre um \emph{mbaraka},
chocalho usado nas rezas, e um \textit{pedaço de papel para escrever}. A
...
branco, um papel'' (2009, p.\,163). Em muitas ocasiões, o \emph{kuaxia} --- papel e
seus derivados ---, é mencionado pelos Guarani Mbya como expressão do
pensamento e dos agenciamentos \emph{juruá}, sobretudo nos últimos tempos, com
a multiplicação de projetos, relatórios e documentos como mediadores no
acesso a recursos e direitos.

O~\emph{kuaxia} é uma expressão do pensamento aprisionado dos brancos, que só
...
\begin{bibliohedra}
\tit{bonilla}, Oiara. \emph{Des proies si désirables: soumission et prédation pour
...
\tit{cadogan}, León. \emph{Ayvu rapyta. Textos míticos de los Mbyá-Guaraní del
Guairá}. São Paulo: \textsc{fflch}-\textsc{usp}, 1959.

\tit{centro de trabalho indigenista} (coord.). \emph{Xondaro Mabaete. A~Força do
Xondaro}. São Paulo: \textsc{cti}, 2013.

\tit{costa}, Luiz. ``Alimentação e comensalidade entre os Kanamari''. \emph{Mana~}19(3),
2013.

\tit{fausto}, Carlos. ``Banquete de gente: comensalidade e canibalismo na
Amazônia''. \emph{Mana~}8(2), 2002.

\titidem. ``Donos demais: maestria e domínio na Amazônia''. \emph{Mana~}14(2), 2008.

\tit{gordon}, Cesar. \emph{Economia selvagem: ritual e mercadoria entre os índios
Xikrin"-Mebêngôkre}. São Paulo: Unesp, \textsc{isa}; Rio de Janeiro: Nutti, 2006.

\tit{heurich}, Guilherme O. \emph{Outras alegrias: parentesco e festas mbya}.
Dissertação de Mestrado. Rio de Janeiro: \textsc{ppgas}-Museu Nacional, 2011.

\tit{ladeira}, Maria Inês. \emph{O~caminhar sob a luz. O~território mbya à beira do
oceano}. São Paulo: Unesp, 2007.

\tit{ladeira}, Maria Inês \& \textsc{azanha}, Gilberto. \emph{Os índios da Serra do Mar. A
presença Mbyá-Guarani em São Paulo}. São Paulo: \textsc{cti}, Nova Stella, 1988.

\tit{lima}, Tania Stolze. ``O~dois e o seu múltiplo: reflexões sobre o
perspectivismo em uma cosmologia tupi''. \emph{Mana~}6(2), 1996.

\titidem. \emph{Um peixe olhou pra mim: o povo Yudjá e a
perspectiva}. São Paulo: Unesp, \textsc{isa}; Rio de Janeiro: Nutti, 2005.

\tit{macedo}, Valéria. ``Nexos da Diferença entre os Guarani. Entre
aldeias, cidades, corpos e cosmos''. In: \textsc{el far}, Alessandra; Barboza,
Andrea; \textsc{amadeo}, Javier (orgs.). \emph{Ciências sociais em diálogo: cultura e diferença}. São Paulo: Unifesp, 2014.

\titidem. ``De encontros nos corpos guarani''. \emph{Ilha~}15, 2013.

\titidem. ``Dos cantos para o mundo. Invisibilidade, figurações da
cultura e o se fazer ouvir nos corais guarani''. \emph{Revista de Antropologia}
55(1), 2012.

\titidem. \emph{Nexos da diferença. Cultura e afecção em uma aldeia
guarani na Serra do Mar}. Tese de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2009.

\tit{mello}. Flávia Cristina de. \emph{Aetchá nhanderukuery karai retarã: entre
...
\tit{mendes júnior}, Rafael Fernandes. \emph{Os animais são muito mais do que algo
somente bom para comer}. Dissertação de Mestrado. Rio de Janeiro:
\textsc{ppga}-\textsc{uff}, 2009.

\tit{montardo}, Deise Lucy Oliveira. \emph{Através do mbaraka. Música, dança e
xamanismo guarani}. São Paulo: Edusp, 2009.

\tit{monteiro}, John Manuel. ``Os Guarani e a história do Brasil meridional:
séculos \textsc{xvi}-\textsc{xvii}''. In: \textsc{carneiro da cunha}, Manuela (org.). \emph{História dos índios no Brasil}. São Paulo: Companhia das Letras, 1998 [1992].

\tit{nimuendajú}, Curt. \emph{As lendas da criação e destruição do mundo como
fundamentos da religião dos Apapocúva"-Guarani}. São Paulo,
Hucitec/\,Edusp, 1987 [1914].

\tit{pereira}, Vicente Cretton. \emph{Aqueles que não vemos: uma etnografia das
relações de alteridade entre os Mbya Guarani}. Dissertação de Mestrado.
Rio de Janeiro: \textsc{ppga}-\textsc{uff}, 2014.

\tit{pimentel}, Spensy K. \emph{Elementos para uma teoria política kaiowá e guarani}.
Tese de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2012.

\tit{pierri}, Daniel Calazans. \emph{O~perecível e o imperecível. Lógica do sensível
e corporalidade no pensamento guarani"-mbya}. Dissertação de Mestrado.
São Paulo: \textsc{ppgas}-\textsc{usp}, 2013.

\tit{pissolato}, Elizabeth. \emph{A~duração da pessoa. Mobilidade, parentesco e
xamanismo mbya (guarani)}. São Paulo: Unesp, \textsc{isa}; Rio de Janeiro: \textsc{n}u\textsc{ti}, 2007.

\tit{ramo y affonso}, Ana María. \emph{De pessoas e palavras entre os Guarani"-Mbya}.
...
\tit{sztutman}, Renato. \emph{O~profeta e o principal: a ação política ameríndia e
seus personagens}. São Paulo: Edusp, 2012.

\tit{vilaça}, Aparecida. ``Fazendo corpos: reflexões sobre morte e canibalismo
entre os Wari’ à luz do perspectivismo''. \emph{Revista de Antropologia}~41(1),
1998.

\tit{vilaça}, Aparecida. ``Cultural change as body methamorphosis''. In: \textsc{fausto},
Carlos \& \textsc{heckenberger}, Michael (eds.). \emph{Time and memory in indigenous
Amazonia}. Flórida: University Press of Florida, 2007.

\tit{vilaça}, Aparecida. ``Conversão, predação e perspectiva''. \emph{Mana} 14(1), 2008.

\tit{viveiros de castro}, Eduardo. \emph{A~inconstância da alma selvagem}. São Paulo:
Cosac Naify, 2002.
\end{bibliohedra}
...
\chapter*{O~desabrochar da palavra\subtitulo{Sobre o encontro dos Clastres com os Guarani}}

\addcontentsline{toc}{chapter}{O~desabrochar da palavra, \textit{\small por Renato Sztutman}}
\markboth{~desabrochar da palavra}{}

\vspace*{-.5\baselineskip}

\begin{flushright}
\textsc{renato sztutman}\footnote[*]{Docente do Departamento de Antropologia da \textsc{usp},
pesquisador do \textsc{ce}st\textsc{a}-\textsc{usp} e do Laboratório de Imagem e Som em
Antropologia (\textsc{lisa-usp}).}
\end{flushright}

\noindent{}\textls[-20]{Este não é um texto sobre os Guarani,\footnote{Agradeço às organizadoras pela oportunidade de falar com os Guarani
no seminário ``Nas Redes Guarani''. Em especial à Valéria pelo incentivo para desenvolver este texto e suas ideias e pela oportunidade de pensar em conjunto a partir do
mundo guarani, o qual infelizmente conheço ainda tão pouco. Agradeço,
por fim, a Henrique Pougy, com quem venho discutindo a
relação entre linguagem e política, e a Lucas Keese e Aline
...
Guayaki.}\looseness=-1 \enlargethispage{\baselineskip}
...
religião, orientada para a busca de uma \textit{Terra sem mal} e baseada em
...
guarani da sua ideia de \textit{sociedade contra o Estado} (1974a); versão
...
das relações intercomunitárias e da guerra. O~\textit{contra"-Estado} que P.\,Clastres encontra entre os Guarani é um \textit{contra"-Um}\footnote{No sentido
sugerido por La Boétie no \emph{Discurso da servidão voluntária}, de 1549.} e
uma \textit{máquina de guerra} do pensamento.\footnote{No sentido estendido
...
Clastres que, em \emph{A~terra sem mal} (1975), se debruça sobre o \textit{profetismo
...
denominados na literatura sobre os Guarani de \textit{profetas}, mantendo"-se
...
agressores, os \emph{karai} seriam \textit{líderes espirituais}, portadores de
...
Clastres apresenta a \textit{filosofia da chefia indígena}. Nas \textit{sociedades
...
comunicação e revela sua \textit{dupla natureza}. A~linguagem seria, para P.
...
coisas para se tornar constitutiva delas.\looseness=-1

Se a fala do chefe \textit{primitivo} é, como escreve P. Clastres em ``Troca e
poder'', \textit{vazia} porque não comunica, a fala do profeta guarani --- as
\textit{belas palavras} --- é ao mesmo tempo um veículo de comunicação com as
...
\textit{valor}. Se a fala do chefe \textit{primitivo} não comunica, não é possível
...
Henrique Pougy (2015).} Falar seria, com efeito, o grande \textit{ato
...
transcendente, que extrai seu fundamento do \textit{Mito"-Lei divino}. Tanto na
...
(2011, p.\,214). Tais atos de fala são, segundo a autora, irreversíveis e
...
bilíngue em guarani e espanhol \emph{Ayvu rapyta}, os textos apapokuva compilados
por Curt Unkel Nimuendajú no começo do século \textsc{xx} e, por fim, excertos
...
por sua vez, oferecem diferentes sortes de textos: \textit{narrativas míticas}
orais contadas com bastante frequência e de modo bastante aberto,
\textit{textos religiosos} que guardam certo saber esotérico e uma linguagem
fortemente metafórica, inacessíveis aos ``não indígenas'', \emph{juruá}, e, por fim,
\textit{discursos metafísicos}, exegeses de narrativas míticas carregadas de
uma reflexão de caráter mais propriamente subjetivo. Se a intimidade de
Cadogan com os sábios mbya lhe rendeu o acesso a textos \textit{esotéricos},
dotados de uma linguagem própria das divindades, P. Clastres encontra
no que ele equipara a \textit{discursos metafísicos} uma inovação com relação
...
reportando"-se à \textit{linguagem propriamente humana} --- que tem como
...
\textit{palavra habitante}, uma vez que o \emph{nhe’e} seria enviado pelas divindades
...
pessoa à comunidade daqueles que se reúnem pelo \emph{ayvu}'' (1974b, p.\,29).} Já
...
das crianças pequenas. Gerar uma pessoa implica, entre os Guarani, \textit{dar
assento} a um nome; trata"-se de um ato poético de encarnação da
palavra. Ganhar um nome é, como indica H. Clastres, \textit{manter erguido o
fluxo do dizer} (1975, p.\,108), isto é, ganha"-se um nome ao mesmo tempo em
...
expressão que ganhou a famosa tradução de \textit{Terra sem mal}.
...
\textit{belas palavras}, seriam também \textit{os adornados}. Não por acaso, as
...
ideogramática da língua guarani'' (2013, p.\,15), haja vista a profusão de
redes de imagens que nomeiam abstrações. Em ``A~grande fala'', P. Clastres
oferece alguns exemplos dessa profusão de metáforas: fala"-se \textit{flor do
arco} no lugar de flecha, \textit{esqueleto da bruma} no lugar de cachimbo e
\textit{ramagens floridas} no lugar de dedos de \emph{Nhamandu}, divindade primeira,
...
\emph{déploiement}, traduzido na versão brasileira como ``desdobramento''.
...
tudo o que existe no \textit{curso de sua própria evolução}. Na tradução dos
...
si mesmo'' (1974b, p.\,18). Como ensina a glosa de Cadogan, as expressões
...
sagradas'' ou como ``sabedoria/\,poder criador'' (1959, p.\,25). \emph{Kuaa"-ra"-ra}
...
surjam'' (1959, p.\,17).\footnote{``Comparando o verbo \emph{guero"-jera} com as
formas ‘reflexas’ de \emph{jupi} = subir e \emph{guejy} = descer, por exemplo:
\emph{oguero"-jupi} = o faz subir enquanto sobe; \emph{oguero"-guejy} = o faz descer
enquanto desce'' (1959, p.\,17). Em suma, podemos glosar \emph{oguero"-jera} como
...
transformação: aquela do botão em flor'' (2013, p.\,102). 

\emph{Nhamandu} se desdobrando tal uma \textit{uma flor que se abre para a luz do
sol}; \emph{Nhamandu} sendo ao mesmo tempo \textit{o sol e a flor} (1974b, p.\,19).
Com Clastres, poderíamos tomar essa transformação como um
\emph{desdobramento}. No lugar de uma ação \textit{criadora}, termo bastante
...
quer escapar, Clastres visualiza um \textit{\emph{Nhamandu} desdobrando"-se ele mesmo
em seu próprio desdobramento} (p.\,25). Trata"-se da emergência de uma divindade
...
%\emph{Nhamandu se déployant lui"-même en son propre déploiement}. Acho que não tem por que deixar o original em francês do Clastres, certo?

\emph{Nhamandu} é a divindade primeira, fonte de todas as \textit{almas} e de todas as
...
cada qual a fonte das \textit{almas"-palavras}, \textit{linguagens"-afeto} de cada
pessoa humana que habita a \textit{terra imperfeita}. O~Um que é a um só tempo
...
Guarani do Guairá são os assim chamados \textit{discursos metafísicos}, algo
que não teria sido exatamente notado por Cadogan. P. Clastres fala em
\textit{textos enigmáticos}, \textit{reflexões críticas sobre os mitos, comentários
livres, brilhos de uma luz sem traços} (1974b, p.\,15). Da poética das
\textit{belas palavras} ele vê brotar um pensamento que ``interroga o mundo e a
infelicidade do mundo, colocando a questão das causas: por que os
homens são humanos demais?'' (1974b, p.\,11). A~poesia das \textit{belas palavras}
...
desenrolar sob o signo do Um.\footnote{1974b, p.\,12.}
\end{quote}
...
Voltamos, assim, à imagem do \textit{desabrochar da palavra}, às figuras de
...
experimentar humanamente um devir"-divindade. Essa \textit{duplicidade} é a
...
clastriano e ameríndio, especialmente Tupi"-Guarani, do \textit{Dois} como
...
possível pensar de maneira mais afinada com os Guarani em uma distinção entre
\textit{bonito"-bom} e \textit{feio"-ruim}, o que nos envia para a oposição decisiva,
...
morada das divindades. Isso exige uma \textit{paciência com o corpo}, que
...
a conexão entre o tema da \textit{terra corruptível} e o mundo dos \emph{juruá}.
...
da \textit{bruma pesada} que impede que os Guarani aproximem"-se do mundo dos
\emph{nhe’e kuery}, as divindades. Com a \textit{bruma pesada} do \emph{Tupã} \emph{juruá}, por
...
subjetiva que projeta uma \textit{meta"-mitologia}, um discurso sobre a
mitologia (1974b, p.\,125). Nesse sentido, os mitos não se pensariam apenas
\textit{por meio} dos homens, como havia proposto Lévi"-Strauss (1964), mas
...
mitologias indígenas contêm necessariamente uma \textit{filosofia virtual}.
...
\textls[-10]{Como sugere Beatriz Perrone"-Moisés (2011), é possível extrair das
...
em textos posteriores, buscará na mitologia dos indígenas chulupi do Chaco
...
mitologia, de um lado, e reflexividade e criatividade, de outro.}\looseness=-1
...
discursivos, por exemplo, os \textit{textos religiosos}, as \textit{belas palavras}.
...
\emph{juruá}, em que tudo se torna infinitamente mais pesado. \looseness=-1
...
criticando modos de conhecimento e existência dos não indígenas, \emph{napë}, a
...
vemos uma exegese \textit{subjetiva} da mitologia servindo à interpretação de
...
que visam amainar os conflitos correntes. \looseness=-1
...
\textit{manifesto cosmopolítico}. A~ideia de uma \textit{cosmopolítica} remeteria aos
...
humana e não humana --- sobre o que costumamos chamar de \textit{política}, arte
da construção de um mundo comum a partir da suposição de uma ontologia
comum. A~\textit{cosmopolítica} de Stengers exige justamente que passemos a
...
coletivos étnicos, exigência da interface com o mundo dos não indígenas,
...
entre líder espiritual e cacique, interlocutor dos \emph{juruá}. Mais do que
...
pelo sentido da mobilidade. A~ideia de \textit{multilocalidade}, esmiuçada por
...
assim dizer \textit{purificado}, uma vez que o pensamento que emerge não pode
jamais perder o pé do \emph{arandu porã}, o \textit{belo conhecimento}, jamais
...
escreve, em ``A~grande fala'', que é preciso \textit{traduzir os Guarani em
Guarani} (1974b, p.\,15), adentrando os conceitos deste povo, por mais
difícil que isso possa parecer, por mais que tenhamos de lutar com a
linguagem que dispomos.

\textls[-10]{Esse esforço de diálogo e essa tradução --- metas de uma antropologia
contemporânea, não mais satisfeita com a ideia de uma \textit{medida de todas
...
Se eu as inscrevo agora no papel, ou \emph{kuaxia}, como dizem os Guarani, não é
...
papel da escrita dos \emph{juruá} possa um dia reverter ao menos em parte o
...
compromisso a liberdade e o movimento.}\looseness=-1

\begin{bibliohedra}
\tit{albert}, Bruce. ``L’or cannibale et la chute du ciel''. \emph{L’homme} 126--128, 1993.

\tit{batista vianna}, Rosely. \emph{Roça barroca}. São Paulo: Cosac \& Naify, 2011.

\tit{de la boétie}, Étienne. \emph{Discours de la servitude volontaire}. Paris:
Flammarion, 1993 [1549].

\tit{cesarino}, Pedro. \emph{Quando a terra deixou de falar: cantos da mitologia
...
\tit{clastres}, Hélène. \emph{La terre sans mal: le prophétisme tupi"-guarani}. Paris:
Eds. du Seuil, 1975. {[}Tradução brasileira: \emph{Terra sem Mal. O~profetismo
tupi"-guarani}. São Paulo: Brasiliense, 1978.{]}

\titidem. ``De quoi parlent les indiens''. In: \textsc{abensour}, Miguel \& \textsc{kupiec} (eds.). \emph{Pierre Clastres}. Paris: Sens \& Tonka, 2011.
...
\titidem. \emph{Le Grand parler: mythes et chants sacrés des indiens Guarani}.
...
\titidem. \emph{Recherches d’anthropologie politique}. Paris: Eds. du Seuil, 1980.
...
\tit{kopenawa}, Davi \& \textsc{albert}, Bruce. \emph{La chute du ciel: paroles d’um chamane yanomami}. Paris: Plon, 2010.

\tit{levi-strauss}, Claude. \emph{O~cru e o cozido: Mitológicas \textsc{i}}. São Paulo: Cosac \& Naify, 2004 {[}1964{]}.

\titidem. \emph{História de lince}. São Paulo: Companhia das Letras, 1993 {[}1991{]}. 

\textsc{lima}, Tânia Stolze. ``O~dois e seu múltiplo: perspectivismo numa
cosmologia tupi''. \emph{Mana}~2(2), 2002.

\titidem. ``Por uma cartografia do poder e da diferença nas cosmopolíticas
ameríndias''. \emph{Revista de Antropologia}~54(2), 2011. 

\tit{macedo}, Valéria. \emph{Nexos da diferença. Cultura e afecção em uma aldeia
guarani na Serra do Mar}. Tese de Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2009.

\tit{macedo}, Valéria \& \textsc{sztutman}, Renato. ``A~parte de que se é parte: notas
sobre individuação e divinização a partir dos Guarani''. \emph{Cadernos de
Campo}~23, 2014.

\tit{pierri}, Daniel C. \emph{O~perecível o imperecível: lógica do sensível e
...
\tit{prado jr}., Bento. ``Lembranças e reflexões sobre Pierre Clastres:
...
\tit{pougy}, Henrique. \emph{Por uma pragmática do poder: a fala do chefe no Alto
Xingu}. Relatório Final de Iniciação Científica --- Fapesp. São Paulo:
\textsc{usp}, Ms, 2015. 

\tit{stengers}, Isabelle. ``La proposition cosmopolitique''. In: \textsc{lolive}, Jacques
\& \textsc{soubeyran}, Olivier (eds.). \emph{L’émergence des cosmopolitiques}. Paris:
La Découverte, 2007.

\tit{viveiros de castro}, Eduardo. \emph{Métaphysiques cannibales: lignes
...
\begin{adjustwidth}{-2.7cm}{}
 \vspace{-3.1cm}
 \includegraphics[width=136mm]{./img/GUARANIS-img5.jpg}	
  \hfill
  \end{adjustwidth}
...
\part[Tecnologias, circulação e transformação]{Tecnologias, circulação\break e transformação}
...
\addcontentsline{toc}{chapter}{Filmar histórias e transformar olhares, \textit{\small por Kuaray Poty}}
\markboth{Filmar histórias\ldots}{}

%\@openrighttrue\makeatother
\begin{flushright}
\textsc{kuaray poty (ariel ortega)}\footnote[*]{Cineasta Mbya no Rio Grande do Sul.}
\end{flushright}
...
faziam dentro das aldeias. Eu queria mudar um pouco isso dos \emph{juruá} irem
...
converso não tem ideia do que é fronteira, ele não fala \textit{eu vou na
Argentina}, ele fala \textit{eu vou cruzar do outro lado do rio}, e quando vão
pro Paraguai falam \textit{eu vou cruzar do outro lado do outro rio}. Isso é
...
crianças \emph{juruá} já tenham um pouco de contato com os indígenas antes de
...
\smallskip
\hspace*{\fill}\textsc{bruno schultze}
\end{minipage}
\end{flushright}
...
\addcontentsline{toc}{chapter}{Trilhando histórias em imagens, \textit{\small por Papa Mirĩ Poty}}
\markboth{Trilhando histórias\ldots}{}

\begin{flushright}
\textsc{papa mirĩ poty (carlos fernandes)}\footnote[*]{Cineasta Mbya
...
em meio à dificuldade dessa trajetória ouvi muitos \textit{não pode}. Houve
...
público. Na época eu me sentia maravilhado\ldots{} \textit{como que se pode falar
...
momento. Por isso sofri muito de me dizerem que \textit{não pode}.
...
\smallskip
\hspace*{\fill}\textsc{renato sztutman}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Formação e autonomia na\break produção de filmes}
\addcontentsline{toc}{chapter}{Formação e autonomia na produção de filmes, \textit{\small por Alexandre Werá e Lucas Keese}}
\markboth{Formação e autonomia\ldots}{}

\begin{flushright}
\textsc{alexandre werá}\footnote[*]{Cineasta Mbya no estado de São Paulo.}\\
\textsc{lucas keese}\footnote[\dag]{Mestre em antropologia pelo \textsc{ppgas}-\textsc{usp} e membro do \textsc{cti}.}
\end{flushright}
...
%\section{«Roexauka rive»~vs.~
\section{«avyukuaa ta’anga rupi, romombe’u\break aguã nhandereko régua»\protect\footnote{``Falar através das imagens, para contar sobre nosso modo de ser''.}}{}
%\protect\footnote{``\uppercase{A}penas mostrar vs. falar através das imagens, para contar sobre nosso modo de ser''.}}{}
...
guarani de uma maneira que os \emph{juruá kuery}, ``brancos'', entendam e
...
Já os \emph{juruá kuery}, ``brancos'', passam a entender um pouco da cultura
...
sobre o \emph{nhandereko} que os \emph{juruá} possam sentir e entender.~ Acreditamos
...
soja, e essa imagem pode parecer boa para alguns \emph{juruá}, porque é
...
% \emph{http://www.youtube.com/watch?v=cvq7cZjIrk4}
...
Isso significa uma apropriação de tecnologias, como computadores para edição
...
consolidados e recorrentes nas produções dos \emph{juruá kuery}.

Retomando o argumento do Werá, essa apropriação da linguagem audiovisual
é um \textit{saber} falar a partir da articulação
...
por Werá, a fala na \emph{opy}, ``casa de reza'', é um momento político
...
circulando, podem circular e devem circular entre \emph{juruá} e guarani? Em
vez de encarar esses conhecimentos de forma separada, eu acho que
podemos pensar como se dão essas trocas.}

\smallskip
\hspace*{\fill}\textsc{guilherme martins}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Entre enxadas e tratores\subtitulo{Notas sobre um (des)encontro}}

\addcontentsline{toc}{chapter}{Entre enxadas e tratores, \textit{\small por Tatiane Klein}}
\markboth{Entre enxadas e tratores}{}

\begin{flushright}
\textsc{tatiane klein}\footnote[*]{Mestre e doutoranda em Antropologia Social pelo
\textsc{ppgas}-\textsc{usp}.}
\end{flushright}
%\smallskip
...
tempo do criador.}{\textsc{wai wai, chefe wajãpi},\\\emph{A~arca dos Zo’é}}
...
trabalhar duro para analisar a questão.\footnotemark}{\textsc{renée kahukura}\footnotemark}
\footnotetext[1]{Tradução livre, a
partir de entrevista realizada pela autora.}
\footnotetext[2]{Repórter da M\=aori Television}
...
5’48’’). Disponível no YouTube.} foi
visualizado por mais de 3.000 pessoas no YouTube e é nele que Apykaa
...
%\emph{http://www.youtube.com/watch?v=rb4V3Lrn-D0}

Apresentando narrativa em torno do que deveria ser tomado como
\textit{realidade}, esse vídeo foi feito, conta"-me um dos realizadores do
...
Aldeias (\textsc{fida} 4),\footnote{Na última edição do Prêmio Culturas Indígenas
...
Grande: era o \textit{pessoal} de Guyra Roká --- uma retomada que passa por
...
sua solidariedade aos Kaiowá e Guarani, identificando"-os como um \textit{povo
...
pelo vídeo, Gallois e Carelli (1995, p.\,213) notaram a importância de
...
(1995, p.\,213). No caso que apresento aqui, os M\=aori decidiram entrar em
...
efetividade sobre o \textit{real}.
...
ela precisa ser compreensível \textit{em si e para si}. Muitas vezes ela não
...
narrativa}.\footnote{Benjamin, 1985, p.\,203.}
\end{quote}
...
Trabalhando sob diferentes \textit{modos de} produzir informação, um coletivo
...
necessidades impostas pelo mundo dos \textit{projetos}.\footnote{Este Fórum é
...
próprio nome da associação diz, \textit{realizadores indígenas}, categoria
...
membros da \textit{diretoria} da associação, a experiência de captura e edição
...
com relação a termos como \textit{realizador}, \textit{filmmaker} ou \textit{cineasta}
...
chamamos de um ‘filme’'' (Dias, 2011, p.\,13). De fato, o que a etnografia
...
\textit{projetos} de formação de \textit{realizadores}, \textit{cineastas}, \textit{filmmakers}.

No caso da Ascuri, \textit{realizador indígena} aqui parece conter um
...
\textit{projetos} de comunicação, de forma que \textit{realizador indígena} --- assim
como os produtos de suas práticas midiáticas, como sugere Dias (2011, p.\,73), aparecem como formas de produzir relações eficazes com os não
...
\textit{práticas midiáticas}, como forma de contemplar tanto o caráter
...
Te’ýikue, a \textsc{ti} Caarapó, durante o Vídeo Índio Brasil,\footnote{Esse
...
membro da Ascuri, o \textit{som do arquinho não tem palavras} e, portanto, é
impossível anotá-lo.
...
realizador responde que \textit{o cinema é muito rápido} e, por estar
...
vontade de \textit{fazer o diferente}.
...
Segundo Marques Pereira (2004, p.\,275--6), entre os xamãs kaiowá ``a
...
de \textit{preservação da cultura}, pois
...
xamãs se rebelam contra uma espécie de folclorização da cultura}.\footnote{Marques Pereira, 2004, p.\,275.}
\end{quote}
...
mesmo que essa construção se traduza em dilemas e desencontros de expectativas.
...
meio dela, os indígenas falam por si. Essa fala quis mostrar elaborações
...
\textit{falarem}, como disse, com múltiplos auditórios --- com vistas a produzir
...
\textit{guaranização} das tecnologias.

\begin{bibliohedra}
\tit{benjamin}, Walter. \emph{Magia e técnica, arte e política}. São Paulo: Ed.
Brasiliense, 1985.

\tit{dias}, Diego Madi. \emph{``Mekaron Ipêx'': cultura, corpo, comunicação e
...
\tit{gallois}, Dominique Tilkin \& \textsc{carelli}, Vincent. ``Índios eletrônicos: a
rede indígena de comunicação''. \emph{Sexta Feira} 2, São Paulo: Pletora, 1998.

\titidem. ```Vídeo nas Aldeias': A~experiência Waiãpi''. \emph{Cadernos de Campo} 2,
1992.

\titidem. ``Diálogo entre Povos Indígenas: a Experiência de Dois Encontros
Mediados pelo Vídeo''. \emph{Revista de Antropologia} 38(1), 1995.

\tit{pereira}, Levi Marques. ``O~pentecostalismo Kaiowá: uma aproximação dos
aspectos sociocosmológicos e históricos''. In: \textsc{wright}, Robin M.
...
\footnotesize
{\itshape
Quem trabalha com os Kaiowá viu o que foi a mobilização de 2012:
...
Kaiowá como sobrenome no perfil do Facebook, entre outros efeitos. Um
ano antes, se você fosse perguntar para as pessoas quem são os Guarani
Kaiowá, tem um bocado de gente que não tinha ideia. Nesse contexto, o
trabalho de vídeo é promissor, principalmente com a formação de
coletivos mistos, trocas de experiência e informação.}

\smallskip
\hspace*{\fill}\textsc{spensy k. pimentel}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Comunicação, convívio e permuta\break em \emph{Yvy vai}}
\addcontentsline{toc}{chapter}{Comunicação, convívio e permuta em \emph{Yvy vai}, \textit{\small por Maria Inês Ladeira}}
\markboth{Comunicação, convívio\ldots}{}

\begin{flushright}
\textsc{maria inês ladeira}\footnote[*]{Doutora em Geografia Humana pela
...
\emph{juruá}, ``não indígenas'', não abstraiu seus próprios mecanismos mesmo que,
por vezes, eles apareçam interagindo com as novas tecnologias.\looseness=-1

Em \emph{Yvy vai}, o convívio e a permuta, incluindo os \emph{juruá} em sua
...
se acendem os fogos'', e onde, a partir dos seus elementos constitutivos, espécies povoadoras, são criados elos de comunicação e continuidade
...
que vivem nas florestas. Já \textit{os brancos vieram de outras ilhas}.
Entretanto, por não ser exclusivo, o seu compartilhamento com os \emph{juruá}
...
\emph{etavaekuéry}, os \emph{juruá}, perfuram a terra, estragando e enfraquecendo o
...
naturais necessários para sustentar o modo de vida dos \emph{juruá} no mundo
...
feitas pelo \emph{juruá} cada vez se estragam mais e mais, e contou das
...
que as coisas do \emph{juruá} entram demais na aldeia, que eles não escutam
...
possível adquirir a capacidade de entender os \textit{códigos} que ele envia,
...
cantos, me disse que o \textit{jeito de saber} era um jeito que não podia se
acabar como as coisas do \emph{juruá}.
...
mundo socialmente reedificado. Cadogan (1997) refere"-se ao
...
\textls[-10]{Essa esfera de comunicação, ou comunhão das almas, \emph{nhẽe}, se
...
partilhada e interpretada constantemente (Ladeira, 1992).}\looseness=-1

Esse princípio de interatividade pressupõe um outro, anterior, que é o
da separação dos primeiros Guarani, \textit{em casais}, para povoar, e assim
...
aldeia Pastoreo, em Itapua, Paraguai, em 1997, proferido para recepcionar
...
otra en la morada de Karaí, Oriente, {[}\ldots{}{]}'' (Cadogan, 1997 {[}1959{]}, p.\,24 e 49.} para compor, enfeitar, reproduzir os seres criados por
...
já propõe várias formas de \textit{permuta} para tornar possíveis as
...
de tantas fronteiras: o \emph{paraguassu}, ``mar'', \emph{yvyty}, ``montanhas'', \emph{kaguy poruey}, ``matas intocáveis'', os descaminhos provocados por \emph{Anhã}, o \emph{jepotá}, ``transformação em seres primigênios'', a própria morte física, os
\emph{etavaekuéry}, ``os que são muitos em \emph{Yvy vai}'', os \emph{juruá}.
Nem mesmo esses
...
marãey}, ``terra da perenidade'', pois os seres, ou espécies, de origem, as
...
\textit{permanentemente}, um mesmo espaço geográfico. Entretanto, pelo fato
...
\textls[-10]{Já a transmissão de mensagens sobre acontecimentos previsíveis na terra,
...
\textit{códigos}, daí o prestígio dos xamãs. O~acesso às divindades acontece
...
retã}, ``moradas dos \emph{Nhanderu}''.}\looseness=-1
...
veiculação do fenômeno \emph{jepotá} no \emph{Youtube}: um corpo foi exumado por
...
batizados, os que não têm um nome"-alma prescindem de ser pessoa, humanidade guarani, daí sua preocupação em não acreditar.}
...
pedras, as \emph{yvyra}, as ``árvores'', \emph{mbore}, ``anta'', \emph{tatu}, \emph{guyra}, ``todos os pássaros''\ldots{} Para entrar nas matas é preciso pedir licença para
...
profundidade. Sobre as relações com os \textit{donos das coisas}, a etnologia
indígena tem dedicado atenção. Entre os trabalhos que se aprofundam
sobre o assunto, destaca"-se o de Fausto (2008). }\looseness=-1
...
Vale do Ribeira, São Paulo, os frutos pequenos dessas espécies privilegiadas
...
\section{«Jurakuéry, etavaekuéry, yvypokuéry»\protect\footnote{\uppercase{O}~termo
mais comumente
empregado para designar os \emph{juruá}, ``brancos'', é \emph{etavekuéry}. \emph{
...
origem, a chegada, dos \textit{brancos}.}}
...
usar. Mas agora o \emph{juruá} diz que tem que pedir licença pra ele, o \textsc{ibama}
...
inferem os sistemas dos \emph{juruá}. Os povos indígenas incorporam às suas
próprias cosmologias o universo dos brancos, \emph{juruá}, com suas
conceituações e tecnologias. Assim, os aparatos tecnológicos
construídos em \emph{Yvyrupa}, como carros, televisão, computadores, celulares, são
...
Nas mediações com as agências de governo, como a \textsc{funai} e o Ministério da Justiça,
com as instituições de educação, saúde, assistência, \textsc{ong}s, entre
outras, os indígenas de um modo geral, já há algum tempo, e
...
mesmos que sejam decifráveis pelos não indígenas, aos quais,
...
parceiros \emph{juruá}, têm se constituído num meio eficaz também para a
circulação de notícias e informações entre aldeias, proporcionando
alegrias e saudades e motivando encontros \textit{de verdade}.
...
\begin{bibliohedra}
\tit{cadogan}, León. \emph{Textos míticos de los Mbya"-Guaraní del Guaíra}. Asunción:
Ceaduc/\,Cepag, 1997 [1959].

\tit{fausto}, Carlos. ``Donos demais: maestria e domínio na Amazônia''. \emph{Mana},
14(2), 2008. 

\tit{gorosito kramer}, Ana Maria. \emph{Encuentros y desencuentros. Relaciones
...
\titidem. \emph{Espaço geográfico guarani"-mbya: significado, constituição e uso}.
São Paulo: Edusp, 2008.

\titidem. ``Yvy marãey''. \emph{Suplemento Antropológico} 34(2), 1999.

\tit{montoya}, Antonio R. \emph{Tesoro de la lengua guarani}. Asunción: Centro de
...
\begin{adjustwidth}{-2.7cm}{}
 \vspace{-3.1cm}
 \includegraphics[width=136mm]{./img/GUARANIS-img6_crop2.jpg}	
  \end{adjustwidth}
  \caption{Inauguração de \emph{ogapysy} (casa de reza) kaiowá na Reserva Indígena
...
\chapter*{Formas organizacionais entre os Kaiowá e Guarani em Mato Grosso do Sul\smallskip\subtitulo{Mobilidade, modalidades de assentamentos}}
\addcontentsline{toc}{chapter}{Formas organizacionais entre os Kaiowá e Guarani em Mato Grosso do Sul, \textit{\small por Levi Marques Pereira}}
%\markboth{Mobilidade, modalidades\ldots}{}
\markboth{Kaiowá e Guarani em Mato Grosso do Sul}{}

%\chapter*{Mobilidade, modalidades de assentamentos\\ e formas organizacionais entre
%os Kaiowá e Guarani em Mato Grosso do Sul}
%\addcontentsline{toc}{chapter}{Mobilidade, modalidades de assentamentos e formas organizacionais entre os Kaiowá e Guarani em Mato Grosso do Sul}

%\@openrighttrue\makeatother

\begin{flushright}
\textsc{levi marques pereira}\footnote[*]{Docente na Universidade Federal da
...
Kaiowá e Guarani que vivem em Mato Grosso do Sul (\textsc{ms}), considerando as estratégias por eles
...
livro de Nimuendajú (1987, p.\,xxiii), afirma que os Guarani ``continuam
...
essa suposta \textit{espantosa capacidade de desterritorialização} tem
...
culturais que asseguram sua reprodução (Beber, 2004, p.\,132--3; 
Cavalcante, 2013, p.\,64ss). Essa definição
...
\textit{confinamento} em reservas, desenvolvido por Brand (1997). A~esse
conceito, proponho acrescentar a percepção das reservas enquanto \textit{áreas
...
As oito reservas, demarcadas pelo \textsc{spi} entre 1915 e 1928, perfazendo um
...
\section{A~reserva como área de confinamento e de\break acomodação e a geração de novas
formas\break de mobilidade e assentamentos}
...
oficial}'' (Schaden, 1974, p.\,10). Mas foi Brand (1997) quem
...
assentamentos se orientavam pelas seguintes características:
...
disse um líder político, \textit{antigamente o indígena sempre procurava o lugar
bom para morar, onde tinha mato bom, água boa}, ou seja, fatores
ecológicos influenciavam na escolha;

\item
O local estar livre de ameaças
sobrenaturais, como espíritos perigosos;

\item
Proximidade de parentelas aliadas, necessárias para as práticas matrimoniais, festivas e rituais;

\item
A capacidade do casal de \textit{cabeças} de parentela de conduzir
eficazmente a vida comunitária, ou seja, de demonstrar habilidade para
unir os parentes e resolver problemas de convivência;

\item
A não incidência de doenças ou de mortes repentinas provocadas por causas
...
cosmológicos. A~ocupação agropastoral interrompeu essa dinâmica de
...
e \textit{neutralidade} em relação às formas de exercício da política kaiowá e
...
Qualquer chefe de posto da \textsc{funai}, agente indigenista, missionário, ou
...
\textit{autoridades} --- como denominam o Capitão e o Chefe de
Posto\footnote{Chefe de Posto era o funcionário do órgão indigenista
responsável por gerir a reserva e o Capitão era o indígena escolhido como
...
destituiu a figura do chefe de posto, nas os indígenas seguem chamando os
...
\textit{aprisionamento} das autoridades, numa espécie de manipulação recíproca
e oscilante.
...
os \emph{outsiders} de sua condição de \textit{estrangeiros}. 
...
indígena acabou por gerar muita inquietação ou \textit{incomodação} nos
...
\section{Famílias kaiowá e guarani reacomodadas\break em periferias de cidades}
...
de análise algumas famílias situadas na confluência de linhas, as estradas
...
\section{Acampamentos mobilizados para a reocupação\break da terra: «tekorarã»}
...
ocupação tradicional. Geralmente, estão situados: 

\begin{enumerate}
\item
Margens de
rodovias próximas à terra reivindicada;

\item
Acampamentos no interior das reservas;

\item
Ocupando pequenas porções da terra reivindicada. 
\end{enumerate}
...
\section{Apropriação de espaços e produção\break de formas de vida comunitária}
...
situação de indígenas vivendo em periferias das cidades parece apresentar
...
unicamente na população \textit{aldeada} nas reservas. A~análise aqui
...
\begin{bibliohedra}
\tit{beber}, Marcus Vinícius. \emph{O~sistema de assentamento dos grupos ceramistas
...
\tit{brand}, Antonio J. \emph{O~impacto da perda da terra sobre a tradição
kaiowá/\,guarani: os difíceis caminhos da palavra}. Tese de Doutorado.
Porto Alegre: \textsc{puc}-\textsc{rs}, 1997.

\tit{cardoso de oliveira}, Roberto. \emph{O~índio e o mundo dos brancos}. São Paulo:
Pioneira, 1972 {[}1964{]}.

\tit{cavalcante}, Thiago Leandro Vieira. \emph{Colonialismo, território e
territorialidade: a luta pela terra dos Guarani e Kaiowá em Mato Grosso
do Sul}. Tese de Doutorado. Assis: \textsc{unesp}, 2013.

\tit{nimuendajú}, Curt Unkel. \emph{As lendas da criação e destruição do mundo como
fundamentos da religião dos Apapocúva"-Guarani}. São Paulo,
Hucitec/\,Edusp, 1987 {[}1914{]}.

\tit{pereira}, Levi M. \emph{Imagens kaiowá do sistema social e seu entorno}. Tese de
Doutorado. São Paulo: \textsc{ppgas}-\textsc{usp}, 2004.

\titidem. \emph{Relatório de identificação da Terra Indígena Guyra Roka,
...
Kaiowá e dos indígenas na região das Guianas em questões relacionadas à
...
ao modo de circular e às estruturas em redes dos Guarani Kaiowá? Por
uma certa política do \textsc{spi} e mesmo mais antiga, o confinamento entre os
Guarani Kaiowá forçou ao uso de formulações do tipo \emph{tekoha} significando
...
espaços entrecortados por cidades, estradas e fazendas em que os Kaiowá
...
Brasil}
\addcontentsline{toc}{chapter}{Articulações e transformações entre as parcialidades Guarani no sul do Brasil, \textit{\small por Diogo de Oliveira}}
\markboth{Articulações e transformações\ldots}{}

\begin{flushright}
\textsc{diogo de oliveira}\footnote[*]{Bacharel em Ciências Biológicas pela Universidade Federal de Santa Catarina (\textsc{ufsc}),
mestre em Antropologia Social pelo Programa de Pós"-Graduação em Antropologia Social (\textsc{ppgas-ufsc}) e Indigenista
...
conhecidos pelas designações Mbya, Nhandéva, ou Chiripa, e Kaiowá. A
presença dessa grande diversidade na população guarani já havia sido
apontada naquela região por Nimuendajú (1914) alguns anos antes.
...
A~obra de Egon Schaden (1962), em seus \textit{aspectos fundamentais
...
parece"-me que a obra de Schaden peca por seu enfoque na \textit{aculturação},
...
quais ele chama de Nhandéva e \textit{Mbüa}, são aqueles que à época
...
entre estes e aqueles que se encontravam nas selvas do Alto Paraná, no
Paraguai, e Misiones, na Argentina, no fim da Guerra do Paraguai, em
1870. Podemos considerar que estudos como os de Ciccarone
(2001), Ladeira (2007; 2008), Rodrigues (1999),
Litaiff (1996; 1999) e Vietta (1992), entre outros, são
...
Rosa Mariani Cavalheiro, que em linhas gerais se autoidentifica aos
não indígenas como mbya, apontar recorrentemente a sua diferença a outros
grupos Guarani por serem do \textit{costume chiripa}. Tal assertiva passou a
...
como Kaiowá, e Tambeope, que vieram a ser conhecidos como Mbya, quais
...
grupos \textit{educavam} os Tambeope sobre os costumes da agricultura e a
...
de pyno, o urtigão. Neste sentido, os Chiripa usavam calças compridas
...
Podemos dizer que os dialetos nhandéva e kaiowá são mais próximos entre
...
menção aos dialetos nhandéva e kaiowá como sendo a \textit{língua antiga},
...
história de vida o \textit{tempo em que não existia \emph{juruá}}, a mobilidade
...
Segundo o casal, sua idade é medida de fato pela \textit{taquara seca},
...
Cavalos, Mbiguaçu, entre outros.\footnote{Veja Vietta (1992); Garlet
...
no sul do Brasil, que somam aproximadamente 5.500 indígenas (\textsc{sesai},
...
registrados por Nimuendajú (1987), marcando a etnologia Guarani ao
discorrer sobre a busca da \textit{Terra sem mal}. Os Nhandéva fizeram a
...
relatada por Nimuendajú (1987), e outra a partir nos anos 1960, com a
...
Os grupos assentados em reservas mais antigas, como as \textsc{ri}s Araribá e
...
forçado com grupos Kaiowá, estabelecendo relações de conflito e
...
indígenas (\textsc{sesai}, 2013). De forma geral, autoidentificam"-se simplesmente
como Guarani, como um diferenciador em relação aos Kaiowá, com quem
...
de seis mil indígenas, que ocupavam mais de 40 aldeias (Carvalho, 2013;
Peralta, 1995; Guaska, 2012), no oeste do Paraná. Estes indígenas da
...
que somam aproximadamente três mil indígenas (\textsc{sesai}, 2013), sendo que
...
pessoas Mbya e Kaiowá entre os Ava"-Guarani é comum, porém bastante
...
para as reservas Kaiowá, como Dourados, Amambai e Caarapó. Seus
...
\begin{bibliohedra}
\tit{barabas}, Alicia M. ``Los derechos indígenas, la antropología jurídica y
los movimientos etnopolíticos''. \emph{Ilha}, v.\,10, n.\,1, 2008.

\tit{barbosa}, Pablo Antunha \& \textsc{mura}, Fabio. ``Construindo e reconstruindo
territórios Guarani: dinâmica territorial na fronteira entre Brasil e
Paraguai (sec. \textsc{xix}-\textsc{xx})''. \emph{Journal de la société des américanistes}, v.\,97, n.\,2, 2011. 

\tit{bartolomé}, Miguel. \emph{Orekuera Royhendu (Lo que escuchamos en
sueños): Shamanismo y religión entre los Ava"-Katu"-Ete del Paraguay}.
México: Instituto Indigenista Interamericano, 1977.

\titidem. \emph{Procesos interculturales: antropología política
del pluralismo cultural en América Latina}. México: Siglo \textsc{xxi} Editores,
2006.

\titidem. ``Oguerojera (desplegarse) - la etnogenesis del
pueblo mbya"-guarani''. \emph{Ilha}, 10(1), 2008.

\tit{basini rodrigues}, José E. \emph{Estratégias econômicas, políticas e religiosas
na mito"-práxis mbyá-guarani}. Dissertação de Mestrado. \textsc{ufrgs}, 1999.

\tit{brasil}. \textsc{sesai} (Secretaria especial de Saúde Indígena). \emph{\textsc{siasi} -- Sistema de Informação de Atenção à Saúde Indígena}. Brasília: Ministério da
Saúde/\,\textsc{sesai}, 2013.

\tit{brighenti}, Clóvis.\emph{~Estrangeiros na própria terra:~presença
Guarani e Estados Nacionais}.~Chapecó: \textsc{argos}/\,Ed. da \textsc{ufsc}, 2010. 

\tit{cadogan}, León. \emph{Ayvu rapyta: textos míticos de los Mbyá-Guaraní del
Guairá}. Asunción: Ceaduc"-Cepag, 1997 [1959].

\titidem. ``Como interpretan los Chiripá (Avá Guaraní) la
danza ritual''. \emph{Revista de Antropologia}, v.\,7, n.\,1--2, 1959.

\titidem. ``En torno de la aculturación de los Mbya"-Guaraní
del Guairá''. \emph{América Indígena}, v.\,20, n.\,2, 1960. 

\titidem. \emph{Ywyra Ñe’ery: fluye del árbol la palabra.
Sugestiones para el estudio de la cultura guaraní}. Asunción: \textsc{cepag},
1971.

\tit{cardoso}, Jayme \& \textsc{westphalen}, Cecília. \emph{Atlas Histórico do Paraná}.
Curitiba: Livraria do Chaim, 1986.

\tit{ciccarone}, Celeste. \emph{Drama e sensibilidade: migração, xamanismo e
mulheres mbya guarani}. Tese de Doutorado. \textsc{puc}-\textsc{sp}, 2001.

\tit{conradi}, Carla. \emph{As ações do Estado Nacional e a
trajetória política dos Guarani Ñandeva no Oeste do Paraná (1977--1997)}.
Dissertação de Mestrado. \textsc{ufgd}, 2007.

\tit{darella}, Maria Dorothea. \emph{Ore Roipota Yvy Porã, Nós queremos terra boa:
territorialização guarani no litoral de Santa Catarina, Brasil}. Tese de
Doutorado. \textsc{puc}-\textsc{sp}, 2004.

\tit{garlet}, Ivori. \emph{Mobilidade mbyá: história e significação}.
Dissertação de Mestrado. \textsc{puc}-\textsc{rs}, 1997.

\tit{gobbi}, Flávio S. \emph{Entre parentes, lugares e outros: traços na
sociocosmologia guarani no sul}. Dissertação de Mestrado. \textsc{ufrgs}, 2008.

\tit{guaska}, Enrique. ``Del canto al llanto. Situación de las comunidades
indígenas afectadas por la represa de Itaipú''. \emph{Acción}, v.\,157, 2012.

\tit{ladeira}, Maria Inês. \emph{O~caminhar sob a luz. Território mbya à
beira do oceano}. São Paulo: \textsc{unesp}, 2007.

\titidem. \emph{Espaço geográfico guarani"-mbya: Significado,
constituição e uso}. São Paulo: Edusp, 2008.

\tit{litaiff}, Aldo. \emph{As divinas palavras: identidade étnica dos Guarani"-Mbyá}.
Florianópolis: \textsc{ufsc}, 1996.

\titidem. \emph{Les fils du soleil: mythes et pratiques dês
indiens mbya"-guarani du littoral du Brésil}. Tese de Doutorado.
Université de Montréal, 1999.

\tit{melià}, Bartolomeu; \textsc{grünberg}, Friedl; \textsc{grünberg} Georg. \emph{Los Pai"-Tavyterã. Etnografía guaraní del Paraguay contemporáneo}. Asunción: Centro de
Estudios Antropológicos de la Universidad Católica, 1976.

\tit{melià}, Bartomoleu. \emph{El Guarani conquistado y reducido: ensayos de
etnohistoria}. Asunción: Biblioteca Paraguaya de Antropología, 1986.

\titidem. ``A~terra sem mal dos Guarani: economia e profecia''. \emph{Revista de
Antropologia}, vol.~33, 1990. 

\titidem. \emph{El Guarani: experiencia religiosa}. Asunción: Ceaduc"-Cepag, 1991.

\tit{mello}, Flávia. \emph{Aata tapé rupy, seguindo pela estrada:~uma
...
\titidem. \emph{Aetchá Nhanderukuery Karai Retarã. Entre Deuses e Animais:
Xamanismo, Parentesco e transformação entre os Chiripá e Mbyá}. Tese de
Doutorado. \textsc{ufsc}, 2006. 

\titidem. ``Mbyá e Chiripá: identidades étnicas, etnônimos e autodenominações
entre os Guarani do sul do Brasil''. \emph{Tellus}, v.\,7, n.\,12, 2007.

\tit{müller}, Pe. Franz. \emph{Etnografia de los Guarani del Alto Parana}. Buenos
Aires: \textsc{caea}, 1989.

\tit{myskiw}, Antonio. \emph{Colonos, posseiros e grileiros: conflitos de
terras no Oeste Paranaense (1961/\,66)}. Dissertação de Mestrado.
\textsc{uff}-\textsc{unioeste}, 2002.

\tit{nimuendajú}, Curt. \emph{As lendas de criação e destruição do mundo como
fundamentos da religião dos Apapocúva"-Guarani}. São Paulo: Hucitec/\,\textsc{usp},
1987 [1914].

\tit{oliveira}, Diogo. \emph{Arandu Nhembo’ea: Cosmologia, Agricultura e Xamanismo
entre os Guarani"-Chiripá no litoral de Santa Catarina}. Dissertação de
Mestrado. \textsc{ufsc}, 2011.

\tit{peralta}, Raquel. \emph{Los impactos de la Itaipú y las respuestas a los
mismos, de los Avá Chiripá, de acuerdo a su filosofía sobre la tierra}.
Monografía, 1995.

\tit{pereira}, Levi Marques. \emph{Parentesco e organização social kaiowá.
Dissertação de Mestrado}. \textsc{unicamp}, 1999.

\tit{pimentel}, Spensy K. \emph{Elementos para uma teoria política kaiowá e guarani}.
 Tese de Doutorado. \textsc{ppgas}-\textsc{usp}, 2012.

\tit{ribeiro}, Sara. \emph{O~horizonte é a terra: manipulação da
...
\tit{silva}, Evaldo Mendes da. \emph{Folhas ao vento: a micromobilidade de grupos
Mbya e Nhandéva (Guarani) na Tríplice Fronteira}. Tese de Doutorado. \textsc{ppgas}-Museu Nacional, 2007.

\tit{vietta}, Katya. \emph{Mbya: guarani de verdade}. Dissertação de Mestrado. \textsc{ufrgs}, 1992.
\end{bibliohedra}
...
quando se menciona \textit{coletivos}, e do que se fala quando se menciona
\textit{redes}. O~culturalismo que guiou o trabalho de missionários e etnólogos
...
\smallskip
\hspace*{\fill}\textsc{marta amoroso}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Um nome que faz diferença\subtitulo{Reflexões com famílias tupi-guarani}}

\addcontentsline{toc}{chapter}{Um nome que faz diferença, \textit{\small por Lígia R.\,Almeida, Amanda C.\,Danaga e Camila Mainardi}}
%\markboth{Um nome\ldots}{}

\begin{flushright}
\textsc{lígia r. almeida}\footnote[*]{Doutora em antropologia social pelo
\textsc{ppgas}-\textsc{usp}.}\\
\textsc{amanda c. danaga}\footnote[\dag]{Doutora em antropologia
social pelo \textsc{ppgas}-\textsc{ufsc}ar.}\\
\textsc{camila mainardi}\footnote[\ddag]{Doutora em antropologia social pelo \textsc{ppgas}-\textsc{usp}.}
\end{flushright}
...
Guarani e seus municípios são: Araribá, em Avaí; Bananal, em Peruíbe;
Guarani do Aguapeú, em Mongaguá; Serra de Itatins, em Itariri; Jaraguá, em São
Paulo; Ribeirão Silveira, em São Sebastião; Itaoca, em Mongaguá;
Piaçaguera, em Peruíbe; Renascer, em Ubatuba; Barão de Antonina, em Barão de
Antonina; Guarani de Itaporanga, em Itaporanga; Tekoa Jaikoaty, em 
Miracatu; Paranapuã, em São Vicente; Aldeinha, em Itanhaem; e Paraíso, em Iguape. Em algumas dessas aldeias há corresidência entre os Tupi
...
nos municípios de Barão Antonina, no sudoeste do estado de São Paulo,
Ubatuba, no litoral norte do estado de São Paulo, e Peruíbe, no litoral sul
do mesmo estado. Veremos que a noção de \textit{mistura},\footnote{Falas e
...
\textit{mistura} que, segundo nossos interlocutores, é resultante de uma história
...
alianças que os grupos mantêm com os outros, sejam eles indígenas ou não
indígenas, de maneiras muito diversas. Sendo as relações entre estes
...
a despeito de ter nomeado um subgrupo como Nhandeva, reconhece \textit{essa}
expressão como a autodenominação de todos os Guarani, significando ``os
que são dos nossos''.

A~respeito da definição desse termo, Nimuendajú (1987, p.\,7) comentou: ``Os
...
termo \emph{nhandeva} para se referirem aos parentes e a outros indígenas. Fazem
uso de nhandeva não como um etnônimo, uma categoria fixa que remeteria
a uma etnia, mas como forma de identificar"-se enquanto indígenas. Empregam
o termo, em especial, em oposição aos não indígenas.\footnote{No caso da
...
não indígenas, na relação com o Estado --- mas não só --- e são imputadas de
...
imposto pelos não indígenas, mas trataram de lhes ensinar que são Tupi
Guarani. A~autodesignação expressa a \textit{mistura}, os casamentos entre Tupi
e Guarani, e também com outros indígenas e não indígenas como constituintes
...
interlocutores de modos e intensidades diferentes: a \textit{mistura} e os
...
universo do discurso (2009, p.\,313).} as disputas territoriais e os
processos de demarcação da terra. 

\section{Aldeia Ywy Pyhaú: da luta pela terra\break ao fortalecimento da cultura}
...
cacique discursou sobre a importância da terra para sua família tupi"-guarani, 
fazendo críticas ferrenhas ao tratamento conferido aos povos
...
mais velha da aldeia Ywy Pyhaú, em junho de 2010:
...
sempre fomos Tupi"-Guarani, o branco que quis mudar isso.
\end{quote}
...
garantir o direito de sua família \textit{viver na cultura}, de \textit{ser Tupi
Guarani}. E~foi assim, junto às reivindicações pela terra e à busca de
garantia de que poderiam, tal qual \textit{os antigos},\footnote{``Viver como os
...
fundamental para a aquisição de tais qualidades.} viver em uma \textit{terra
...
indígenas encontraram os Tupi"-Guarani e os ouviram chamarem"-se entre si de
\emph{nhandeva}, que traduzem como \textit{todos nós índios}, os denominaram dessa
...
As famílias tupi"-guarani de Ywy Pyhaú afirmam que são \textit{índios misturados},
em razão dos casamentos realizados entre os Tupinambá e Tupiniquim da
costa litorânea e povos Guarani oriundos do Paraguai. Mas a \textit{mistura} e
os casamentos que nela resultam, como apontado anteriormente, remetem
ainda aos casamentos com outros povos indígenas e com os não indígenas.
Esses, em sua maioria, vão morar na aldeia e \textit{vivem mesmo como índio}.
...
puro, mas os principais mesmo foram esses dois.\footnote{Marcílio Marcolino,
aldeia Ywy Pyhaú, 2010.}
\end{quote}

A~\textit{mistura} é fundamental na constituição da pessoa e das famílias Tupi
Guarani e é constantemente acionada por essas famílias de Ywy Pyhaú
para explicar o que consideram \textit{ser Tupi"-Guarani}. Entretanto, ela não é
contrária ao que consideram ser um \textit{índio puro}, aquele que fala a língua
e vive segundo os costumes ensinados por \emph{Nhanderu}. Ser \textit{índio puro}
inclui \textit{ser índio misturado}, mas exclui a categoria \textit{mestiço} que, para
essas famílias, pressupõem a não \textit{vivência na cultura}.

\textit{Viver na cultura} consiste em respeitar o que lhes ensina \emph{Nhanderu}, bem
...
que possibilita a vivência como no \textit{tempo dos antigos} se torna escassa e
...
do que denominam \textit{fortalecimento cultural}. 
...
sempre mostrar nossa cultura!\footnote{Marcílio Marcolino, Aldeia Ywy Pyháu,
2010.}
\end{quote}

Como forma de mostrar a \textit{cultura tupi"-guarani}, as famílias de Ywy Pyhaú
...
do que o Tupi"-Guarani, o \emph{tupi antigo}. As crianças aprendem a língua nas
\textit{aulas de cultura} ministradas na escola da aldeia e também no convívio
...
com parceiros outros, indígenas de aldeias próximas e não indígenas engajados
na elaboração e execução de projetos culturais que visam a conquista e
manutenção de direitos. O~\textit{fortalecimento cultural} dessas famílias,
através da demarcação de sua terra e dos projetos mencionados são uma
forma de \textit{continuar existindo}, como costuma enfatizar o cacique Marcílio
Marcolino.\looseness=-1
...
parentes, \textit{aldeia \textsc{x}} ou \textit{aldeia de fulano}, em comentários como: ``Agora
...
pela aldeia Nhamandu Mirim, estamos em constante mudanças para
...
informações entre em contato pelo telefone celular {[}número{]}.\footnote{Cacique
...
conformação do etnônimo Tupi"-Guarani. Catarina disse: 
...
Nessas falas, a \textit{mistura} é positivada em detrimento da ideia de \textit{pureza} ---
...
inerente à construção do parentesco.\looseness=-1

\textls[-15]{Os casamentos estão envoltos em intenso debate. No limite, tais
discussões têm em vista aqueles com quem desejam compartilhar o dia a
dia e aqueles \textit{indesejados}, o que, em geral, independe de serem
indígenas ou brancos. O~ponto é que os casamentos são assuntos
importantes e lançam luz às narrativas sobre a \textit{mistura} e o etnônimo
Tupi"-Guarani.}\looseness=-1
...
\section{Entre outros: agenciamentos das\break relações na aldeia Ywyty Guaçu} 

As relações com outros --- famílias guarani mbya e não indígenas --- são marcadas
...
de \textit{mistura}. Caracterizam, inclusive, o processo de constituição da
...
cenário utilizado para a produção do filme e alguns indígenas foram
...
afirmação de que \textit{onde tem oca tem índio}, essas famílias fixaram"-se na
...
afirmam sua origem como resultante de um processo de \textit{mistura} entre duas
matrizes distintos, os Tupinambá e os Guarani. Sendo que os Tupi
Guarani da aldeia Ywyty Guaçu não excluem os não indígenas desse
...
a diferença entre a fala do filme e a fala deles: Parece que
...
trabalhando junto.\footnote{Antonio Awá, Aldeia Renascer, 2009.}
\end{quote}
...
outros grupos que vivem na região e dos não indígenas. ``Se Awá morre e não
...
\emph{www.aldeiarenascer.blogspot.com}.} No
...
produção e veiculação de imagens sinaliza um diálogo com aqueles que
...
Souza (2010), os enunciados da cultura seriam \textit{efeitos do encontro} com
o não indígena.\footnote{``Quando usam nossa palavra --- ou alguma tradução
...
mostrar que \textit{etnicidade}, entendida como linguagem em que o repertório
...
Entre \textit{bons e maus selvagens do século \textsc{xvi}} até \textit{ecólogos por natureza
...
construídos (Carneiro da Cunha, 2012, p.\,120--4). No caso das famílias tupi
guarani que vivem no estado de São Paulo, elas não acolheram um nome
imposto pelos não indígenas --- tal como a classificação Guarani Nhandeva ---
e lutaram, e ainda lutam, pela desconstrução de um estereótipo de
\textit{indianidade}, afirmando aos não indígenas sua condição Tupi"-Guarani,
...
que expressam a \textit{mistura}, os casamentos entre famílias Guarani e Tupi,
...
em especial no que diz respeito aos não indígenas. A~estes são dirigidas
as enunciações que relatam a \textit{mistura} como constituinte da pessoa tupi
guarani. Ademais, os não indígenas podem ser colaboradores em projetos e
...
famílias tupi"-guarani. Ensejamos sublinhar que os não indígenas e as
...
\begin{bibliohedra}
\tit{albert}, Bruce \& \textsc{ramos}, Alcida. \emph{Pacificando o branco. Cosmologias do
contato no Norte amazônico}. São Paulo: \textsc{unesp}, 2000.

\tit{almeida}, Lígia R. \emph{Os Tupi"-Guarani de Barão de Antonina (\textsc{sp}): migração, território e identidade}. Dissertação de Mestrado. São Carlos: \textsc{ufsc}ar,
2011.

\tit{carneiro da cunha}, Manuela. ``‘Cultura’ e cultura: conhecimentos
tradicionais e direitos intelectuais''. In: \line(1,0){25}. \emph{Cultura com aspas e outros ensaios}. São Paulo: Cosac \& Naify, 2009. 

\titidem. ``O~futuro da questão indígena''. In: \line(1,0){25}. \emph{Índios no Brasil: história, direitos e cidadania}. São Paulo: Claro Enigma, 2012.

\tit{coelho de souza}, Marcela S. ``A~vida material das coisas intangíveis''.
In: \line(1,0){25}; \textsc{coffaci de lima}, Edilene (orgs.).
\emph{Conhecimento e cultura: práticas de transformação no mundo indígena}.
Brasília: Athalaia, 2010.

\tit{danaga}, Amanda C. \emph{Os Tupi, os Mbya e os outros: um estudo etnográfico da
aldeia Renascer - Ywyty Guaçu}. Dissertação de Mestrado. São Carlos:
\textsc{ufsc}ar, 2012. 

\tit{ladeira}, Maria Inês. ``Aldeias livres Guarani do litoral de São Paulo e
da periferia da capital''. In: \textsc{monteiro}, John Manuel et al. (orgs.).
...
\tit{mainardi}, Camila. \emph{Construindo proximidades e distanciamentos. Etnografia
da Terra Indígena Tupi"-Guarani Piaçaguera, \textsc{sp}}. Dissertação de Mestrado.
São Carlos: \textsc{ufsc}ar, 2010.

\tit{nimuendajú}. Curt. ``Apontamentos sobre os Guarani''. \emph{Revista do Museu
Paulista}, v.\,8, 1954.

\titidem. \emph{As lendas de criação e destruição do mundo como fundamentos da
...
\tit{schaden}, Egon. ``Aspectos fundamentais da cultura guarani''. \emph{Revista de
Antropologia} vol.~4, 1954.

\tit{taylor}, Anne"-Christine. ``La invención del Jívaro: notas etnográficas
...
Xiripa, Nhandeva, Kaiowá\ldots{} A~classificação Mbya foi criada, não sei
...
\smallskip
\hspace*{\fill}\textsc{papa mirῖ poty (carlos fernandes)}
\end{minipage}
\end{flushright}

\thispagestyle{empty}

\chapter*{Os Mbya desceram o Araguaia\subtitulo{Parentesco e dispersão}}

\addcontentsline{toc}{chapter}{Os Mbya desceram o Araguaia, \textit{\small por Rafael Fernandes Mendes Júnior}}
\markboth{Os Mbya desceram\ldots}{}

\begin{flushright}
\textsc{rafael fernandes mendes júnior}\footnote[*]{Doutor pelo \textsc{ppgas}-Museu
Nacional/\,\textsc{ufrj}.}
\end{flushright}

%\section{Introdução}

\noindent{}Este artigo é o resultado de seis meses de trabalho de
campo
%\footnote{Para a pesquisa de campo entre os Mbya contei com
%financiamento do \textsc{ppgas} através dos ``Editais de Auxílio à Pesquisa
%\textsc{ppgas}/\textsc{mn}/\textsc{ufrj} e \textsc{capes}'' (2012/1, 2013/1 e 2013/2), do \textsc{cnp}q e da \textsc{faperj}.Uma versão preliminar deste artigo foi apresentada durante o seminário:
%``\textsc{ce}s\textsc{ta} nas redes Guarani'', na \textsc{usp}, em outubro de 2013.}
junto aos Mbya
...
tem o mesmo significado que \emph{nhandeagua}. Aos não indígenas denominam
\emph{juruá}.} ou pelos brancos, \emph{juruá}, em um contexto em que as
...
Paraguai em busca da terra sem mal (Nimuendajú, 1987 [1914]).
...
separada, dentro do campo Tupi"-Guarani'' (1986, p.\,99). Isso porque o autor
...
infância e adolescência em um local que ele chamava de \textit{margem do
...
capturado pelos soldados paraguaios, sob acusação de ser \textit{revoltoso}, e
...
ela como \textit{Guerra do Paraguai}, onde seus pais, mobilizados pelas
...
\textit{terra onde não mais se morre}, o motivo mítico foi a tônica da
...
queria nos levar'' (Albino Karai Ataa, \textsc{ti} Xambioá, 30 de maio de 2012).

Em agosto de 2014, ouvi de Joaquim Karai, neto do
\emph{nhanderu}\footnote{Entre os Guarani setentrionais e os Kaiowá (Montardo,
...
não indígenas, entre os setentrionais ela é rejeitada por estar associada à
...
%Verificar referência a figuras e tracejados
...
numa fazenda sob os cuidados de um homem não indígena. Em 1975, o irmão
...
%  \centering
% \includegraphics[width=\textwidth]{./img/fig1_horiz.jpg}	
%  \hfill
%  \caption{Dispersão das famílias após a morte do cacique Manoel Rodrigues em Mozarlândia, Goiás, no ano de 1966}
% \end{figure} 
...
% \begin{figure}[Ht]
%   \centering
%  \includegraphics[width=\textwidth]{./img/GUARANIS-img10_crop.png}	
%   \hfill
...
podíamos ficar lá, porque éramos paraguaios'' (João Werá). 
...
% \begin{figure}[Ht]
  % \centering
 % \includegraphics[width=\textwidth]{./img/GUARANIS-img11_crop.jpg}	
  % \hfill
...
eu ia conversar na linguagem e eu mesmo sorria de mim.\footnote{Abílio Karai e
Leonardo Guarany, Nova Jacundá, 24 de junho de 2013.}
\end{quote}

%-->TRATAR! EXCLUIR LEGENDA EMBUTIDA NA IMAGEM!
% \begin{figure}[Ht]
%   \centering
%  \includegraphics[width=\textwidth]{./img/GUARANIS-img12_crop.png}	
%   \hfill
%   \caption{Constituição do grupo do Albino desde a Ilha do Bananal até a Terra Indígena Xambioá, entre o final da década de 1960 e o final da década de 1980.}
% \end{figure}
   % Unhandled or unsupported graphics:
...
que casar com \textit{juruá} ou com outros índios; então é melhor casar com
...
não, a gente sabe que é errado!\footnote{João Werá, Nova Jacundá, 11 de junho de 2012.}
\end{quote}

Em sua tese de doutorado, Mello (2006, p.\,75) havia chamado a atenção para
...
referentes que os nossos, como envolvem outros componentes'' (2002, p.\,406).
...
possibilidade pertinente'' (2002, p.\,408).
...
\emph{jepotá}. Como em outros contextos ameríndios, ocorre quando uma pessoa,
...
pessoas Mbya e não Mbya, \emph{juruá} ou \emph{te’yi}. Este tipo de casamento é
...
casamentos entre Mbya e \emph{juruá} de uma forma positiva a partir de suas
...
possuíam nomes mbya. O~motivo era claro: \emph{juruá ra’y ou juruá rajy}, ``filho ou filha de pai \emph{juruá}''.} pelo xamã, restando"-lhes apenas o nome
brasileiro. Esse enfraquecimento, no limite, ocasiona a morte da
pessoa.

\emph{Jejavy} e \emph{jepotá} são, portanto, dois modos indesejados de relação com o
exterior e pela mesma razão: a perda da verdadeira condição humana.
A~vítima de \emph{jepotá} deixa o convívio de seus parentes e termina por
...
viver como \emph{juruá} ou \emph{te’yi}, entre brancos ou indígenas. 
...
quem se casar que não fosse guajajara ou \emph{juruá}. Essa época coincidiu
...
fundamental da busca pessoal de satisfação'' (2007, p.\,59); ``se não se fica
...
ela existe como potência --- \emph{jepotá} e \emph{jejavy}. Paralelamente, este
...
lhes deram Nimuendajú (1987 [1914]), Clastres (1978 [1975]) e Schaden
...
grupo'' mantenho o termo proposto por Garlet: mobilidade (Garlet, 1997, p.\,16 \emph{apud} Pissolato, 2007, p.\,97). Após o falecimento do xamã, o
...
\begin{bibliohedra}
\tit{albernaz}, Adriana. \emph{Antropologia, histórias e
temporalidades entre os Ava"-Guarani de Oco’i (\textsc{pr})}. Tese de Doutorado.
\textsc{ufsc}, 2009.

\tit{cadogan}, Leon. \emph{Dicionario mbya"-guarani"-castellano}. Asunción: Ceaduc"-
Cepag, 1992.

\tit{capdevila}, Luc. ``La guerre du Chaco Tierra adentro déconstruire la
representation d’un conflit international''. In: \textsc{capdevila}, Luc;
\textsc{combès}, Isabelle; \textsc{richard}, Nicolas; \textsc{barbosa}, Pablo. \emph{Les
hommes transparents: indiens et militaires dans la guerre du Chaco
(1932--1935)}. Rennes: \textsc{pur}, 2010.

\tit{chamorro}, Graciela. \emph{A~espiritualidade guarani: uma teologia ameríndia
da palavra}. São Leopoldo: Ed. Sinodal, 1998.

\tit{clastres}, Hélène. \emph{A~terra sem mal: o profetismo tupi"-guarani}. São Paulo:
Brasiliense, 1978.

\tit{fausto}, Carlos. \emph{Os Parakanã. Parentesco e avunculato}. Dissertação de
Mestrado. \textsc{ppgas}-\textsc{ufrj}, 1991.

\titidem. ``De primos e sobrinhas: terminologia e aliança entre os Parakanã
(Tupi) do Pará''. In: \textsc{viveiros de castro}, Eduardo (org.). \emph{Antropologia do
parentesco: estudos ameríndios}. Rio de Janeiro: \textsc{ufrj}, 1995.

\titidem. \emph{Inimigos Fiéis}. São Paulo: Edusp, 2001.

\tit{heurich}, Guilherme. \emph{Outras alegrias: parentesco e festas mbya}.
 Dissertação de Mestrado. \textsc{ppgas}-Museu Nacional, 2011.

\tit{ladeira}, Maria Inês. \emph{O~caminhar sobre a luz: o território mbyá à beira
do oceano}. Dissertação de Mestrado. \textsc{puc}-\textsc{sp}, 1992.

\titidem. \emph{Espaço geográfico guarani"-mbya: Significado,
constituição e uso}. São Paulo: Edusp, 2008.

\tit{lima}, Tânia Stolze. ``O~dois e seu múltiplo: reflexões sobre o
perspectivismo em uma cosmologia tupi''. \emph{Mana}, v.\,2, n.\,2, 1996.

\tit{macedo}, Valéria. \emph{Nexos da diferença. Cultura e afecção em uma aldeia
guarani na Serra do Mar}. Tese de Doutorado. \textsc{ppgas}-\textsc{usp}, 2009.

\titidem. ``De Encontros nos Corpos Guarani''. \emph{Ilha}, v.\,15, n.\,2, 2013.

\tit{melià}, Bartolomeu. \emph{El Guarani: experiencia religiosa}. Asunción:
Ceaduc"-Cepag, 1991

\tit{mello}, Flávia. \emph{Aetchá Nhaderukuery karai retarã: Entre
deuses e animais: xamanismo, parentesco e transformação entre os
...
\tit{migliora}, Amanda Alves. \emph{Inventando outros: desdobramentos de um contato
multifacetado}. Dissertação de Mestrado. \textsc{ppgas}-Museu Nacional, 2014.

\tit{nimuendajú}, Curt. \emph{As lendas de criação e destruição do mundo como
fundamentos da religião apapocúva"-guarani}. São Paulo: Hucitec, 1987 {[}1914{]}.

\tit{pereira}, Vicente Cretton. \emph{Aqueles que não vemos: uma etnografia das
relações de alteridade entre os Mbya Guarani}. Dissertação de Mestrado.
\textsc{ppga}-\textsc{uff}, 2014.

\tit{pierri}, Daniel. \emph{O~perecível e o imperecível: lógica do sensível
e corporalidade no pensamento guarani"-mbya}. Dissertação de Mestrado.
...
\tit{rivière}, Peter. \emph{Indivíduo e Sociedade na Guiana}. São Paulo: Edusp, 2001.

\tit{schaden}, Egon. \emph{Aspectos fundamentais da cultura guarani}. São Paulo:
Difel, 1962 {[}1954{]}. 

\tit{silva}, Evaldo. \emph{Folhas ao vento: a micromobilidade de grupos
Mbya e Nhandéva (Guarani) na Tríplice Fronteira}. Cascavel: Edunioeste, 2009.

\tit{vilaça}, Aparecida. \emph{Comendo como gente}. Rio de Janeiro: \textsc{anpocs}/\,\textsc{ufrj}, 1992.

\titidem. ``Chronically unstable bodies: reflections on Amazonian
corporalities''. \emph{Journal of the Royal Anthropological Institute}, 11(3),
2005.

\textsc{viveiros de castro}, Eduardo. \emph{Arawete: os deuses canibais}. Rio de
Janeiro: Jorge Zahar, 1986.

\titidem. ``Alguns Aspectos da Afinidade no Dravidianato Amazônico''. In:
\line(1,0){25} \& \textsc{carneiro da cunha}, M. (orgs.).
\emph{Amazônia: etnologia e história Indígena}. São Paulo: \textsc{nhii}-\textsc{usp},
1993.

\titidem. ``Atuação e contra"-efetuação do Parentesco''. In: \line(1,0){25}. \emph{A~inconstância da alma selvagem}. São Paulo: Cosac \& Naify, 2002.
\end{bibliohedra}
...
\chapter*{Os Mbya"-Guarani de Misiones frente à\break \emph{Ley del Aborigen} nos anos 1980}

\addcontentsline{toc}{chapter}{Os Mbya"-Guarani de Misiones frente à \emph{Ley del Aborigen} nos anos 1980, \textit{\small por Donatella Schmidt}}
\markboth{Os Mbya"-Guarani de misiones\ldots}{}

\begin{flushright}
\textsc{donatella schmidt}\footnote[*]{Docente na Universidade de Pádua, Itália.}
\end{flushright}
...
criação de uma lei que reconhecia o \textit{povo Guarani} como categoria
...
e que o velho Dionisio Duarte, até então reconhecido \textit{cacique geral} de
...
até que ele veio a ser nomeado \textit{cacique geral de Misiones}. Segundo seu
...
todos es requisitos necessários para ser reconhecido enquanto \textit{cacique}
geral.
...
benefícios derivantes do fato de ser parte da sociedade \textit{missioneira}, de
outro, a manutenção das distâncias; de um lado o \textit{progresso}, como ele
...
assembleia em Yaveriry, ele havia declarado querer os \emph{juruá}, os
...
setores da população de Misiones: era coautor de um livro de poesia,
...
continuamente a oposição entre o \textit{velho sistema} de Duarte e o \textit{novo
...
perder. Lorenzo queria voltar a \textit{estas coisas que já não tem mais, que
já se perderam} e Duarte queria manter \textit{estas coisas que ainda tem, que
...
tempo da Colônia, fugiram do sistema da \emph{encomenda} e do \emph{yanaconazgo};\footnote{Veja, por exemplo, Susnik, 1979--1980.} aderiram somente parcialmente
...
\emph{mbya reko}, expressa na procura da \textit{Terra sem mal}, centrada na \emph{opy},
...
\begin{bibliohedra}
\tit{clastres}, Hélène. \emph{La terre sans mal: le prophetisme Tupi"-Guarani}. Paris:
Editions du Seuil, 1975.

\tit{clastres}, Pierre. \emph{La société contre l’etat: recherche d’antropologie
politique}. Paris: Les editions de Minuit, 1974.

\tit{ley} del Aborigen 2435. Junho 1987, Posadas, Misiones.

\titidem. Regulamentación. Novembro 1987, Posadas, Misiones.

\titidem. Estatuto. Novembro 1987, Posadas, Misiones.

\tit{melià}, B. ``La tierra sin mal de los Guaraní. Economia y profecía''.
Asunción, \emph{Suplemento Antropólogico}, v.\,12, n.\,2, 1987.

\tit{schmidt}, Donatella. \emph{Do you have an \emph{Opy}? Politics and identity among the
Mbya"-Guaraní of Argentina and Eastern Paraguay}. San Francisco e
Bethesda: Austin \& Winfield Press, 1994.

\tit{shaden}, Egon. \emph{Aspectos fundamentais da cultura Guaraní}. São Paulo:
Edusp, 1974 {[}1954{]}.

\tit{susnik}, Branislava. \emph{Etnohistoria de los Guaranies: época colonial}.
Asunción: Museo Etnografico Andrés Barbero, 1979--1980.
\end{bibliohedra}

\chapter[Carta pública em defesa aos direitos do Povo Guarani]{Carta pública em defesa aos\break direitos do Povo Guarani}

\markboth{Carta pública\ldots}{}
...
\begin{flushright}
\textit{São Paulo, 18 de outubro de 2013}
\end{flushright}
