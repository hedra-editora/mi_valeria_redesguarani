...
Conhecido como \emph{Aty Guasu} --- Grande Assembleia Kaiowá e Guarani, esse
...
As festas kaiowá e guarani, segundo a memória dos mais velhos, estavam
...
\begin{quote}
A~combinação dos termos \textit{ontologia} e \textit{política} sugere"-nos que as
...
\noindent
Ha’e ko kunhãgue’i, yma, yma, kunhãgue’i por no ojepotáa py ko ikã guaxu
...
\footnotetext[8]{Conforme explicação que recebi sobre esta fala: quando a
...
\medskip
\noindent
``Rejejogua vai’i ‘rã, rejepotá ‘rã xera’y. Rejepotá ‘rã ko yvyra rovapy
...
\noindent
Ha'e rami vy ae tu omba'exo merami aipo avi he'i: ``ema'ẽ eme
...
noendui, nguu ayvu noendui’i va’e, va’e"-va’e’i rive tu ojepotá. Ha’e
...
vem.\footnotemark[10] E~isso não é bom. Quando menstrua pela primeira
vez, tem que sentar e sentar {[}passar pelo processo de reclusão{]}. Assim
é bom.
\end{paracol}
\footnotetext[10]{Refere"-se aos sujeitos não humanos que são atraídos pelo
...
\noindent
Ha’e vy ma inhegue’i primeira, he’ia rami juruá ayvu py, ijypy’i ete tu
...
\medskip
\noindent
Ha'e rami ma je, ha'e ma aipo e'i avi: ``eĩ yvi merami ma reĩ, eĩ
...
\medskip
\noindent
Ha'e va'e py ae ma tu ombo'e avi: ``ndeayvu katu vai rei eme
ta'vy''.
...
\switchcolumn
\noindent
Depois, ensinariam: ``Não fale mal dos outros''.
\end{paracol}
