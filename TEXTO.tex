...
\raggedleft
\footnotesize
\emph{As falas guarani e kaiowá mostram que a busca da Terra sem Mal pode estar na
...
do \emph{juruá} que chegam na aldeia. 
...
\textsc{ppgas}-\textsc{usp}.}\\
\textsc{amanda c. danaga}\footnote{Doutora em antropologia
social pelo \textsc{ppgas}-\textsc{ufsc}ar.}\\
\textsc{camila mainardi}\footnote{Doutora em antropologia social pelo \textsc{ppgas}-\textsc{usp}.}
\end{flushright}
\medskip
