...
``Guarani Kaiowá'' em seus nomes. Milhares de outras pessoas
acrescentaram aos seus perfis os dizeres ``Eu sou\ldots{}'' com o nome de um
povo indígena, sendo ``Kaiowá'' um dos mais citados. Na mesma direção,
...
tentar chegar, em vida, à Terra sem mal, \emph{yvy marane’y}, um lugar ``onde
...
``ambivalência do humano'' (Pissolato, 2007, p.\,410) posta em destaque nas
cosmologias tupi"-guarani. Esse autor, como se sabe, considerava a ideia
de um ``modelo tupi"-guarani'' (1986, p.\,623--700), elaborado a partir de uma
...
pessoa constituída pelo ``devir'' (1986, p.\,623). Entre os Guarani,
...
corporal"-espiritual, alcançar a imortalidade, ou ``amadurecimento''.
...
os ``motivos religiosos'' de Nimuendajú a um cálculo e uma razão ``à
...
1979, p.\,175), oriundas da ``aculturação'', com a chegada dos europeus, ou,
...
``profetismo'' como ``xamanismo feito história'' (2005, p.\,410) ou ``leitura da
...
recentemente, Sztutman (2005, p.\,41), de uma ``tradução guarani do devir não humano''?
...
foi a única a utilizar o termo ``utopia'' associado à Terra sem mal.
Carneiro da Cunha e Viveiros de Castro (2009, p.\,95) igualmente o
fizeram. 

Por que, afinal, é que, mesmo quando reconhecemos a dimensão política da
Terra sem mal, vamos considerá-la uma ``utopia''? Utopia, afinal ---
...
repassar diretamente aos indígenas uma mensagem a respeito de nosso ``caminho
...
mesmo. Sabe quando o \emph{xeramõi} fica ``argh, argh'' (sonorização), é que tem
...
num ambiente'' (Ingold, 2010, p.\,21). O~‘ambiente’ é compreendido aqui,
...
``transição entre o que se é e o que se está por ser'' (2009, p.\,163). Por
...
``encantamento sexual, o que se denomina \emph{odjepotá}'' (1962, p.\,85). Mas
...
inevitavelmente, o da feitiçaria, ou``arte'' como costumam dizer os Guarani,
...
``consciência'' do parentesco,\footnote{Entre os Piro, a partir do trabalho da
...
primeira forma de consciência, aquela do ``pensar aos próximos'' (2006, p.\,161).
...
formas de ``alegrar (-se com) parente'', envolvendo ações ou disposições
...
``individualista'' da reza.\footnote{Ver Nimuendajú, 1987, e Schaden 1962, p.\,122.} 
...
\textls[-10]{Alguns contextos que colocam no centro o tema do ``ficar alegre'' foram
...
vida''. O~``si'' é a condição própria dos \emph{juruá}, sempre pensando em si,
...
das relações intercomunitárias e da guerra. O~``contra"-Estado'' que P.\,Clastres encontra entre os Guarani é um ``contra"-Um''\footnote{No sentido
sugerido por La Boétie no \emph{Discurso da servidão voluntária}, de 1549.} e
uma ``máquina de guerra'' do pensamento.\footnote{No sentido estendido
...
homens são humanos demais?'' (1974b, p.\,11). A~poesia das ``belas palavras''
...
a conexão entre o tema da ``terra corruptível'' e o mundo dos \emph{juruá}.
...
\emph{nhe’e kuery}, as divindades. Com a ``bruma pesada'' do \emph{Tupã} \emph{juruá}, por
...
\item
A capacidade do casal de ``cabeças'' de parentela de conduzir
...
menção aos dialetos nhandéva e kaiowá como sendo a ``língua antiga'',
...
história de vida o ``tempo em que não existia \emph{juruá}'', a mobilidade
...
discorrer sobre a busca da ``Terra sem mal''. Os Nhandéva fizeram a
...
\emph{mbya reko}, expressa na procura da ``Terra sem mal'', centrada na \emph{opy},
