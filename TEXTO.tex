...
temperança, caracterizada por um modo de ser calmo (Montardo, 2009, p.\,163--64). 
\end{quote}
...
aniquilar a humanidade xikrin (Gordon, 2006, p.\,410).
\end{quote}
...
transformação: aquela do botão em flor'' (2013, p.\,102, grifos meus). 
...
desenrolar sob o signo do Um (1974b, p.\,12).
\end{quote}
...
narrativa} (Benjamin, 1985, p.\,203, grifos meus).
\end{quote}
...
(Marques Pereira, 2004, p.\,275, grifos meus).
\end{quote}
...
oficial}'' (Schaden, 1974, p.\,10, grifos meus). Mas foi Brand (1997) quem
...
não, a gente sabe que é errado! (João Werá, Nova Jacundá, 11 de junho de 2012).
\end{quote}
