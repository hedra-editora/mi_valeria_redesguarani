...
\chapter*{Mundéu do mundo\subtitulo{Predação e troca em relações entre os Guarani e os \emph{juruá}}}
...
\textsc{lucas keese}\footnote{Mestre em antropologia pelo \textsc{ppgas}-\textsc{usp} e membro do \textsc{cti}.}
\end{flushright}
\medskip
...
trabalhar duro para analisar a questão.\footnotemark[2]}{\textsc{renée kahukura}\footnotemark[3]}
...
\raggedleft
\footnotesize
\emph{Quem trabalha com os Kaiowá viu o que foi a mobilização de 2012:
...
\section{Acampamentos mobilizados para a reocupação da terra --- «tekorarã»}
