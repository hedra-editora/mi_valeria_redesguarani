...
\vspace{-3.1cm}
  \includegraphics[width=136mm]{./img/Foto_capa_crop2}
\end{adjustwidth}
...
\chapter*{\emph{Aguyjevete} pra quem luta!\subtitulo{A~Comissão Yvyrupa e a busca por nosso espaço de viver}}
...
\bigskip
\textls[-10]{Essa narrativa, da qual reproduzo apenas um pequeno trecho, foi
...
assim como outras instituições e relações que vêm do mundo juruá, não
...
\chapter*{Tornar"-se adulto sem deixar de ser gente\subtitulo{Fazer (crescer) parentes}}
...
que agora os juruá dizem que é obrigatório pedir licença ao Ibama e
...
\chapter*{Mundéu do mundo\subtitulo{Predação e troca em relações entre os Guarani e os «juruá»}}
...
\section{«Roexauka rive»~vs.~«avyukuaa ta’anga rupi,\break romombe’u aguã nhandereko régua»\protect\footnote{``\uppercase{A}penas mostrar vs. falar através das imagens, para contar sobre nosso modo de ser''.}}{}
...
tempo do criador.}{\textsc{wai wai, chefe wajãpi}, em \emph{A~arca dos Zo’é}}
...
\addcontentsline{toc}{chapter}{Mobilidade, modalidades de assentamentos e formas organizacionais entre os Kaiowá e Guarani em \textsc{ms}}
...
\section{Acampamentos mobilizados para a\break reocupação da terra: «tekorarã»}
...
\item
Em margens de
rodovias nas proximidades da terra reivindicada;

\item
Em acampamentos no interior das reservas;
...
que casar com juruá ou com outros índios; então é melhor casar com
...
\begin{flushright}
\textsc{são paulo, 18 de outubro de 2013}
\end{flushright}
