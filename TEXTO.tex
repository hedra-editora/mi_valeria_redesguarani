...
Aldeia Peguaoty, Sete Barras (\textsc{sp})
...
(1999: 123), as obras de Nimuendajú (1987 [1914]) e Métraux (1927).
...
(\emph{nhandereko}).\footnote{O~termo \emph{nhandereko} (\emph{nhande} = pronome pessoal da primeira pessoa plural inclusiva, aqui com atribuição possessiva +
...
mal, ou ``imperecível'', ver Pierri, 2013), ou de levar a vida e criar
...
``individualista'' da reza (ver Nimuendajú, 1987 [1914] e Schaden 1962:
122). 
...
histórica desses grupos com aqueles descritos por Nimuendajú (1987
...
Já no início do século \textsc{xx}, com a criação do \textsc{spi} (Serviço de Proteção aos
Índios, órgão oficial que antecedeu a \textsc{funai}), Curt Nimuendajú
...
Te’ýikue (\textsc{ti} Caarapó) durante o Vídeo Índio Brasil,\footnote{Esse
...
poruey} (matas intocáveis), os descaminhos provocados por \emph{Anhã}, o \emph{jepotá}
(transformação em seres primigênios), a própria morte física, os
\emph{etavaekuéry} (os que são muitos em \emph{Yvy vai}, os \emph{juruá}). Nem mesmo esses
...
livro de Nimuendajú (1987: xxiii), afirma que os Guarani ``continuam
...
A~respeito da definição desse termo, Nimuendajú (1987: 7) comentou: ``Os
...
não, a gente sabe que é errado! (João Werá, Nova Jacundá, 11/06/2012).
\end{quote}
...
possuíam nomes mbya. O~motivo era claro: ``\emph{juruá ra’y ou juruá rajy}''
(filho ou filha de pai \emph{juruá}).} pelo xamã, restando"-lhes apenas o nome
