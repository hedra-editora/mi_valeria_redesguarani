...
\section{«Roexauka rive»~vs.~«avyukuaa ta’anga rupi, romombe’u aguã nhandereko régua»\footnotesize\protect\footnote{``\uppercase{A}penas mostrar vs. falar através das imagens, para contar sobre nosso modo de ser''.}}{}
...
\section{«Jurakuéry, etavaekuéry, yvypokuéry»\footnotesize\protect\footnote{\uppercase{O}~termo
mais comumente
