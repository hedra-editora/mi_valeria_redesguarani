...
\begin{figure}
 \centering
\includegraphics[width=\textwidth,height=\textheight]{./img/fig1_crop.jpg}	
 \hfill
...
%\begin{tabular}{c c}
%\includegraphics[width=\textwidth,height=\textheight]{./img/fig1.jpg}
%    &
%\rotatebox[origin=c]{90}{Figure~\thefigure: Figura 1. Dispersão das famílias após a morte do cacique Manoel Rodrigues em Mozarlândia (GO) no ano de 1966}
%\end{tabular}
%\end{figure}
...
\begin{quote}
%\noindent
\forceindent Abílio: Meus meninos ainda falavam na linguagem\footnote{É~como os
...
\begin{figure}
 ...
 \includegraphics[width=\textwidth]{./img/GUARANIS-img12_crop.png}	
  \hfill
  \caption{Figura 4. Constituição do grupo do Albino desde a Ilha do Bananal até a Terra Indígena Xambicá, entre o final da década de 1960 e o final da década de 1980.}
\end{figure}
   % Unhandled or unsupported graphics:
