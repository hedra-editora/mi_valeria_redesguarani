...
simpósio \versal{CE}st\versal{A} nas Redes Guarani.  Sob coordenação de Dominique Tilkin
...
Gallois, na coordenação do \versal{CE}stA, tem acompanhado a imensa demanda por
...
pesquisadores do \versal{CE}stA, aos quais fomos somando outros pesquisadores. 
...
atuação dos pesquisadores do \versal{CE}stA e de outros que puderam participar
do simpósio. Todas essas redes, que procuramos amarrar neste livro,
contaram com a colaboração inestimável da equipe do \versal{CE}stA, a quem
...
\chapterspecial{Aguyjevete pra quem luta!}{A Comissão Yvyrupa e a busca por
...
(em Ubatuba/\versal{SP}). Também tinha o mais velho que era o xondaro da aldeia,
...
de duas falas de Karai Mirim durante o simpósio ``\versal{CE}stA nas Redes
...
\emph{Valéria Macedo}\footnote{Docente na área de antropologia
do~Departamento de Ciências Sociais da Universidade Federal de São
Paulo e pesquisadora colaboradora no \versal{CE}stA-\versal{USP}.}
\end{flushright}
\medskip
...
\versal{RAMO} Y \versal{AFFONSO}, Ana Maria. De pessoas e palavras entre os Guarani-Mbya.
...
\versal{LEVI}-\versal{STRAUSS}, Claude. O cru e o cozido: Mitológicas I. São Paulo: Cosac
Naify, 2004 [1964].
