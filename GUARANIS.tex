...
Gallois e Valéria Macedo, o simpósio reuniu os antropólogos do \versal{CE}stA
...
aldeia Brakui, em Angra dos Reis/\versal{RJ}, e formado em Licenciatura em
...
O próximo artigo, de Alice Haibara --- mestre em antropologia pela \versal{USP} ---
...
povos, na Terra Indígena Panambi-Lagoa Rica, em Douradina (\versal{MS}). Foto:
...
\chapterspecial{\emph{Aguyjevete} pra quem luta!}{A Comissão Yvyrupa e a busca por
...
\chapterspecial{A caminho do Sol}{Cosmografias guarani}{}
\begin{flushright}
...
\versal{Pierri}, Daniel Calazans. O perecível e o imperecível: lógica do
...
Desde o século \versal{XVI} os Guarani tiveram uma série de tradutores, uns
...
\chapter{Novas terras sem males: a luta guarani-kaiowa pelos tekoha}
\begin{flushright}
...
forma os tekoha são pensados como \emph{yvy marane’y}. Além de gozar de grande
...
Yvy marane’y como um lugar da transcendência ao longo do século \versal{XX}? Não
...
\begin{Parskip}
\versal{CADOGAN}, Leon. Ayvu rapyta. 2ª ed. Assunção: Ceaduc-Cepag, 1997.

\versal{CARNEIRO} \versal{DA} \versal{CUNHA}, Manuela \& \versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo.
...
\versal{CLASTRES}, Hélène. Terra sem mal: o profetismo tupi-guarani. São
Paulo: Brasiliense, 1978.

\versal{COMBÈS}, Isabelle. Pai Sumé, el Rey Blanco y el Paititi. Anthropos
106, 2011a.

—————. El Paititi, los Candires y las migraciones guaraníes.
Suplemento Antropológico \versal{XLVI} (1), 2011b.

\versal{DE} \versal{LA} \versal{CADENA}, Marisol. Política indígena: um análisis más allá de
‘la política’. \versal{WAN E}-Journal 4, 2008. Disponível em
...
\versal{NIMUENDAJU}, Curt Unkel. As lendas da criação e destruição do mundo
como fundamentos da religião dos Apapocúva-Guarani. São Paulo:
Hucitec/Edusp, 1987 [1914].
...
\versal{PEREIRA}, Levi M. Imagens kaiowa do sistema social e seu entorno.
Tese de Doutorado. São Paulo: \versal{PPGAS}/\versal{USP}, 2004.

\versal{PIMENTEL}, Spensy K. ``Violência contra os povos indígenas''. In:
Sacchetta, Vladimir (org.). \versal{CDDPH}: Conselho de Defesa dos Direitos da
...
agronegócio. \versal{R}@u 4(2), 2012a.
...
\versal{PISSOLATO}, Elizabeth. A duração da pessoa: mobilidade, parentesco
e xamanismo mbya (guarani). São Paulo: Unesp, \versal{ISA}; Rio de Janeiro:
NuTi, 2007.

\versal{SZTUTMAN}, Renato. O profeta e o principal: a ação política
ameríndia e seus personagens. Tese de Doutorado. São Paulo: \versal{PPGAS}-\versal{USP},
2005.

\versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo. Araweté: os deuses canibais. Rio de
...
tekoha reocupada em litígio,  \versal{TI}s e reservas/aldeias. Além das Aty
...
\chapterspecial{Sonhos e conhecimentos na vida guarani}{Uma experiência de
...
\begin{flushright}
\emph{Jera Poty Miri (Giselda Pires de Lima)\footnote{Professora na escola da aldeia Tenonde Porã, São Paulo /\versal{SP}.}}
\end{flushright}  
...
\begin{flushright}
\emph{Alice Haibara}\footnote{Mestre em antropologia pela \versal{USP} e membro do
...
\begin{Parskip}
\versal{CLASTRES}, Helene. Terra sem mal: o profetismo tupi-guarani. São
Paulo: Brasiliense, 1978.

\versal{COHN}, Clarice. A criança indígena: a concepção Xikrin de infância
e aprendizado. Dissertação de Mestrado. São Paulo: \versal{PPGAS}-\versal{USP}, 2000.

\versal{ECKART}, Jan-Arthur Bruno. O saber imanente mbya-guarani e a escola
...
\versal{LIMA}, Giselda Pires de (Jera Guarani). Kyringue reko. Crianças
guarani. Trabalho de Conclusão de Curso. São Paulo: Fisp/\versal{USP}, 2008.

\versal{MELO}, Clarissa Rocha de. Corpos que falam em silêncio. Escola,
...
\versal{MONTARDO}, Deise Lucy Oliveira. Através do mbaraka. Música, dança e
xamanismo guarani. São Paulo: Edusp, 2009

\versal{OLIVEIRA}, Melissa.  Nhanhembo’é: infância, educação e religião
entre os Guarani de M’Biguaçu, \versal{SC}. Cadernos de Campo 13, 2005.

\versal{TESTA}, Adriana Queiroz. Palavra, sentido e memória. Educação e
...
\begin{Parskip}
\versal{GALLOIS}, Dominique Tilkin. O movimento na cosmologia waiãpi:
criação, expansão e transformação do universo. Tese de Doutorado
(versão corrigida). São Paulo: \versal{PPGAS}-\versal{USP}, 1996.

\versal{GARCIA}, Uirá Felippe. Karawara. A caça e o mundo dos Awá-Guajá.
Tese de Doutorado. São Paulo: \versal{PPGAS}-\versal{USP}, 2010.

\versal{GARLET}, Ivori José. Mobilidade mbyá: história e significação.
Dissertação de Mestrado. Porto Alegre: \versal{PUC}-\versal{RS}, 1997.

\versal{LADEIRA}, Maria Inês. Espaço geográfico guarani-mbya. Significado,
...
\versal{SCHADEN}, Egon. Aspectos fundamentais da cultura guarani. São
Paulo: Difusão Europeia do Livro, 1962.

\versal{TESTA}, Adriana Queiroz. Caminhos de saberes guarani mbya: modos de
criar, crescer e comunicar. Tese de Doutorado. São Paulo: \versal{PPGAS}-\versal{USP},
2014.

\versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo. A inconstância da alma selvagem e
...
Para que os mbya possam ficar aqui em \emph{yvy rupa} (esta Terra, plataforma
...
voltando, entre a \emph{yvy rupa} e o amba (cidade, lugar) de Nhanderu (o
...
dos nhe’\~{e} terem afazeres e especializações, tanto na \emph{yvy rupa} como
...
entre as aldeias e entre a \emph{yvy rupa} (plataforma terrestre) e o amba de
...
alegrar juntas. Em se tratando de chegar a \emph{yvy marã e’\~{y}} (Terra sem
...
\begin{Parskip}
\versal{CADOGAN}, León. Ayvu rapyta. Textos míticos de los Mbyá-Guaraní del
Guairá. São Paulo: \versal{FFLCH}-\versal{USP}, boletim n. 227, série Antropologia n. 5,
1959.

\versal{CLASTRES}, Hélene. Terra sem mal. Roraima: Ed. Tapé, 2007 [1978].
...
\versal{LADEIRA}, Maria Inês. Espaço geográfico Guarani-Mbya. São Paulo:
Edusp, 2008.

—————. O caminhar sob a luz: o território Mbya à beira do oceano. 
Dissertação de Mestrado. São Paulo: \versal{PUC}-\versal{SP}, 1992.

\versal{LIMA}, Tânia Stolze. Um peixe olhou pra mim: o povo Yudjá e a
perspectiva. São Paulo: Unesp, \versal{ISA}; Rio de Janeiro: NuTi, 2005.

\versal{MACEDO}, Valéria. Nexos da diferença. Cultura e afecção em uma
aldeia guarani na Serra do mar. Tese de Doutorado. São Paulo:
\versal{PPGAS}-\versal{USP}, 2009.

\versal{MELIÀ}, Bartolomeu. El Guarani: experiência religiosa. Asunción:
Ceaduc-Cepag, 1991.

\versal{MONTOYA}, Antonio Ruiz de. Vocabulário y tesoro de la Lengua
...
\versal{PISSOLATO}, Elizabeth de Paula. A duração da pessoa. Mobilidade,
parentesco e xamanismo mbya (guarani). São Paulo: Unesp, \versal{ISA}; Rio de
Janeiro: NuTi, 2007.

\versal{SEEGER}, Anthony; \versal{DA} \versal{MATTA} Roberto; \versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo. A
...
\versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo. A inconstância da alma selvagem. São
Paulo: Cosac Naify, 2002.

\versal{WAGNER}, Roy. A invenção da cultura. São Paulo: Cosac Naify, 2010
[1981].
\end{Parskip}
...
\begin{Parskip}
\versal{ALLARD}, Olivier. Emotions and relations: a point of view on
Amazoniam kinship. Dissertação de Mestrado. Cambridge: University of
Cambridge, 2003.

\versal{FAUSTO}, Carlos. Inimigos fiéis: historia, guerra e xamanismo na
...
\versal{SEEGER}, Anthony; \versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo; \versal{DA} \versal{MATTA}, Roberto. A
construção da pessoa nas sociedades indígenas brasileiras. Boletim do
Museu Nacional 32, 1979.

\versal{STRATHERN}, Marilyn. The gender of the gift. Problems with women
and problems with society in Melanesia. Berkeley e Los Angeles:
University of California Press, 1988.

\versal{SURRALÉS}, Alexandre. Au coeur du sens: perception, affectivité,
...
\begin{Parskip}
\versal{CARVALHO}. Maria Lucia Bradt de. Das terras dos índios a índios sem
terras. O Estado e os Guarani do Oco’y: violência, silêncio e luta.
Tese de Doutorado. São Paulo: \versal{USP}, 2013.

\versal{FUNAI}. Relatório circunstanciado de identificação e delimitação da \versal{TI}
Tenondé Porã. Brasília: \versal{FUNAI}, 2010.

\versal{FUNAI}. Relatório circunstanciado de identificação e delimitação da \versal{TI}
Jaraguá. Brasília: \versal{FUNAI}, 2011.

\versal{GARLET}, Ivori José. Mobilidade mbya: história e significação.
Dissertação de Mestrado. Porto Alegre: \versal{PUC}-\versal{RS}, 1997.

\versal{LADEIRA}, Maria Inês. O caminhar sob a luz: o território mbya à beira do
...
\versal{MACEDO}, Valéria Mendonça de. Nexos da diferença. Cultura e afecção em
uma aldeia guarani na Serra do Mar. Tese de Doutorado. São Paulo:
\versal{PPGAS}-\versal{USP}, 2009

\versal{NIMUENDAJU}, Curt Unkel. As lendas da criação e da destruição do mundo
como fundamentos da religião dos Apapocuva-guarani. São Paulo:
Hucitec/Edusp, 1987 [1914].

\versal{NOELLI}, Francisco Silva. Sem tekoha não há tekó: em busca de um modelo
...
\versal{NOGUEIRA} \versal{DA} \versal{SILVA}, Fabio de O. Elementos de etnografia mbya: lideranças
...
\versal{PEREIRA}, Sandra de Castro. Os loteamentos clandestinos no distrito do
Jaraguá (\versal{SP}): moradia e especulação. Dissertação de Mestrado. São
Paulo: \versal{USP}, 2006.

\versal{SCHADEN}, Egon. Aspectos Fundamentais da cultura guarani. São Paulo:
Epu/Edusp, 1974 [1954].
...
Índio, órgão oficial que antecedeu a \versal{FUNAI}), Curt Nimuendaju
...
\begin{Parskip}
\versal{BONILLA}, Oiara. Des proies si désirables: soumission et prédation pour
...
\versal{CENTRO} \versal{DE} \versal{TRABALHO} \versal{INDIGENISTA} (coord.). Xondaro Mabaete. A Força do
Xondaro. São Paulo: \versal{CTI}, 2013.

\versal{GORDON}, Cesar. Economia selvagem: ritual e mercadoria entre os índios
Xikrin-Mebêngôkre. São Paulo: Unesp, \versal{ISA}; Rio de Janeiro: Nutti, 2006.

\versal{COSTA}, Luiz. Alimentação e comensalidade entre os Kanamari. Mana 19(3),
2013.

\versal{FAUSTO}, Carlos. Banquete de gente: comensalidade e canibalismo na
Amazônia. Mana 8(2), 2002.

\versal{FAUSTO}, Carlos. Donos demais: maestria e domínio na Amazônia. Mana
14(2), 2008.

\versal{HEURICH}, Guilherme O. Outras alegrias: parentesco e festas mbya.
Dissertação de Mestrado. Rio de Janeiro: \versal{PPGAS}-Museu Nacional, 2011.

\versal{LADEIRA}, Maria Inês. O caminhar sob a luz. O território mbya à beira do
oceano. São Paulo: Unesp, 2007.

\versal{LADEIRA}, Maria Inês \& \versal{AZANHA}, Gilberto. Os índios da Serra do Mar. A
...
\versal{LIMA}, Tania Stolze. Um peixe olhou pra mim: o povo Yudjá e a
perspectiva. São Paulo: Unesp, \versal{ISA}; Rio de Janeiro: Nutti, 2005.

\versal{MACEDO}, Valéria. ``Nexos da Diferença entre os Guarani. Entre aldeias,
...
\versal{MACEDO}, Valéria. De encontros nos corpos guarani. Ilha 15, 2013.
...
\versal{MACEDO}, Valéria. Nexos da diferença. Cultura e afecção em uma aldeia
guarani na Serra do Mar. Tese de Doutorado. São Paulo: \versal{PPGAS}-\versal{USP}, 2009.

\versal{MELLO}. Flávia Cristina de. Aetchá nhanderukuery karai retarã: entre
...
\versal{MENDES} \versal{JÚNIOR}, Rafael Fernandes. Os animais são muito mais do que algo
...
séculos \versal{XVI}-\versal{XVII}. In: Carneiro da Cunha, Manuela (org.). História dos
índios no Brasil. São Paulo: Companhia das Letras, 1998 [1992].

\versal{NIMUENDAJU}, Curt. As lendas da criação e destruição do mundo como
fundamentos da religião dos Apapocúva-Guarani. São Paulo,
Hucitec/Edusp, 1987 [1914].

\versal{PEREIRA}, Vicente Cretton. Aqueles que não vemos: uma etnografia das
relações de alteridade entre os Mbya Guarani. Dissertação de Mestrado.
Rio de Janeiro: \versal{PPGA}-\versal{UFF}, 2014.

\versal{PIMENTEL}, Spensy K. Elementos para uma teoria política kaiowa e guarani.
Tese de Doutorado. São Paulo: \versal{PPGAS}-\versal{USP}, 2012.

\versal{PIERRI}, Daniel Calazans. O perecível e o imperecível. Lógica do sensível
e corporalidade no pensamento guarani-mbya. Dissertação de Mestrado.
São Paulo: \versal{PPGAS}-\versal{USP}, 2013.

\versal{PISSOLATO}, Elizabeth. A duração da pessoa. Mobilidade, parentesco e
xamanismo mbya (guarani). São Paulo: Unesp, \versal{ISA}; Rio de Janeiro: \versal{N}u\versal{TI},
2007.

\versal{RAMO} \versal{Y} \versal{AFFONSO}, Ana Maria. De pessoas e palavras entre os Guarani-Mbya.
...
(parte \versal{I}). Mana 3(1), 1997.

\versal{SCHADEN}, Egon. Aspectos fundamentais da cultura guarani. São Paulo:
Edusp, 1974 [1954].

\versal{SZTUTMAN}, Renato. O profeta e o principal: a ação política ameríndia e
...
\versal{VILAÇA}, Aparecida. Conversão, predação e perspectiva. Mana 14(1), 2008.

\versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo. A inconstância da alma selvagem. São Paulo:
Cosac Naify, 2002.
\end{Parskip}
...
nhe’ẽ é \emph{yvy marã e’y}, mundo incorruptível, onde nada se esgota;
...
\begin{Parskip}
\versal{ALBERT}, Bruce. L’or cannibale et la chute du ciel. L’homme 126-128,
1993.

\versal{BATISTA} \versal{VIANNA}, Rosely. Roça barroca. São Paulo: Cosac Naify, 2011.

De La \versal{BOÉTIE}, Étienne. Discours de la servitude volontaire. Paris:
Flammarion, 1993 [1549].

\versal{CESARINO}, Pedro. Quando a terra deixou de falar: cantos da mitologia
...
\versal{CLASTRES}, Hélène. La terre sans mal: le prophétisme tupi-guarani. Paris:
Eds. du Seuil, 1975. [Tradução brasileira: Terra sem Mal. O profetismo
tupi-guarani. São Paulo: Brasiliense, 1978.]

—————. ``De quoi parlent les indiens''. In: \versal{ABENSOUR}, Miguel \& \versal{KUPIEC}
(eds.) Pierre Clastres. Paris: Sens \& Tonka, 2011.

\versal{CLASTRES}, Pierre. La Société contre l’État. Paris: Eds. de Minuit,
...
\versal{DELEUZE}, Gilles; \versal{GUATTARI}, Félix. Mil platôs. Capitalismo e
esquizofrenia \versal{II}. São Paulo: Editora 34, 2004 [1980].

\versal{KOPENAWA}, Davi \& \versal{ALBERT}, Bruce. La chute du ciel: paroles d’um chamane
yanomami. Paris: Plon, 2010.

\versal{LEVI}-\versal{STRAUSS}, Claude. O cru e o cozido: Mitológicas \versal{I}. São Paulo: Cosac
Naify, 2004 [1964].
...
\versal{PIERRI}, Daniel C. O perecível o imperecível: lógica do sensível e
corporalidade no pensamento mbya-guarani. Dissertação de Mestrado. São
Paulo: \versal{PPGAS}-\versal{USP}, 2013.

\versal{POUGY}, Henrique. Por uma pragmática do poder: a fala do chefe no Alto
...
\versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo. Métaphysiques cannibales: lignes
...
Aldeias (\versal{FIDA} 4)\footnote{Na última edição do Prêmio Culturas Indígenas
...
de produção audiovisual, radio-difusão e \versal{TV} Comunitária{quotedbl}.
...
Te’ýikue (\versal{TI} Caarapó) durante o Vídeo Índio Brasil\footnote{Esse
...
relações eficazes: essas cartas, vídeos, \versal{CD}s, websites, livros,
...
\begin{Parskip}
\versal{BENJAMIN}, Walter. Magia e técnica, arte e política. São Paulo: Ed.
Brasiliense, 1985.

\versal{DIAS}, Diego Madi. ``Mekaron Ipêx'': cultura, corpo, comunicação e
...
usar. Mas agora o jurua diz que tem que pedir licença pra ele, o \versal{IBAMA}
...
Comissão Guarani Yvyrupa (\versal{CGY}), inovando na articulação das aldeias e na
...
\begin{Parskip}
\versal{CADOGAN}, León. Textos míticos de los Mbya-Guaraní del Guaíra. Asunción:
Ceaduc/Cepag, 1997 [1959].

\versal{FAUSTO}, Carlos. Donos demais: maestria e domínio na Amazônia. Mana
14(2), 2008. 

\versal{GOROSITO} \versal{KRAMER}, Ana Maria. Encuentros y desencuentros. Relaciones
interétnicas y representaciones em Misiones (Argentina). Dissertação de
Mestrado. Brasília: \versal{UNB}, 1982.
...
\versal{MONTOYA}, Antonio R. Tesoro de la lengua guarani. Asunción: Centro de
...
\versal{CARDOSO} \versal{DE} \versal{OLIVEIRA}, Roberto. \emph{O índio e o mundo dos brancos}. São Paulo:
Pioneira, 1972 [1964].
...
Como mencionado, os grupos Nhandéva que na transição para o século \versal{XX}
...
\versal{BARTOLOMÉ}, Miguel Alberto. \emph{Orekuera Royhendu (Lo que escuchamos en
...
\versal{BRIGHENTI}, Clóvis Antônio.\emph{~Estrangeiros na própria terra:~presença
...
mulheres mbya guarani}. Tese de Doutorado. São Paulo: \versal{PUC}-\versal{SP}, 2001.

\versal{CONRADI}, Carla Cristina Nacke. \emph{As ações do Estado Nacional e a
trajetória política dos Guarani Ñandeva no Oeste do Paraná (1977-1997)}.
Dissertação de Mestrado. Dourados: \versal{UFGD}, 2007.
...
Doutorado. São Paulo: \versal{PUC}-\versal{SP}, 2004.
...
\versal{LADEIRA}, Maria Inês Martins. \emph{O caminhar sob a luz. Território mbya à
beira do oceano}. São Paulo: Editora da \versal{UNESP}, 2007.
...
Florianópolis: Editora da \versal{UFSC}, 1996.
...
\versal{MELLO}, Flávia Cristina. \emph{Aata tapé rupy, seguindo pela estrada:~uma
investigação dos deslocamentos territoriais de famílias mbyá-guarani no
sul do Brasil}.~Dissertação de Mestrado. Florianópolis: \versal{UFSC}, 2001.
...
Doutorado. Florianópolis: \versal{UFSC}, 2006. 
...
Aires: \versal{CAEA} Ed., 1989.

\versal{MYSKIW}, Antonio Marcos. \emph{Colonos, posseiros e grileiros: conflitos de
...
Mestrado. Florianópolis: \versal{UFSC}, 2011.
...
Dissertação de Mestrado}. Campinas: \versal{UNICAMP}, 1999.

\versal{PIMENTEL}, Spensy K. \emph{Elementos para uma teoria política kaiowá e guarani}.
 Tese de Doutorado. São Paulo: \versal{PPGAS}-\versal{USP}, 2012.

\versal{RIBEIRO}, Sara Iurkiv Gomes Tibes. \emph{O horizonte é a terra: manipulação da
identidade e construção do ser entre os guarani no Oeste do Paraná
(1977-1997)}. Tese de Doutorado. Porto Alegre: \versal{PUC}-\versal{RS}, 2002.
...
de Janeiro: \versal{PPGAS}-Museu Nacional, 2007.

\versal{VIETTA}, Katya. \emph{Mbya: guarani de verdade}. Dissertação de Mestrado. Porto
Alegre: \versal{UFRGS}, 1992.
\end{Parskip}
...
\versal{CARNEIRO} \versal{DA} \versal{CUNHA}, Manuela. ``‘Cultura’ e cultura: conhecimentos
...
\versal{COELHO} \versal{DE} \versal{SOUZA}, Marcela S. ``A vida material das coisas intangíveis''.
...
\versal{PPGAS}/\versal{MN}/\versal{UFRJ} e \versal{CAPES}'' (2012/1, 2013/1 e 2013/2), do \versal{CNP}q e da \versal{FAPERJ}.
Uma versão preliminar deste artigo foi apresentada durante o seminário:
``\versal{CE}s\versal{TA} nas redes Guarani'', na \versal{USP}, em outubro de 2013.} junto aos Mbya
...
\begin{Parskip}
\versal{ALBERNAZ}, Adriana Cristina Repelevicz. \emph{Antropologia, histórias e
temporalidades entre os Ava-Guarani de Oco’i (\versal{PR})}. Tese de Doutorado.
Florianópolis: \versal{UFSC}, 2009.
...
Mestrado. Rio de Janeiro: \versal{PPGAS}-\versal{UFRJ}, 1991.
...
parentesco: estudos ameríndios}. Rio de Janeiro: Editora \versal{UFRJ}, 1995.

—————. \emph{Inimigos Fiéis}. São Paulo: Edusp, 2001.

\versal{HEURICH}, Guilherme Orlandini. \emph{Outras alegrias: parentesco e festas mbya}.
 Dissertação de Mestrado. Rio de Janeiro: \versal{PPGAS}-Museu Nacional, 2011.

\versal{LADEIRA}, Maria Inês. \emph{O caminhar sobre a luz: o território mbyá à beira
do oceano}. Dissertação de Mestrado. São Paulo: \versal{PUC}-\versal{SP}, 1992.
...
\versal{MELLO}, Flávia Cristina de. \emph{Aetchá Nhaderukuery karai retarã: Entre
deuses e animais: xamanismo, parentesco e transformação entre os
Chiripá e Mbyá Guarani}. Tese de Doutorado. Florianópolis: \versal{PPGAS}-\versal{UFSC},
2006.

\versal{MENDES} \versal{JÚNIOR}, Rafael Fernandes. \emph{Os animais são muito mais do que algo
somente bom para comer}. Dissertação de Mestrado. Niterói: \versal{PPGA}-\versal{UFF},
2009.

\versal{MIGLIORA}, Amanda Alves. \emph{Inventando outros: desdobramentos de um contato
multifacetado}. Dissertação de Mestrado. Rio de Janeiro: \versal{PPGAS}-Museu
Nacional, 2014.

\versal{NIMUENDAJU}, Curt Unkel. \emph{As lendas de criação e destruição do mundo como
...
relações de alteridade entre os Mbya Guarani}. Dissertação de Mestrado.
Niterói: \versal{PPGA}-\versal{UFF}, 2014.
...
xamanismo mbya (guarani)}. São Paulo: Unesp, \versal{ISA}; Rio de Janeiro: NuTi,
2007.
...
\versal{VILAÇA}, Aparecida. \emph{Comendo como gente}. Rio de Janeiro: \versal{ANPOCS}/Ed. \versal{UFRJ},
1992.
...
\versal{VIVEIROS} \versal{DE} \versal{CASTRO}, Eduardo (1986). \emph{Arawete: os deuses canibais}. Rio de
Janeiro: Jorge Zahar/\versal{ANPOCS}, 1986.

—————. ``Alguns Aspectos da Afinidade no Dravidianato Amazônico''. In:
Viveiros de Castro, Eduardo \& Carneiro da Cunha, Manuela (orgs.).
\emph{Amazônia: etnologia e história Indígena}. São Paulo: \versal{NHII}-\versal{USP}/Fapesp,
1993.
...
\versal{SCHMIDT}, Donatella. \emph{Do you have an Opy? Politics and identity among the
