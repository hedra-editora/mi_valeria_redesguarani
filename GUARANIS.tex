...
%\scriptsize{\emph{A~Comissão Yvyrupa e a busca por nosso espaço de viver}}}
...
%\scriptsize{\emph{Cosmografias guarani}}}
...
%\scriptsize{\emph{a luta guarani"-kaiowa pelos \emph{tekoha}}}}
...
\scriptsize{\emph{Uma experiência de pesquisa na universidade}}}
...
%\scriptsize{\emph{fazer (crescer) parentes}}}
...
%\scriptsize{\emph{alegria e saudade fazendo parentesco}}}
...
%\scriptsize{\emph{algumas conexões no ``alegrar"-se''}}}
...
%\scriptsize{\emph{Predação e troca nas relações com os brancos}}}
...
%\scriptsize{\emph{Sobre o encontro dos Clastres com os Guarani}}}
...
%\scriptsize{\emph{notas sobre um (des)encontro}}}
...
%\scriptsize{\emph{reflexões com famílias tupi guarani}}}
...
%\scriptsize{\emph{parentesco e dispersão}}}
