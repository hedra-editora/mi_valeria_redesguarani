...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{./img/mapita.jpg}	
  \hfill
...
\emph{A~Comissão Yvyrupa e a busca por nosso espaço de viver}}
...
\emph{Ficamos muito tristes com a reação de alguns que acham que a homenagem a
...
\emph{Cosmografias guarani}}

\addcontentsline{toc}{chapter}{A~caminho do Sol,
\scriptsize{\emph{por Daniel Calazans Pierri}}}
...
\chapter*{Novas terras sem males\\ \emph{a luta guarani"-kaiowa pelos \emph{tekoha}}}
...
\chapter*{\emph{Ore ava reko}\\ \emph{luta dos Guarani e Kaiowa para
...
\emph{Uma experiência de pesquisa na universidade}}
...
\chapter*{Tornar"-se adulto sem deixar de ser gente\\ \emph{fazer (crescer)
parentes}}

\addcontentsline{toc}{chapter}{Tornar"-se adulto sem deixar de ser gente,
\scriptsize{\emph{por Adriana Queiroz Testa}}}
...
\chapter*{O~que nos levanta sobre a terra\\ \emph{alegria e saudade fazendo
parentesco}}

\addcontentsline{toc}{chapter}{O~que nos levanta sobre a terra,
\scriptsize{\emph{por Ana Maria Ramo y Affonso}}}
...
\chapter*{Parentesco e emoções\\ \emph{algumas conexões no
``alegrar"-se''}}
...
\bigskip
\emph{Predação e troca em relações\\ entre os Guarani e os \emph{jurua}}} 
...
\chapter*{O~desabrochar da palavra\\ \emph{Sobre o encontro dos Clastres com os
Guarani}}
...
\scriptsize{\emph{por Papa Miri Poty (Carlos Fernandes)}}}
...
\scriptsize{\emph{por Alexandre Wera}}}
...
\chapter*{Entre enxadas e tratores\\ \emph{notas sobre um (des)encontro}}
...
\section{Comissão Guarani Yvyrupa (\versal{CGY}), inovando na articulação das aldeias e na
...
\versal{GOROSITO} \versal{KRAMER}, \emph{Ana Maria. Encuentros y desencuentros. Relaciones
...
\begin{figure}[H]
  \centering
 \includegraphics[width=104mm]{./img/GUARANIS-img6.jpg}	
  \hfill
...
\chapter*{Um nome que faz diferença\\ \emph{reflexões com famílias tupi guarani}}

\addcontentsline{toc}{chapter}{Um nome que faz diferença,
\scriptsize{\emph{por Lígia R. Almeida}}}
...
\chapter*{Os Mbya desceram o Araguaia\\ \emph{parentesco e dispersão}}

\addcontentsline{toc}{chapter}{Os Mbya desceram o Araguaia,
\scriptsize{\emph{por Rafael Fernandes Mendes Júnior}}}
