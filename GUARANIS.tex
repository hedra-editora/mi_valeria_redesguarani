...
gêmeos''. Segundo ela, Nhamandu, o Sol, nasceu na primeira terra, \emph{yvy
...
\begin{flushright}
\emph{Jera Poty Mirῖ (Giselda Pires de Lima)\footnote{Professora na escola da aldeia Tenonde Porã, São Paulo /\versal{SP}.}}
\end{flushright}  
...
aos \emph{xeramo\~{i}}\footnote{O termo \emph{xeramo\~{i}} significa,
...
\emph{xeramo\~{i}}\footnote{O uso do termo masculino
\emph{xeramo\~{i}} para se referirem às lideranças políticas
