\title{Nas redes guarani}

\title{Saberes, traduções e transformações}

\author{Dominique Tilkin Gallois e Valéria Macedo}

\chapter{}

\textbf{edição brasileira©}			 {Hedra 2022}\\
\textbf{organização©}		 		 {Dominique Tilkin Gallois e Valéria Macedo}\\
...
\textbf{revisão}					 {Bru Pereira de Araújo e Renier Silva}\\
\textbf{capa}		 				 {Lucas Kroëff}\\

\textbf{\textsc{isbn}}			 		 {978-65-89705-74-1}
...
\textit{Podemos estudar sim, mas continuar sonhando em guarani. Assim nosso conhecimento faz a gente.}
\textsc{karai mirim e algemiro da silva}

\chapter{Introdução: As múltiplas conexões de pessoas e 
conhecimentos}
...
melhor para os índios é que eles deixem de sê-lo, para que \textit{alcancem a
...
\chapter{Movimentos pela terra, andanças entre mundos}
...
%\textls[-10]
\noindent Essa narrativa, da qual reproduzo apenas um pequeno trecho, foi
...
\emph{yvyrupa}, como dizem os índios. Nimuendajú foi o primeiro autor que já
...
\emph{O~Globo}, 27 de maio de 2008.} se achava que os índios já não teriam terra
...
índios, que, como todas as pessoas, \textit{são espíritos que desejam
transcender}.
...
aquelas originárias dos territórios em conflito com os não índios, como os
...
\chapter{Caminhos e conhecimentos}
...
professores, sendo seis \emph{juruá}, ``não índios'', e sete guarani.
...
\chapter{Conexões, alteridades, alterações}
...
viviam longe e \textit{deixavam} que os índios vivessem ali como modo de
...
fortemente metafórica, inacessíveis aos ``não índios'', \emph{juruá}, e, por fim,
...
\chapter{Tecnologias, circulação e transformação}
...
\chapter{Nas aldeias e entre aldeias}
...
disse um líder político, \textit{antigamente o índio sempre procurava o lugar
...
no sul do Brasil, que somam aproximadamente 5.500 índios (\textsc{sesai},
...
\textit{indianidade}, afirmando aos não índios sua condição Tupi"-Guarani,
...
viver como \emph{juruá} ou \emph{te’yi}, entre brancos ou índios. 
